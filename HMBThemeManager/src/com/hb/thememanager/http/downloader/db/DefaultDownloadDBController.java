...
public final class DefaultDownloadDBController implements DownloadDBController {
  ...
  public DefaultDownloadDBController(Context context, DownloadConfig downloadConfig) {
    this.context = context;
    dbHelper = new DefaultDownloadHelper(context, downloadConfig);
  ...
  @Override
  public DownloadInfo findDownloadedInfoByPath(String savedFilePath) {
	  Cursor cursor = readableDatabase
            .query(DefaultDownloadHelper.TABLE_NAME_DOWNLOAD_INFO, DOWNLOAD_INFO_COLUMNS, "path=?",
