...
public class DefaultDownloadHelper extends SQLiteOpenHelper {
  ...
  public DefaultDownloadHelper(Context context, DownloadConfig downloadConfig) {
    super(context, downloadConfig.getDatabaseName(), null, downloadConfig.getDatabaseVersion());
  }
