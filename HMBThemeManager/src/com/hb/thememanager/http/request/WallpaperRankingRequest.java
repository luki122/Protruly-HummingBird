...
public class WallpaperRankingRequest extends ThemeRequest {


	private Context mContext;


	public WallpaperRankingRequest(Context context){
		super(context);
		mContext = context;
	}
	...
	public void request(Http http, IResponseHandler handler) {
		...
		try{
			InputStream input = asset.open("test_json/wallpaper_rank.json");
			String code=getEncoding(input);
			input=asset.open("test_json/wallpaper_rank.json");
