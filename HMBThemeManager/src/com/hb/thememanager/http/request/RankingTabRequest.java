...
public class RankingTabRequest extends ThemeRequest {


	private Context mContext;


	public RankingTabRequest(Context context){
		super(context);
		mContext = context;
	}
	...
	public void request(Http http, IResponseHandler handler) {
		...
		try{
			InputStream input = asset.open("test_json/tabs.json");
			String code=getEncoding(input);
			input=asset.open("test_json/tabs.json");
