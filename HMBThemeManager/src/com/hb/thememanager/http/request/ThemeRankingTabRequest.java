...
public class ThemeRankingTabRequest extends ThemeRequest {


	private Context mContext;


	public ThemeRankingTabRequest(Context context){
		super(context);
		mContext = context;
	}
	...
	public void request(Http http, IResponseHandler handler) {
		...
		try{
			InputStream input = asset.open("test_json/theme_tabs.json");
			String code=getEncoding(input);
			input=asset.open("test_json/theme_tabs.json");
