...
public abstract class AbsLocalWallpaperListFrag extends AbsLocalThemeFragment implements ThemeListMVPView
,DialogInterface.OnClickListener{
	...
	protected abstract LocalWallpaperAdapter getAdapter();
	...
	private void deleteSelectedTheme(){
		SparseArray<Wallpaper> selectThemes = getAdapter().getSelectedItems();
