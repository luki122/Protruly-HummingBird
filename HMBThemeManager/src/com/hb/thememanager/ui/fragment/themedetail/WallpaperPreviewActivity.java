...
import com.hb.thememanager.views.LocalWallpaperApplyButton;
...
OnColorPickerListener,IconLoadCallBack{
	...
	public static final int ICON_BOTTOM = 0;
	public static final int ICON_TOP = 1;
	public static final String[] PREVIEW_TOP_ICONS  = {
	...
	private LocalWallpaperApplyButton  mApplyButton;
	...
	private void initial(){
		...
		mApplyButton = (LocalWallpaperApplyButton)findViewById(R.id.btn_wallpaper_apply);
		...
		mAdapter = new WallpaperPreivewPagerAdapter(this,mWallpapers,-1);
		mCurrentWallpaper = mWallpapers.get(currentPosition);
		mApplyButton.setWallpaper(mCurrentWallpaper);
