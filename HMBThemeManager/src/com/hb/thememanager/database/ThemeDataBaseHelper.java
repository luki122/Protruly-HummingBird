...
public class ThemeDataBaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_RINGTONG = "ringtong";
    ...
    static{
    	...
    	TABLES.put(Theme.RINGTONG, TABLE_RINGTONG);
    ...
    public ThemeDataBaseHelper(final Context context,int themeType) {
        ...
        TLog.e(TAG, "create table in themes database:"+DB_TABLE);
    }
    ...
    private void createThemesTable(SQLiteDatabase db,String table) {
    	...
    	}else if(TABLE_RINGTONG.equals(table)){
    		sql.append(SQL_CREATE_RINGTONG_TABLE);
    	}
        try {
            db.execSQL(sql.toString());
        } catch (SQLException ex) {
            Log.e(TAG, "couldn't create table in themes database:"+ex+"  SQL:"+sql);
            throw ex;
        }
    }
