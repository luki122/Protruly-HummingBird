...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getContext().getDrawable(R.drawable.ic_arrow_up);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getContext().getDrawable(R.drawable.ic_arrow_down);
        }

        if (TextUtils.isEmpty(textCollapse)) {
            textCollapse = getContext().getString(R.string.topic_detail_etv_collapse);
        }
        if (TextUtils.isEmpty(textExpand)) {
            textExpand = getContext().getString(R.string.topic_detail_etv_expand);
        }
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, getContext().getColor(R.color.topic_item_text_color));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, sp2px(getContext(),14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView_collapseExpandTextColor, getContext().getColor(R.color.topic_detail_etv_color));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, sp2px(getContext(),14));
        ...
        mText = typedArray.getString(R.styleable.ExpandableTextView_android_text);
        typedArray.recycle();
...
//            mTvContent.setMaxLines(mMaxCollapsedLines);
    ...
    private void setDrawbleAndText(){
        ...
        mTvExpandCollapse.setText(mCollapsed ? getResources().getString(R.string.topic_detail_etv_expand) : getResources().getString(R.string.topic_detail_etv_collapse));
    }
