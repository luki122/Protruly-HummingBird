...
public class RoundRectImageView extends ImageView {
	private static final float DEFAULT_ROUND_SIZE = 20;
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.RoundRectImageView);
        mRoundSize = typedArray.getDimension(R.styleable.RoundRectImageView_round, DEFAULT_ROUND_SIZE);
        typedArray.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = BitmapUtils.drawable2bitmap(getDrawable());
        ...
        canvas.drawRoundRect(new RectF(0,0,getWidth(),getHeight()), mRoundSize, mRoundSize,
                mPaint);
    }
