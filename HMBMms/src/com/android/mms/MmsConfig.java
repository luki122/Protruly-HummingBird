...
public class MmsConfig {
    ...
    ///@}
    //tangyisen modify
    private static final int MAX_IMAGE_HEIGHT = 480 * 3;//480;//Integer.MAX_VALUE;//480;
    private static final int MAX_IMAGE_WIDTH = 640 * 3;//640;//Integer.MAX_VALUE;//640
    ...
    private static int sSmsToMmsTextThreshold = 7;//4; tangyisen modify
