...
public class SlideshowAttachmentView extends LinearLayout implements
    ...
    protected void onFinishInflate() {
        mImageView = (ZzzCircleImageView) findViewById(R.id.slideshow_image);
        //mTextView = (TextView) findViewById(R.id.slideshow_text);
        mPlay = (ImageView)findViewById(R.id.play_slideshow_button);
        mView = (ImageView)findViewById(R.id.view_slide_button);
    }
    ...
    public void setAudio(Uri audio, String name, Map<String, ?> extras) {
        ...
        MessageUtils.showView( mPlay );
        mPlay.setImageResource( R.drawable.zzz_ic_message_attachment_edit_voice );
        MessageUtils.hideView( mView );
    }
    ...
    public void setImage(String name, Bitmap bitmap) {
        ...
        if (bitmap != null) {
            mImageView.setType(ZzzCircleImageView.IMAGE_TYPE);//tangyisen add
            mImageView.setImageBitmap(bitmap);      // implementation doesn't appear to be null-safe
            MessageUtils.hideView( mPlay );
            MessageUtils.showView( mView );
        }
    }
    ...
    public void setVideo(String name, Uri video) {
        ...
        mImageView.setType(ZzzCircleImageView.VIDEO_TYPE);//tangyisen add
        mImageView.setImageBitmap(bitmap);
        MessageUtils.showView( mPlay );
        mPlay.setImageResource( R.drawable.zzz_ic_message_attachment_edit_video );
        MessageUtils.hideView( mView );
    }
