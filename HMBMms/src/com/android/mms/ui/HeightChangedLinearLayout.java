...
public class HeightChangedLinearLayout extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(DEBUG) MmsLog.d(TAG, "onLayout(): changed = " + changed + ", left = " + l
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(DEBUG) MmsLog.d(TAG, "onMeasure(): widthMeasureSpec = " + widthMeasureSpec
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if(DEBUG) MmsLog.d(TAG, "onSizeChanged(): oldw = " + oldw + ", oldh = " + oldh
                + ",w = " + w + ", h = " + h);
        final int fw = w;
        final int fh = h;
