...
public class MmsPlayerActivityItemData {
    ...
    private static final String TAG = "Mms/MPAIData";
    ...
    private String mFileName;//vcard and vcalendar
    private FileAttachmentModel mFileAttachmentModel;
    //end tangyisen
    ...
    //begin tangyisen
    public MmsPlayerActivityItemData(Context context, String subject, String fileName, FileAttachmentModel model) {
        mSubject = subject;
        mFileName = fileName;
        mFileAttachmentModel = model;
    }
    //end tangyisen
    ...
    public FileAttachmentModel getFileAttachmentModel() {
        return mFileAttachmentModel;
    }
    //end tangyisen
}
