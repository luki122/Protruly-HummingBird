...
public abstract class RequestPermissionsActivityBase extends Activity {
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[],
        ...
        if (permissions != null && permissions.length > 0
            ...
            if (!MyPermissionsUtil.hasPermission(RequestPermissionsActivityBase.this, permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(this, R.string.permission_no_storage, Toast.LENGTH_SHORT).show();
            } else if (!MyPermissionsUtil.hasPermission(RequestPermissionsActivityBase.this, permission.READ_CONTACTS)) {
                Toast.makeText(this, R.string.permission_no_contacts, Toast.LENGTH_SHORT).show();
            }/* else if (!MyPermissionsUtil.hasPermission(RequestPermissionsActivityBase.this, permission.ACCESS_FINE_LOCATION)) {
                Toast.makeText(this, R.string.permission_no_location, Toast.LENGTH_SHORT).show();
            } */else if (!MyPermissionsUtil.hasPermission(RequestPermissionsActivityBase.this, permission.READ_CALL_LOG)) {
                Toast.makeText(this, R.string.permission_no_calllog, Toast.LENGTH_SHORT).show();
            } else if (!MyPermissionsUtil.hasPermission(RequestPermissionsActivityBase.this, permission.RECORD_AUDIO)) {
                Toast.makeText(this, R.string.permission_no_record, Toast.LENGTH_SHORT).show();
            } else if (!MyPermissionsUtil.hasPermission(RequestPermissionsActivityBase.this, permission.READ_SMS)) {
