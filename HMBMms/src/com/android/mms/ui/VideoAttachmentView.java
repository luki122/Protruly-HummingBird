...
public class VideoAttachmentView extends LinearLayout implements SlideViewInterface {
    ...
    private ZzzCircleImageView mThumbnailView;//tangyisen
    ...
    protected void onFinishInflate() {
        mThumbnailView = (ZzzCircleImageView) findViewById(R.id.video_thumbnail);
    }
        ...
        try {
            ...
            if (extName.equals("dcf")) {
                Bitmap drmBitmap = DrmUtilsEx.getDrmBitmapWithLockIcon(mContext,
                        bitmap, MessageResource.drawable.drm_red_lock);
                if (drmBitmap != null) {
