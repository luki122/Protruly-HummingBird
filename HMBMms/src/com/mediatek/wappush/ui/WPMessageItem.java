...
//            sBuilder.append("<br>");
    ...
    private static final String UNREAD_SELECTION = "(read=0 OR seen=0 OR failed_unread=1)";//lichao add failed_unread
    public static final String[] UNREAD_PROJECTION = {
        WapPush._ID,
        WapPush.READ
        ,WapPush.FAILED_UNREAD//lichao add failed_unread
    };
    private void buildReadContentValues() {
        if (sReadContentValues == null) {
            ...
            sReadContentValues.put("failed_unread", 0);//lichao add failed_unread
        }
    }
}
