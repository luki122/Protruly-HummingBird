...
//            invalidateOptionsMenu();
    ...
    private void markMmsIndReaded(final Uri uri) {
        new Thread(new Runnable() {
            public void run() {
                ...
                values.put("read", 1);
                values.put("seen", 1);
                //Log.d(TAG, "\n\n markMmsIndReaded(), values.put(failed_unread, 0)");
                values.put("failed_unread", 0);//lichao add
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (mActionMode != null) {
            ...
            Log.d(TAG, "onSaveInstanceState--selectItemIds:" + Arrays.toString(selectedList));
        }
    }
