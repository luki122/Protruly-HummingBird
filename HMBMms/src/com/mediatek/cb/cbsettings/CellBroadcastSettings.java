...
public class CellBroadcastSettings extends TimeConsumingPreferenceActivity
    ...
    //lichao add in 2017-05-03 begin
    private Handler mHandler;
    private boolean needShowLoadDialog;
    private boolean isShowBusyReadingDialog;//BUSY_READING_DIALOG
    //lichao add in 2017-05-03 end
    ...
    private void getCellBroadcastConfig() {
        MmsLog.d(LOG_TAG, "getCellBroadcastConfig start>>>showDialog(BUSY_READING_DIALOG)");
        isShowBusyReadingDialog = true;//lichao add in 2017-05-03
    ...
    private void dismissProgressDialog() {
        MmsLog.d(LOG_TAG, "dismiss LoadDialog");//lichao add in 2017-05-03
        needShowLoadDialog = false;//lichao add in 2017-05-03
    ...
    private void updateUI() {
        MmsLog.d(LOG_TAG, "updateUI");//lichao add in 2017-05-03
        updateChannelUIList();
    ...
    private class CellBroadcastAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            //lichao modify in 2017-05-03 begin
            needShowLoadDialog = true;
            int delay_time = 0;
            if(isShowBusyReadingDialog){
                delay_time = TimeConsumingPreferenceActivity.DIALOG_DELAY_TIME;
            }
            MmsLog.d(LOG_TAG, "onPreExecute, >>>Try to show LoadDialog");
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    if(needShowLoadDialog){
                        mLoadDialog.show();
                        MmsLog.d(LOG_TAG, ">>>show LoadDialog now");
                    }
                }
            }, delay_time);
            //lichao modify in 2017-05-03 end
        }
