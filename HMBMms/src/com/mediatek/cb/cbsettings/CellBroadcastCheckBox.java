...
public class CellBroadcastCheckBox extends SwitchPreference {
    ...
    private Handler mUiHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case QUERY_CBSMS_ACTIVATION:
                ...
                setSummary(mIsCbEanbled ? R.string.zzz_sum_cell_broadcast_control_on
                        : R.string.zzz_sum_cell_broadcast_control_off);
                break;
            default:
