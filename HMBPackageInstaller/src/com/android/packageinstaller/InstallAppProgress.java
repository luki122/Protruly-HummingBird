 ...
 */
public class InstallAppProgress extends BaseActivity implements View.OnClickListener, OnCancelListener {
    ...
    //安装成功状态 add by zhaolaichao 20170713
    private int mOkState;
            ...
            switch (msg.what) {
                case INSTALL_COMPLETE:
                    ...
                    if (msg.arg1 == PackageManager.INSTALL_SUCCEEDED) {
                        ...
                        mLaunchButton.setText(R.string.cancel);
                        mLaunchButton.setBackground(getDrawable(com.hb.R.drawable.button_background_hb_negative));
                        mLaunchButton.setOnClickListener(InstallAppProgress.this);
                        mLaunchButton.setVisibility(View.VISIBLE);
                        mDoneButton.setBackground(getDrawable(com.hb.R.drawable.button_background_hb_positive));
                    }
...
//                            centerTextDrawable.getIntrinsicHeight());
                        centerTextDrawable.setBounds(0, 0,
                                (int)getResources().getDimension(R.dimen.install_ok_icon_width),
                                (int)getResources().getDimension(R.dimen.install_ok_icon_height));
                        mTvResult.setCompoundDrawablesRelative(null, centerTextDrawable,
                                null, null);
                    }
                    mTvResult.setText(centerTextLabel);
    ...
    public void initView() {
        setHbContentView(R.layout.op_progress);
        int installFlags = 0;
        ...
        mTvResult = (TextView)findViewById(R.id.tv_ok_center_text);

        mExplanationTextView = (TextView) findViewById(R.id.center_explanation);
        FrameLayout layPb = (FrameLayout)findViewById(R.id.top_divider);
        layPb.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        if(v == mDoneButton) {
            ...
            if (mOkState == PackageManager.INSTALL_SUCCEEDED) {
