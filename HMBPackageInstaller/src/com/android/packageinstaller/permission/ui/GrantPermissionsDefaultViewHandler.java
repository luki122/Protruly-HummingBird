...
final class GrantPermissionsDefaultViewHandler
    ...
    public View createView() {
        mRootView = (ManualLayoutFrame) LayoutInflater.from(mContext)
                .inflate(R.layout.hmb_grant_permissions, null);
        if (mRootView.findViewById(R.id.button_group) != null) {
...
//        mIconView.setImageDrawable(mGroupIcon.loadDrawable(mContext));
        mIconView.setImageDrawable(Utils.getPermissionGroupsIcon(mContext, mGroupName, mGroupIcon.loadDrawable(mContext)));
