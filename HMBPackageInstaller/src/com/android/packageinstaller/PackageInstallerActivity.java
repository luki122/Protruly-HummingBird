 ...
 */
public class PackageInstallerActivity extends BaseActivity implements OnCancelListener, OnClickListener {
...
//        tabHost.setup();
        ...
        TabsTitleAdapter adapter = new TabsTitleAdapter(this);
...
//        });
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (TAB_ID_ALL.equals(tab.getTag())) {
                    mInstallFlowAnalytics.setAllPermissionsDisplayed(true);
                } else if (TAB_ID_NEW.equals(tab.getTag())) {
                    mInstallFlowAnalytics.setNewPermissionsDisplayed(true);
                }
            }
        ...
        /// M: Use MOMS if supported
        boolean supportsRuntimePermissions = MobileManagerUtils.isSupported() ? false :
                      mPkgInfo.applicationInfo.targetSdkVersion >= Build.VERSION_CODES.M;
        ...
        Log.e(TAG, ">>>count>>getPermissionCount>>" + N);
        if (mAppInfo != null) {
...
//            tabHost.addTab(tabHost.newTabSpec(TAB_ID_NEW).setIndicator(
//                    getText(R.string.newPerms)), mScrollView);
            tabLayout.addTab(tabLayout.newTab().setTag(TAB_ID_NEW).setText(getText(R.string.newPerms)));
            adapter.addTab(position, getText(R.string.newPerms).toString(), mScrollView);
            position ++;
        } else  {
...
//            tabLayout.addTab(tabHost.newTabSpec(TAB_ID_ALL).setIndicator(
//                    getText(R.string.allPerms)), root);
            tabLayout.addTab(tabLayout.newTab().setTag(TAB_ID_ALL).setText(getText(R.string.allPerms)));
            adapter.addTab(position, getText(R.string.allPerms).toString(), root);
        }
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //set view
        setHbContentView(R.layout.install_start);
