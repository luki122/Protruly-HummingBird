...
public class HbIconUtil {
    ...
    static {
        ...
        // Package
        icon = R.drawable.hmb_doc_apk;
        add("application/vnd.android.package-archive", icon);

        // Audio
        icon = R.drawable.hmb_doc_audio;
        ...
        // Compressed
        icon = R.drawable.hmb_doc_compressed;
        ...
        // Powerpoint
        icon = R.drawable.hmb_doc_powerpoint;
    ...
    public static Drawable loadMimeIcon(Context context, String mimeType) {
        ...
        if ("audio".equals(typeOnly)) {
            return context.getDrawable(R.drawable.hmb_doc_audio);
        } else if ("image".equals(typeOnly)) {
            return context.getDrawable(R.drawable.hmb_doc_image);
        } else if ("text".equals(typeOnly)) {
            return context.getDrawable(R.drawable.hmb_doc_text);
        } else if ("video".equals(typeOnly)) {
            return context.getDrawable(R.drawable.hmb_doc_video);
        } else {
            return context.getDrawable(R.drawable.hmb_doc_generic);
        }
    }
