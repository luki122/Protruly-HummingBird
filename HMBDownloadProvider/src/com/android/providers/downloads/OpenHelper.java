...
public class OpenHelper {
    ...
    private static Intent buildViewIntent(Context context, long id) {
        ...
        try {
            ...
            /// M: Not suitable for MTK DRM solution
            ...
            if (Constants.MTK_DRM_ENABLED
                ...
                Log.d(Constants.DL_DRM, "Open DRM file:" + localUri + " MimeType is" + mimeType);
                intent.setDataAndType(localUri, mimeType);
            } else {
            /// @}
            if ("application/vnd.android.package-archive".equals(mimeType)) {
                // PackageInstaller doesn't like content URIs, so open file
            	//HB. Comments : fixed open apk failed , Engerineer : wxue , Date : 2017年7月5日 ,begin
                //intent.setDataAndType(localUri, mimeType);
            	intent.setDataAndType(Uri.fromFile(file), mimeType);
                //HB. Comments : TODO , Engerineer : wxue , Date : 2017年7月5日 ,begin
