...
public class DownloadService extends Service {
    ...
    private static ExecutorService buildDownloadExecutor() {
    	//HB. Comments : modify concurrent thread number , Engerineer : wxue , Date : 2017年6月30日 ,begin
        ...
        LogUtil.i("DownloadService","---maxConcurrent = " + maxConcurrent);
        //HB. end
        ...
        public boolean handleMessage(Message msg) {
            ...
            if (isActive) {
                ...
                if (stopSelfResult(startId)) {
                    ...
                    HbDownManager.getInstance(DownloadService.this).clearAllDowninfo();
                    //HB. end
                    mScanner.shutdown();
                    mUpdateThread.quit();
                }
    ...
    private boolean updateLocked() {
        ...
        LogUtil.i(TAG, "nextActionMillis = " + nextActionMillis + "ms");
