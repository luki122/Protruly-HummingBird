...
public class DownloadStorageProvider extends DocumentsProvider {
    ...
    public String createDocument(String docId, String mimeType, String displayName)
        ...
        Log.d(Constants.DL_ENHANCE, "DownloadStorageProvider:createDocument(), docId: " + docId +
    ...
    private void includeDownloadFromCursor(MatrixCursor result, Cursor cursor) {
        ...
        switch (status) {
            case DownloadManager.STATUS_SUCCESSFUL:
                summary = getContext().getString(R.string.notification_download_complete);
                break;
             ...
             if (mimeType.equals(OmaDrmStore.DrmObjectMime.MIME_DRM_CONTENT) ||
                 ...
                 if (localUri != null) {
                     ...
                     if (null != oriMimeType && !oriMimeType.isEmpty()) {
                         ...
                         Log.d(XTAG_DRM, "DownloadStorageProvider: includeDownloadFromCursor a DRM file path:"
