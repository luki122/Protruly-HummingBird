...
public final class DownloadProvider extends ContentProvider {
    ...
    public int update(final Uri uri, final ContentValues values,
        ...
        if (Binder.getCallingPid() != Process.myPid()) {
            ...
            //HB. Comments : update download status , Engerineer : wxue , Date : 2017年6月1日 ,begin
        ...
        // add by wxue for debug start
        //Log.i("DownloadManager","---update()--startService = " + startService + " count = " + count + " values = " + values);
        // add by wxue for debug end
        notifyContentChanged(uri, match);
        if (startService) {
            Context context = getContext();
            context.startService(new Intent(context, DownloadService.class));
            ...
            case ALL_DOWNLOADS_ID:
                ...
                try {
                    while (cursor.moveToNext()) {
                        ...
                        //HB. Comments : don't delete file when delete download record , Engerineer : wxue , Date : 2017年6月2日 ,begin
