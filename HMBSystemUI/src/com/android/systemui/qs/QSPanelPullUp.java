...
public class QSPanelPullUp extends ViewGroup {
    private static final float TILE_ASPECT = 0.59f;
    ...
    private final HbBrightnessView mHbBrightnessView;
    /**hb tangjun add end*/
    ...
    //M: tangjun mod begin
    private QuickSettingCallback mQuickSettingCallback;
    private int mQStileTop_portrait;
    private int mQStileTop_landscape;
    private int mQStileDistance_portrait;
    private int mQStileDistance_landscape;
    private int mHbBrightnessViewDistance_portrait;
    private int mHbBrightnessViewDistance_landscape;
    private int mQSPanelHeightPort;
    private int mQSPanelWidthLand;
    private static final int[] TILES_RESOURCE_IDS = 
    	{R.drawable.hb_airplanemode_off,R.drawable.hb_airplanemode_on,R.drawable.hb_bluetooth_off,R.drawable.hb_bluetooth_on,
    			R.drawable.hb_bluetooth_waiting,R.drawable.hb_data_off,R.drawable.hb_data_on,R.drawable.hb_flashlight_disable,
    			R.drawable.hb_flashlight_off,R.drawable.hb_flashlight_on,R.drawable.hb_location_off,R.drawable.hb_location_on,
    			R.drawable.hb_mutelock_off,R.drawable.hb_mutelock_on,R.drawable.hb_rotationlock_off,R.drawable.hb_rotationlock_on,
    			R.drawable.hb_screenshots_off,R.drawable.hb_screenshots_on,R.drawable.hb_wifi_off,R.drawable.hb_wifi_on,
    			R.drawable.hb_wifi_waiting
    	};
    //M: tangjun mod end

    public QSPanelPullUp(Context context) {
        this(context, null);
    }

    public QSPanelPullUp(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        ...
        /**hb tangjun add begin*/
        mHbBrightnessView=(HbBrightnessView)LayoutInflater.from(context).inflate(R.layout.hb_qs_brightness, this, false);
        /**hb tangjun add end*/
        //mFooter = new QSFooter(this, context);
        addView(mDetail);
        addView(mBrightnessView);
        /**hb tangjun add begin*/
        addView(mHbBrightnessView);
        /**hb tangjun add end*/
    ...
    public void setHost(QSTileHost host) {
        ...
        for(int i = 0; i < TILES_RESOURCE_IDS.length; i++) {
        	ResourceIcon.get(TILES_RESOURCE_IDS[i]);
        }
    }
    ...
    public void updateResources() {
        ...
        mQSPanelHeightPort = res.getDimensionPixelSize(R.dimen.quicksetting_panel_height_port);
        mQSPanelWidthLand = res.getDimensionPixelSize(R.dimen.quicksetting_panel_width_land);
        mQStileTop_portrait = res.getDimensionPixelSize(R.dimen.quick_settings_tile_top_portrait);
        mQStileTop_landscape = res.getDimensionPixelSize(R.dimen.quick_settings_tile_top_landscape);
        mQStileDistance_portrait = res.getDimensionPixelSize(R.dimen.quick_settings_tile_distance_portrait);
        mQStileDistance_landscape = res.getDimensionPixelSize(R.dimen.quick_settings_tile_distance_landscape);
        mHbBrightnessViewDistance_portrait = res.getDimensionPixelSize(R.dimen.quick_settings_brightnessview_distance_portrait);
        mHbBrightnessViewDistance_landscape = res.getDimensionPixelSize(R.dimen.quick_settings_brightnessview_distance_landscape);
        
        WindowManager wm = (WindowManager) mContext.getSystemService(Context.WINDOW_SERVICE);
        //Log.e("555555", "-----mQSPanelHeightPort = " + mQSPanelHeightPort);
        //Log.e("555555", "-----mCellWidth = " + mCellWidth);
        //hb tangjun mod end
    }
    ...
    private void handleSetTileVisibility(View v, int visibility) {
    	/**hb tangjun mod begin*/
    	Log.d("tangjun222", "--handleSetTileVisibility mGridContentVisible = " + mGridContentVisible);
    	/*
    ...
    private void addTile(final QSTile<?> tile) {
        ...
        final QSTile.Callback callback = new QSTile.Callback() {
            ...
            public void onShowDetail(boolean show) {
                QSPanelPullUp.this.showDetail(show, r);
            }
            @Override
        ...
        final View.OnClickListener click = new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	//hb tangjun mod begin
            	if ((r.tile instanceof ScreenShotTile || (r.tile instanceof FlashlightTile && ((FlashlightTile)r.tile).getBatteryLevel() <= 10)
            			|| (r.tile instanceof MobileDataTile && ((MobileDataTile)r.tile).getAirplaneModeEnabled() == true)) && mQuickSettingCallback != null) {
            		mQuickSettingCallback.finishQuickSetting();
            	}
            	//hb tangjun mod end
        ...
        final View.OnLongClickListener longClick = new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
            	...
            	//hb tangjun mod begin
            	if (!(r.tile instanceof FlashlightTile) && mQuickSettingCallback != null) {
            		mQuickSettingCallback.finishQuickSetting();
            	}
            	//hb tangjun mod end
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    	/**hb tangjun mod begin*/
    	final int width = Utilities.isOrientationPortrait(mContext) ? MeasureSpec.getSize(widthMeasureSpec) : mQSPanelWidthLand;
    	final int height = Utilities.isOrientationPortrait(mContext) ?  mQSPanelHeightPort : MeasureSpec.getSize(heightMeasureSpec);
    	...
    	mHbBrightnessView.measure(exactly(width), MeasureSpec.UNSPECIFIED);
        final int brightnessHeight = mHbBrightnessView.getMeasuredHeight() + mBrightnessPaddingTop; 
        /**hb tangjun mod end*/
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int qstile_top;
        int qstile_distance;
        int brightnessview_distance;
        if ( getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT ) {
        	qstile_top = mQStileTop_portrait;
        	qstile_distance = mQStileDistance_portrait;
        	brightnessview_distance = mHbBrightnessViewDistance_portrait;
        } else {
        	qstile_top = mQStileTop_landscape;
        	qstile_distance = mQStileDistance_landscape;
        	brightnessview_distance = mHbBrightnessViewDistance_landscape;
        }
        /*
        mBrightnessView.layout(0, mBrightnessPaddingTop,
                ...
                */
        final int brightnessViewLeft = (w - mHbBrightnessView.getMeasuredWidth()) / 2;
        mHbBrightnessView.layout(brightnessViewLeft, qstile_top+2*(mCellHeight + qstile_distance) + brightnessview_distance,
        		brightnessViewLeft + mHbBrightnessView.getMeasuredWidth(),
        		qstile_top+2* (mCellHeight + qstile_distance) + brightnessview_distance + mHbBrightnessView.getMeasuredHeight());
        /**hb tangjun mod end*/
    ...
    private int getRowTop(int row) {
		...
		if (row <= 0) row = 0;
        return qstile_top + row* (mCellHeight + qstile_distance);
        /**hb tangjun mod end*/
    }
    ...
    //hb  tangjun mod begin
	public interface QuickSettingCallback{
		public void finishQuickSetting();
	}
	
	public void setOnQuickSettingCallback(QuickSettingCallback quickSettingCallback) {
		mQuickSettingCallback = quickSettingCallback;
	}
	//hb tangjun mod end
}
