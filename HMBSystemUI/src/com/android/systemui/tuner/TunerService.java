...
public class TunerService extends SystemUI {
    ...
    private void addTunable(Tunable tunable, String key) {
        ...
        //Log.i(TAG, "addTunable key:" + key + " uri:" + uri);
    ...
    public void reloadSetting(Uri uri) {
        //Log.i(TAG, "TunerService::reloadSetting uri:" + uri);
    ...
    public void clearAll() {
        ...
        //Modify to:
        Settings.System.putString(mContentResolver, CustomBatteryMeterView.SHOW_PERCENT_SETTING, null);
