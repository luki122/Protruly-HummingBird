...
public class RecentsActivity extends Activity implements RecentsView.RecentsViewCallbacks,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().getDecorView().setSystemUiVisibility(flag | View.SYSTEM_UI_FLAG_LAYOUT_STABLE |
        ...
        /**hb tangjun mod for use decorview to set SystemUiVisibility instead begin*/
        /*
        mRecentsView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE |
                View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN |
                View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
                */
        /**hb tangjun mod for use decorview to set SystemUiVisibility instead end*/
    ...
    protected void onStart() {
        ...
        mRecentsView.setHbTaskStackViewScrollWhenStart();
        mConfig.isRecentsShow = true;
        //hb: tangjun add end
    }
    ...
    public void onBackPressed() {
    	...
    	Log.d("tangjun222", "--RecentsActivity onBackPressed");
