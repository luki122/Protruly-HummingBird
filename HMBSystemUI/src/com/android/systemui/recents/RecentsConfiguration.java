...
public class RecentsConfiguration {
    ...
    /**hb: tangjun define final var to fix requirement begin*/
    private static final String PREF_RECENTS_APP_LOCK_INFO= "recents_lock_info";
    public boolean isRecentsShow;
    /**hb: tangjun define final var to fix requirement end*/
    ...
    /**hb: tangjun add read lock state from sharedpreference to fix requirement begin*/
    ...
    /**hb: tangjun add read lock state from sharedpreference to fix requirement end*/
    
    /**hb: tangjun add write lock state from sharedpreference to fix requirement begin*/
    ...
    /**hb: tangjun add write lock state from sharedpreference to fix requirement end*/
    
    /**hb: tangjun getRecentsAppsKey to fix requirement start*/
    ...
    /**hb: tangjun getRecentsAppsKey to fix requirement end*/
    
	/**hb: tangjun add for get Integer value from dimens list begin*/
	public static int getIntegerValueFromResourcesDimens(Resources res,int id){
		return res.getInteger(id);
	}
	/**hb: tangjun add for get Integer value from dimens list end*/
}
