...
public class Recents extends SystemUI
    ...
    void toggleRecentsActivity() {
        ...
        Log.d("tangjun222", "--toggleRecentsActivity");
        ...
        if (topTask != null && mSystemServicesProxy.isRecentsTopMost(topTask, isTopTaskHome)) {
        	/**hb tangjun add for 当将时间日期设置成以前的时间时，会出现TopMostTask为SystemUI的情况,导致弹不出最近任务界面 begin*/
        	//Log.d("tangjun222", "--111");
        	if(!mConfig.isRecentsShow) {
    ...
    void startRecentsActivity(ActivityManager.RunningTaskInfo topTask, boolean isTopTaskHome) {
        ...
        /**hb: tangjun mod for don't need useThumbnailTransition begin*/
        //boolean useThumbnailTransition = (topTask != null) && !isTopTaskHome && hasRecentTasks;
        boolean useThumbnailTransition = false;
        /**hb: tangjun mod for don't need useThumbnailTransition end*/
        ...
        if (!useThumbnailTransition) {
        	...
        	boolean fromApp = (topTask != null) && !isTopTaskHome && hasRecentTasks;
        	/**hb tangjun add end*/
            if (hasRecentTasks) {
...
//                        false /* fromThumbnail */, stackVr);
                startAlternateRecentsActivity(topTask, opts, !fromApp, fromSearchHome,
                		false /* fromThumbnail */, stackVr);
                /**hb tangjun mod end*/
            } else {
...
//                startAlternateRecentsActivity(topTask, opts, true /* fromHome */,
//                        false /* fromSearchHome */, false /* fromThumbnail */, stackVr);
                startAlternateRecentsActivity(topTask, opts, !fromApp,
                		false /* fromSearchHome */, false /* fromThumbnail */, stackVr);
                /**hb tangjun mod end*/
            }
        }
