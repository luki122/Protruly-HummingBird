...
public class RecentsTaskLoader {
    ...
    BroadcastReceiver mThemeChangeBroadcastReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            String action = intent.getAction();
            if (action.equals("com.hb.theme.ACTION_THEME_CHANGE")) {
            	mApplicationIconCache.evictAll();
            	IconManager.getInstance(context, true, false).clearCaches();
            }
        }
    };
    /**hb tangjun add end*/
    ...
    private RecentsTaskLoader(Context context) {
        ...
        /**hb tangjun add begin*/
        registerThemeChangeBroadCast(context);
        /**hb tangjun add end*/
    }
    
    /**hb tangjun add begin*/
    private void registerThemeChangeBroadCast(Context context) {
    	IntentFilter filter = new IntentFilter("com.hb.theme.ACTION_THEME_CHANGE");
    	context.registerReceiver(mThemeChangeBroadcastReceiver , filter);
    }
    /**hb tangjun add end*/
