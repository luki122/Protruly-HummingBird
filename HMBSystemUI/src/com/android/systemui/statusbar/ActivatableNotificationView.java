...
public abstract class ActivatableNotificationView extends ExpandableOutlineView {
    ...
    protected void onFinishInflate() {
        ...
        mBackgroundDimmed.setCustomBackground(R.drawable.notification_material_bg);
        //mBackgroundNormal.setCustomBackground(R.drawable.hb_notification_raw_bg);
        //mBackgroundDimmed.setCustomBackground(R.drawable.hb_notification_raw_bg);
    ...
    private void updateBackgroundTint() {
        int color = mNormalColor;//getBgColor();//modify by chenhl
        //int rippleColor = mNormalRippleColor;//getRippleColor(); //modify by chenhl
