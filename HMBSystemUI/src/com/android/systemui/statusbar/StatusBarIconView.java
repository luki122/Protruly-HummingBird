...
public class StatusBarIconView extends AnimatedImageView implements Cloneable{
    ...
    public StatusBarIconView(Context context, String slot, Notification notification) {
        this(context, slot, notification, false, true);
    }
    ...
    //Modify to:
    //add needMargin in constructor
    //ShenQianfeng modify end
    public StatusBarIconView(Context context, String slot, Notification notification,
            boolean blocked, boolean needMargin) {
        super(context);
    ...
    @Override
    public Object clone(){
        StatusBarIconView o=null;
        try {
            o=(StatusBarIconView)super.clone();
