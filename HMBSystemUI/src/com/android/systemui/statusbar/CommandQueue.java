...
public class CommandQueue extends IStatusBar.Stub {
    ...
    public void removeIcon(int index) {
    	///Log.i(TAG, "removeIcon: index:" + index);
        synchronized (mList) {
            int what = MSG_ICON | index;
            mHandler.removeMessages(what);
    ...
    public void disable(int state1, int state2) {
    	//Log.i(TAG, " disable: state1:" + state1 + " state2:" + state2);
        synchronized (mList) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                case MSG_ICON: {
                    ...
                    switch (msg.arg1) {
                        case OP_SET_ICON: {
                            //Log.i(TAG, "CommandQueue:H::handleMessage OP_SET_ICON");
                        ...
                        case OP_REMOVE_ICON:
                            //Log.i(TAG, "CommandQueue:H::handleMessage OP_REMOVE_ICON");
                ...
                case MSG_DISABLE:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_DISABLE");
                    mCallbacks.disable(msg.arg1, msg.arg2, true /* animate */);
                    break;
                case MSG_EXPAND_NOTIFICATIONS:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_EXPAND_NOTIFICATIONS");
                    mCallbacks.animateExpandNotificationsPanel();
                    break;
                case MSG_COLLAPSE_PANELS:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_COLLAPSE_PANELS");
                    mCallbacks.animateCollapsePanels(0);
                    break;
                case MSG_EXPAND_SETTINGS:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_EXPAND_SETTINGS");
                    mCallbacks.animateExpandSettingsPanel();
                    break;
                case MSG_SET_SYSTEMUI_VISIBILITY:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_SET_SYSTEMUI_VISIBILITY");
                    mCallbacks.setSystemUiVisibility(msg.arg1, msg.arg2);
                    break;
                case MSG_TOP_APP_WINDOW_CHANGED:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_TOP_APP_WINDOW_CHANGED");
                    mCallbacks.topAppWindowChanged(msg.arg1 != 0);
                    break;
                case MSG_SHOW_IME_BUTTON:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_SHOW_IME_BUTTON");
                    mCallbacks.setImeWindowStatus((IBinder) msg.obj, msg.arg1, msg.arg2,
                            msg.getData().getBoolean(SHOW_IME_SWITCHER_KEY, false));
                    break;
                case MSG_SHOW_RECENT_APPS:
                    //Log.i(TAG, "CommandQueue:H::handleMessage MSG_SHOW_RECENT_APPS");
