...
public class MobileSignalController extends SignalController<
    ...
    public void notifyListeners() {
        ...
        //networkIcon = R.drawable.hmb_stat_sys_data_fully_connected_4g;
        //ShenQianfeng add end
        /// @ }
        
        Log.i(TAG, "MobileSignalController::notifyListeners activityIn:" + activityIn + 
    ...
    private final void updateTelephony() {
        ...
        if (mNetworkToIconLookup.indexOfKey(mDataNetType) >= 0) {
            Log.i(TAG, "MobileSignalController::updateTelephony mDataNetType:" + mDataNetType);
        ...
        if(isRoaming()) {
            mCurrentState.networkIcon = R.drawable.hmb_stat_sys_data_fully_connected_roam;
        }else {
