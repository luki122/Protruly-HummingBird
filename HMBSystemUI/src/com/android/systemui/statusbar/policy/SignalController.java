...
public abstract class SignalController<T extends SignalController.State,
    ...
    public int getCurrentIconId() {
        /*
        Log.i("1111", "SignalController::getCurrentIconId mCurrentState class:" + mCurrentState.getClass().getName() + 
                " mCurrentState.inetCondition:" + mCurrentState.inetCondition + 
