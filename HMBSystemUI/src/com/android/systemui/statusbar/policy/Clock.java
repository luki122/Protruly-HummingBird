...
public class Clock extends TextView implements DemoMode {
    ...
    private static final int AM_PM_STYLE_LARGE    = 3; //add by chenhl
    ...
    private final CharSequence getSmallTime() {
        ...
        /*
        Log.i(TAG, "time format:" + format + " mClockFormatString:" + mClockFormatString +
                " MAGIC1:" + MAGIC1 + " MAGIC2:" + MAGIC2 + 
                " d.timeFormat_Hm:" + d.timeFormat_Hm + 
                " d.timeFormat_hm:" + d.timeFormat_hm) ;*/
        if (!format.equals(mClockFormatString)) {
            ...
            if (mAmPmStyle != AM_PM_STYLE_NORMAL) {
                ...
                if (a >= 0) {
                    ...
                    //Log.i(TAG, "time format 22222:" + format );
                    //add by chenhl start
                    if(a==0){
                        mAmPmStyle=AM_PM_STYLE_LARGE;
                    }else{
            ...
            if (magic1 >= 0 && magic2 > magic1) {
                ...
                if (mAmPmStyle == AM_PM_STYLE_GONE) {
                    ...
                    if (mAmPmStyle == AM_PM_STYLE_SMALL) {
                        CharacterStyle style = new RelativeSizeSpan(1f);
                        formatted.setSpan(style, magic1, magic2,
                                          Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
                    }
                    //add by chenhl start
                    else if(mAmPmStyle==AM_PM_STYLE_LARGE){
                        CharacterStyle style = new RelativeSizeSpan(0.9f);
                        formatted.setSpan(style, magic1, magic2,
                                Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
                    }
                    //add by chenhl end
