...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    void doUpdateMobileControllers() {
        //modify by chenhl start for fix bug 2453
        try {
    ...
    void handleIMSAction(Intent intent) {
        ...
        mImsSubId = getSubIdUsingPhoneId(phoneId);
        ...
        for (int i = 0; i < mSlotCount; i++) {
            ...
            for (Map.Entry<Integer, MobileSignalController> entry : mMobileSignalControllers
                ...
                if (i == slotId) {
                    ...
                    PluginManager.getSystemUIStatusBarExt(mContext).setSimInserted(i, true);
                    found = true;
                    break;
                }
            }
            ...
            if (!found) {
                ...
                PluginManager.getStatusBarPlmnPlugin(mContext).updateCarrierLabel(i, false, false,
                        mNetworkName);
                PluginManager.getSystemUIStatusBarExt(mContext).setSimInserted(i, false);
            }
        }
    }
    /// M: Support "Operator plugin - Customize Carrier Label for PLMN". @}
