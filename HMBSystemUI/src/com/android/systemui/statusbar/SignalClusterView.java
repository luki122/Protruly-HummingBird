...
public class SignalClusterView
    ...
    public void setWifiIndicators(boolean enabled, IconState statusIcon, IconState qsIcon,
        ...
        apply();
        Log.i(TAG, "mWifiStrengthId :" + mWifiStrengthId + " mWifiVisible:" + mWifiVisible + " statusIcon.visible:" + statusIcon.visible + " mBlockWifi:" + mBlockWifi + " mWifiDescription:" + mWifiDescription);
    }
    ...
    public void onRtlPropertiesChanged(int layoutDirection) {
        ...
        for (PhoneState state : mPhoneStates) {
            ...
            //ShenQianfeng annotated begin
            /*
            if (state.mMobileType != null) {
                state.mMobileType.setImageDrawable(null);
            }
            */
            //ShenQianfeng annotated end
        }
    ...
    private void apply() {
        ...
        if (((anyMobileVisible && firstMobileTypeId != 0) || mNoSimsVisible) && mWifiVisible) {
            //Log.i(TAG, "SignalClusterView:: mWifiSignalSpacer set to visible");
            mWifiSignalSpacer.setVisibility(View.VISIBLE);
        } else {
            //Log.i(TAG, "SignalClusterView:: mWifiSignalSpacer set to gone");
    ...
    private void applyIconTint() {
        ...
        setTint(mVolteIcon,mIconTint); //add by chenhl
    ...
    private class PhoneState {
        ...
        private ImageView mMobileDataIn, mMobileDataOut;
        ...
        public boolean apply(boolean isSecondaryIcon) {
            ...
            //ShenQianfeng add begin
            mMobileDataIn.setVisibility(mDataActivityIn ? View.VISIBLE : View.INVISIBLE);
            mMobileDataOut.setVisibility(mDataActivityOut ? View.VISIBLE : View.INVISIBLE);
            Log.i(TAG, "SignalClusterView::PhoneState::apply mDataActivityIn:" + mDataActivityIn + 
        ...
        public void setIconTint(int tint, float darkIntensity) {
            ...
            //ShenQianfeng add begin
            setTint(mMobileDataIn, tint);
            setTint(mMobileDataOut, tint);
            //ShenQianfeng add end
        }
