...
public class KeyguardStatusBarView extends RelativeLayout
        implements BatteryController.BatteryStateChangeCallback, NetworkSpeedUpdateListener {
    ...
    private NetworkSpeedTracker mNetworkSpeedTracker;
    ...
    protected void onFinishInflate() {
        ...
        //Modify to:
        mBatteryLevel = (TextView) mSystemIconsSuperContainer.findViewById(R.id.battery_level);
        mNetworkSpeedTextView = (TextView)mSystemIconsSuperContainer.findViewById(R.id.network_speed);
        CustomBatteryMeterView batteryMeterView=(CustomBatteryMeterView)mSystemIconsSuperContainer.findViewById(R.id.battery);
        batteryMeterView.setBatteryLevelTextView(mBatteryLevel);
        //ShenQianfeng modify end
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        //add by chenhl start
        mNetworkSpeedTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,getResources().getDimensionPixelSize(R.dimen.hb_network_text_size));
        //add by chenhl end
    }
    ...
    //ShenQianfeng add begin
    public void setNetworkSpeedTracker(NetworkSpeedTracker tracker) {
        mNetworkSpeedTracker = tracker;
