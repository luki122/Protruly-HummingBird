...
public class PhoneStatusBarPolicy implements Callback {
    ...
    /*private final*/ protected StatusBarManager mService;
    ...
    public PhoneStatusBarPolicy(Context context, CastController cast, HotspotController hotspot,
        ...
        //Modify to:
        mService.setIcon(SLOT_TTY,  R.drawable.hmb_stat_sys_tty_mode, 0, null);
        ...
        //Modify to:
        mService.setIcon(SLOT_ALARM_CLOCK, R.drawable.hmb_stat_sys_alarm, 0, null);
        //ShenQianfeng modify end
        ...
        //Modify to:
        mService.setIcon(SLOT_VOLUME, R.drawable.hmb_stat_sys_ringer_vibrate, 0, null);
        //ShenQianfeng modify end
        ...
        mService.setIcon(SLOT_HOTSPOT, R.drawable.stat_sys_hotspot, 0,
                ...
                */
        //Modify to:
        mService.setIcon(SLOT_HOTSPOT, R.drawable.hmb_stat_sys_hotspot, 0,
                mContext.getString(R.string.accessibility_status_bar_hotspot));
        //ShenQianfeng modify end
    ...
    private void updateAlarm() {
        ...
        //Modify to:
        mService.setIcon(SLOT_ALARM_CLOCK, zenNone ? R.drawable.hmb_stat_sys_alarm_dim
                : R.drawable.hmb_stat_sys_alarm, 0, null);
        //ShenQianfeng modify end
    ...
    private final void updateVolumeZen() {
        ...
        if (DndTile.isVisible(mContext) || DndTile.isCombinedIcon(mContext)) {
            ...
            //Modify to:
            zenIconId = mZen == Global.ZEN_MODE_NO_INTERRUPTIONS
                    ? R.drawable.stat_sys_dnd_total_silence : R.drawable.hmb_stat_sys_dnd;
            //ShenQianfeng modify end
            ...
            Log.i(TAG, "22222222222222222222222222222222222222");
            zenVisible = true;
        ...
        if (DndTile.isVisible(mContext) && !DndTile.isCombinedIcon(mContext)
            ...
            //Modify to:
            volumeIconId = R.drawable.hmb_stat_sys_ringer_silent;
            ...
            //Modify to:
            volumeIconId = R.drawable.hmb_stat_sys_ringer_vibrate;
            //ShenQianfeng modify end
            volumeDescription = mContext.getString(R.string.accessibility_ringer_vibrate);
            
            Log.i(TAG, "555555555555555555555555555555555");
        }
		zenVisible = false; //add by chenhl
        if (zenVisible) {
    ...
    private boolean mBlueToothEnanble=false;
    private int mBlueToothId=-1;
    private final void updateBluetooth() {
        //ShenQianfeng modify begin
        //Original:
        //int iconId = R.drawable.stat_sys_data_bluetooth;
        //Modify to:
        int iconId = R.drawable.hmb_stat_sys_data_bluetooth;
        //ShenQianfeng modify end
        ...
        if (mBluetooth != null) {
            ...
            if (mBluetooth.isBluetoothConnected()) {
                ...
                //Modify to:
                iconId = R.drawable.hmb_stat_sys_data_bluetooth_connected;
                //ShenQianfeng modify end
                contentDescription = mContext.getString(R.string.accessibility_bluetooth_connected);
            }
        }
        if(mBlueToothEnanble!=bluetoothEnabled||mBlueToothId!=iconId) {
            mBlueToothEnanble = bluetoothEnabled;
            mBlueToothId = iconId;
    ...
    /*private final */protected void updateTTY(Intent intent) {
        ...
        if (enabled) {
            ...
            */
            //Modify to:
            mService.setIcon(SLOT_TTY, R.drawable.hmb_stat_sys_tty_mode, 0,
                    mContext.getString(R.string.accessibility_tty_enabled));
            //ShenQianfeng modify end
    ...
    protected void updateHeadset(Intent intent) {
        ...
        if (state == 1) {
            ...
            //Modify to:
            iconId = mic == 1 ? R.drawable.hmb_stat_sys_headset_with_mic :
            R.drawable.hmb_stat_sys_headset_without_mic;
            //ShenQianfeng modify end
