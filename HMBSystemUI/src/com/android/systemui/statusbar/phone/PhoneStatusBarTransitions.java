...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    //add by chenhl start
    private View mNetSeed,mBatteryLevel;
    //add by chenhl end
    ...
    public void init() {
        ...
        //add by chenhl start
        mNetSeed = mView.findViewById(R.id.network_speed);
        mBatteryLevel = mView.findViewById(R.id.battery_level);
        //add by chenhl end
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    //add by chenhl start
                    animateTransitionTo(mNetSeed, newAlpha),
                    animateTransitionTo(mBatteryLevel, newAlphaBC)
                    //add by chenhl end
                    );
            if (isLightsOut(mode)) {
            ...
            //add by chenhl start
            mNetSeed.setAlpha(newAlpha);
            mBatteryLevel.setAlpha(newAlphaBC);
            //add by chenhl end
        }
    }
}