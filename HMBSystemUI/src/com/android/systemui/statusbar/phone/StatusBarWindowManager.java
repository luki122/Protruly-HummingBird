...
public class StatusBarWindowManager {
    ...
    private void applyKeyguardFlags(State state) {
        //Log.i(TAG, "applyKeyguardFlags state:" + state);
    ...
    private void applyHeight(State state) {
        //Log.i(TAG, "applyHeight: state: " + state);
    ...
    private boolean isExpanded(State state) {
    	//HB. Comments : resloved statusbar flickered when used fingerprint , Engerineer : wxue , Date : 2017年6月23日 ,begin
        /*return !state.forceCollapsed && (state.isKeyguardShowingAndNotOccluded()
                || state.panelVisible || state.keyguardFadingAway || state.bouncerShowing
                || state.headsUpShowing);*/
        return !state.forceCollapsed && (state.isKeyguardShowingAndNotOccluded()
                || state.panelVisible || state.isKeyguardFadingAway() || state.bouncerShowing
                || state.headsUpShowing);
        //HB. end
    }
    ...
    private static class State {
        ...
        //HB. Comments : resloved statusbar flickered when used fingerprint , Engerineer : wxue , Date : 2017年6月23日 ,begin
        private boolean isKeyguardFadingAway(){
        	return keyguardFadingAway && !keyguardOccluded;
        }
        //HB. end
