...
public class StatusBarKeyguardViewManager {
    ...
    private void showBouncerOrKeyguard() {
        ...
        mPhoneStatusBar.setCanShowBouncerWallpaper();
        // add by wxue 20140426 end
    ...
    public void updateStates() {
        ...
        //HB. Comments : TODO , Engerineer : wxue , Date : 2017年6月20日 ,begin
        if(occluded != mLastOccluded || mFirstUpdate){
        	updateMonitor.sendKeyguardOccluded(occluded);
        }
        //HB. end
	...
	public void setPwroffAlarmBg(boolean show) {
		mBouncer.setPwroffAlarmBg(show);
	}
}
