        ...
        if (!mDemoMode && command.equals(COMMAND_ENTER)) {
            ...
            if (volume != null) {
                ...
                int iconId = volume.equals("vibrate") ? R.drawable.stat_sys_ringer_vibrate
                        : 0;*/
                //Modify to:
                int iconId = volume.equals("vibrate") ? R.drawable.hmb_stat_sys_ringer_vibrate
                        : 0;
            ...
            if (bt != null) {
                ...
                int iconId = bt.equals("disconnected") ? R.drawable.stat_sys_data_bluetooth
                        ...
                        : 0; */
                //Modify to:
                int iconId = bt.equals("disconnected") ? R.drawable.hmb_stat_sys_data_bluetooth
                        : bt.equals("connected") ? R.drawable.hmb_stat_sys_data_bluetooth_connected
                        : 0;
                //ShenQianfeng modify end
            ...
            if (hotspot != null) {
                ...
                //Modify to:
                int iconId = hotspot.equals("show") ? R.drawable.hmb_stat_sys_hotspot : 0;
                //ShenQianfeng modify end
