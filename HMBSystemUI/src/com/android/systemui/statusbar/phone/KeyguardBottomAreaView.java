...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    private AccessibilityDelegate mAccessibilityDelegate = new AccessibilityDelegate() {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfo info) {
            ...
            String label = null;
            // modify by wxue for hide mLockIcon and mLeftAffordanceView 20170315 start
            /*if (host == mLockIcon) {
            ...
            if (host == mCameraImageView) {
                label = getResources().getString(R.string.camera_label);
            } 
            // modify by wxue for hide mLockIcon and mLeftAffordanceView 20170315 end
    ...
    protected void onFinishInflate() {
        ...
        // add by wxue 20170410 start
        Typeface typeface = Typeface.createFromFile("/system/fonts/NotoSansSC-Regular.otf");
        if(typeface != null){
        	mIndicationText.setTypeface(typeface);
        }
        // add by wxue 20170410
        watchForCameraPolicyChanges();
        updateCameraVisibility();
        mUnlockMethodCache = UnlockMethodCache.getInstance(getContext());
        mUnlockMethodCache.addListener(this);
        // modify by wxue for hide mLockIcon 20170315 start
        //mLockIcon.update();
        // modify by wxue for hide mLockIcon 20170315 end
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        // del by wxue 20170412 start
        /*mIndicationText.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                getResources().getDimensionPixelSize(
                        com.android.internal.R.dimen.text_size_small_material));*/
        // del by wxue 20170412 end
    ...
    public void setUserSetupComplete(boolean userSetupComplete) {
        ...
        updateCameraVisibility();
        // modify by wxue for hide mLeftAffordanceView 20170315 start
        //updateLeftAffordanceIcon();
        // modify by wxue for hide mLeftAffordanceView 20170315 end
    }
