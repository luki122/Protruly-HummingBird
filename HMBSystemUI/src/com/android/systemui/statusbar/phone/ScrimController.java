...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener,
    ...
    private final String TAG = "ScrimController";
    private static final float SCRIM_BEHIND_ALPHA = 0f;//0.62f;//modify by chenhl
    ...
    private void updateScrimKeyguard() {
        if (mExpanding /*&& mDarkenWhileDragging*/) { // del by wxue 20170502 
