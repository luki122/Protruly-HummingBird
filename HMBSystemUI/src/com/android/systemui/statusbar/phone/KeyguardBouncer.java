...
public class KeyguardBouncer {
    ...
    private void inflateView() {
		...
		showPwroffAlarmBg(mIsShowPwroffAlarm);
    }
    ...
    public boolean onBackPressed() {
    	// modify by wxue 20170519 start
    	//return mKeyguardView != null && mKeyguardView.handleBackKey();
    	return mKeyguardView != null && mKeyguardView.onBackPressed();
    	// modify by wxue 20170519 end
    }
	...
	private boolean mIsShowPwroffAlarm = false;
	public void setPwroffAlarmBg(boolean show) {
		mIsShowPwroffAlarm = show;
		Log.d(TAG, " lq_pwroffa ----------> setPwroffAlarmBg() - mIsShowPwroffAlarm = " + mIsShowPwroffAlarm);
		showPwroffAlarmBg(show);
	}

	private void showPwroffAlarmBg(boolean show) {
		Log.d(TAG, " lq_pwroffa ----------> showPwroffAlarmBg() - show = " + show);
		if (mRoot != null) {
			mRoot.setBackground(new FastColorDrawable(mContext.getColor(show?R.color.power_off_alarm_bg:R.color.power_off_alarm_no_bg),show));
		}
	}
    ...
    private static class FastColorDrawable extends Drawable {
        ...
        public FastColorDrawable(int color, boolean show) {
