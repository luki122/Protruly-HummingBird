...
public class NotificationOverflowIconsView extends IconMerger {
    ...
    private void applyColor(Notification notification, StatusBarIconView view) {
        ...
        boolean isPreL = Boolean.TRUE.equals(view.getTag(R.id.icon_is_pre_L));
        boolean colorize = !isPreL || isGrayscale(view);
        if(colorize) {
            view.setImageTintList(ColorStateList.valueOf(mTintColor));
        }
    }
