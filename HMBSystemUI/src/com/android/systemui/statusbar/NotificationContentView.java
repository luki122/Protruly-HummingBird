...
public class NotificationContentView extends FrameLayout {
    ...
    private int mNotificationWidthMargin=0;//add by chenhl
    ...
    public NotificationContentView(Context context, AttributeSet attrs) {
        ...
        //add by chenhl start
        mNotificationWidthMargin = getResources().getDimensionPixelSize(R.dimen.hb_notification_status_margin);
        //add by chenhl end
        reset(true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //add by chenhl start
        int rlWidth = MeasureSpec.getSize(widthMeasureSpec)-mNotificationWidthMargin*2;
        widthMeasureSpec = MeasureSpec.makeMeasureSpec(rlWidth,MeasureSpec.EXACTLY);
        //add by chenhl end
