...
public class AmbientState {
    ...
    //add by chenhl start
    private float mTansbt;
    private float mMaxStackH;
    public void setTransBeween(float b){
        mTansbt =b;
    }
    public float geTtransBeween(){
        return mTansbt;
    }
    public void setMaxStackH(float h){
        mMaxStackH = h;
    }
    public float getMaxStackH(){
        return mMaxStackH;
    }
    //add by chenhl end
}
