...
public class NotificationData {
    ...
    public static final class Entry {
        ...
        public StatusBarIconView keyguardicon; //add by chenhl
        ...
        public Entry(StatusBarNotification n, StatusBarIconView ic,StatusBarIconView kic) {
            this.key = n.getKey();
            this.notification = n;
            this.icon = ic;
            this.keyguardicon=kic;
        }
        ...
        public String toString() {
            ...
            builder.append("interruption:" + interruption + "\n");
            builder.append("autoRedacted:" + autoRedacted + "\n");
            builder.append("legacy:" + legacy + "\n");
            builder.append("targetSdk:" + targetSdk + "\n");
            builder.append("lastFullScreenIntentLaunchTime:" + lastFullScreenIntentLaunchTime + "\n");
            builder.append("--------------------------" + "\n");
    ...
    public void add(Entry entry, RankingMap ranking) {
        //Log.i("NotificationData", "NotificationData::add -> entry.notification.getKey():" + (entry.notification.getKey()));
    ...
    //if NotificationBox is on, and this notification is not priority_max,
    //filter it out.
    public boolean shouldHideStatusBarIconWhenNotificationBoxOn(Entry entry) {
        StatusBarNotification sbn = entry.notification;
        if(mCustomStatusBarManager.isNotificationBoxOn() && 
           ! mCustomStatusBarManager.isNotificationPriorityMax(sbn)) {
            Log.i(TAG, "NotificationData::shouldHideStatusBarIconWhenNotificationBoxOn return true pkg:" + sbn.getPackageName());
            return true;
        }
        Log.i(TAG, "NotificationData::shouldHideStatusBarIconWhenNotificationBoxOn return false pkg:" + sbn.getPackageName());
        return false;
    }
    ...
    public boolean canShowBox(){
        ArrayList<NotificationData.Entry> activeNotifications = getActiveNotifications();
        ...
        for(int i=0;i<N;i++){
            ...
            if(mCustomStatusBarManager.isNotificationPriorityMax(entry.notification)){
                return true;
            }
        }
        return false;
    ...
    boolean shouldFilterOut(StatusBarNotification sbn) {
        ...
        //filter it out.
        /*
        Log.i(TAG, " !!! NotificationData isNotificationBoxOn ---> " + mCustomStatusBarManager.isNotificationBoxOn());
        if(mCustomStatusBarManager.isNotificationBoxOn() && 
           ! mCustomStatusBarManager.isNotificationPriorityMax(sbn)) {
            Log.i(TAG, " !!! NotificationData::shouldFilterOut return true pkg:" + sbn.getPackageName());
            return true;
        }
        */
        //ShenQianfeng add end
        //Log.i(TAG, " !!! NotificationData::shouldFilterOut return false pkg:" + sbn.getPackageName());
        return false;
    }
