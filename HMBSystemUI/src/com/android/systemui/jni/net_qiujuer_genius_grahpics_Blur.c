...
Java_com_android_systemui_Blur_nativeStackBlurPixels(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_android_systemui_Blur_nativeStackBlurBitmap(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_android_systemui_Blur_nativeStackBlurBitmapClip(JNIEnv *env, jclass type,
                                                                jobject bitmap, jint r,
                                                                jint parts) {
    AndroidBitmapInfo infoIn;
    void *pixels;
