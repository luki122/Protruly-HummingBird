...
public class MobileDataTile extends QSTile<QSTile.SignalState> {
    ...
    private static final int QS_MOBILE_DISABLE = R.drawable.hb_data_off;
    private static final int QS_MOBILE_ENABLE = R.drawable.hb_data_on;
    ...
    protected void handleClick() {
    	...
    	if(mAirplaneModeEnabled) {
    		Toast.makeText(mContext, R.string.mobiledata_in_airplanemode, Toast.LENGTH_SHORT).show();
    	}
    	/**hb tangjun add  end*/
    ...
    protected void handleLongClick() {
        ...
        */
    	...
    	Intent intent =  new Intent("com.hb.settings.SimSettings");
    ...
    protected void handleUpdateState(QSTile.SignalState state, Object arg) {
        ...
        */
		state.label = mContext.getString(R.string.quick_settings_mobiledata_mode_label);
    ...
    private final class MobileDataSignalCallback extends SignalCallbackAdapter {
        ...
        public void setIsAirplaneMode(IconState icon) {
            ...
            refreshState(mInfo);
            /**hb tangjun add begin*/
            mAirplaneModeEnabled = mInfo.airplaneModeEnabled;
            /**hb tangjun add end*/
        }
