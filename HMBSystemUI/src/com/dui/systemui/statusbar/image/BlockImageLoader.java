...
import com.dui.systemui.statusbar.image.factory.HbBitmapRegionDecoder;
...
//        图片没被位移，那么屏幕上显示横向2列，纵向getDisplayMetrics().heightPixels/BASEBLOCKSIZE行
    ...
    private static class LoadData {
        ...
        private volatile HbBitmapRegionDecoder mDecoder;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == MESSAGE_LOAD) {//start调用的一开始加载图片的图片信息
                if (loadData.mFactory != null && loadData.mDecoder == null) {
                    ...
                    try {
                        HbBitmapRegionDecoder decoder = loadData.mFactory.made();
...
//            }
                ...
                HbBitmapRegionDecoder decoder = loadData.mDecoder;
                if (decoder != null && loadData.mCacheImageData == null) {
                    ...
                    decodingOptions.inPreferredConfig = Bitmap.Config.RGB_565;//add by chenhl
                    try {
