...
//            simPref.setEnabled(isDataPrefEnable());
    ...
    private void updateSimInfo() {
        ...
        boolean isShowDataSelect = isShowSelect;
        ...
        if(PhoneGlobals.sCmccVersion) {
          ...
          Log.i(LOG_TAG, "updateSimInfo simOperator1 = " + simOperator1 + ", simOperator2 = " + simOperator2);
			
//          	List<SubscriptionInfo> mSubscriptionInfos = PhoneUtils.getActiveSubInfoList();    
