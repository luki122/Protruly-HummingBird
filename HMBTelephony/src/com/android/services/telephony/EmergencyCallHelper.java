...
public class EmergencyCallHelper {
                ...
                case MSG_MODE_SWITCH_RESULT:
                    ...
                    if (ar.exception != null) {
                        ...
                        if (mFailRetryCount++ < MAX_FAIL_RETRY_COUNT) {
                            mHandler.sendMessageDelayed(mHandler.obtainMessage(MSG_START_SWITCH_PHONE),
    ...
    private void onRetryTimeout() {
        ...
        /// @}
            ...
            Log.d(this, "isAirplaneModeOn:" + isAirplaneModeOn);
            /// @}
            if (mNumRetriesSoFar > MAX_NUM_RETRIES || isAirplaneModeOn) {
