...
import com.android.contacts.common.interactions.MultiChoiceHandlerListener;
import com.android.contacts.common.interactions.MultiChoiceRequest;
import com.android.contacts.common.interactions.MultiChoiceService;
...
//		showDialog(getString(messageId));
	...
	private HbDeleteRequestListener listener=new HbDeleteRequestListener() {
		...
		public void onProcessed(int requestType, int jobId, int currentCount,
			...
			if(mHandler!=null && currentCount>0){
