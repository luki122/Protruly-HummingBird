...
//                delayMs + FAB_SCALE_IN_FADE_IN_DELAY, null);
    ...
    public void scaleInHb(int delayMs,AnimatorListenerAdapter listener,ViewPropertyAnimator animator) {
    	Log.d(TAG,"scaleInternal:"+delayMs);
        setVisible(true);        

        AnimUtils.scaleInternalHb(mFloatingActionButtonContainer, 0 /* startScaleValue */, 1 /* endScaleValue */, FAB_SCALE_IN_DURATION,
        		delayMs, listener, AnimUtils.EASE_IN,animator);
    }
