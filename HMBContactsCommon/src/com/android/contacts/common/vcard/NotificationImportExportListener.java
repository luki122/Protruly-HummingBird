...
Handler.Callback {
	...
	public void onImportFinished(ImportRequest request, int jobId, Uri createdUri) {
		...
		if (/*createdUri != null*/false) {
			...
			intent=getAppOpenIntentByPackageName(mContext, "com.android.dialer");
			intent.setClassName("com.android.contacts", "com.android.dialer.DialtactsActivity");
	...
	/* package */ static Notification constructProgressNotification(
		...
		Intent notificationIntent = new Intent("android.intent.action.contacts.HbContactImportExportActivity");
	...
	public static Notification hbConstructProgressNotification(
			Context context, int type, String description, String tickerText,
