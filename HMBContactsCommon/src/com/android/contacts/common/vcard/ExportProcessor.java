...
import hb.provider.ContactsContract.RawContactsEntity;
...
public class ExportProcessor extends ProcessorBase {
    ...
    private boolean isForShareContacts=false;
    public ExportProcessor(VCardService service, ExportRequest exportRequest, int jobId,
            String callingActivity,boolean isForShareContacts) {
    	this(service,exportRequest,jobId,callingActivity);
    	this.isForShareContacts=isForShareContacts;
    }
    ...
    private void runInternal() {
        ...
        try {
           ...
           // composer = ExtensionManager.getInstance().getImportExportExtension()
			...
			intent.putExtra("isForShareContacts", isForShareContacts);
            ...
            while (!composer.isAfterLast()) {
                ...
                if (/*current % 100 == 1*/!isForShareContacts) {
    			...
    			intent1.putExtra("isForShareContacts", isForShareContacts);
