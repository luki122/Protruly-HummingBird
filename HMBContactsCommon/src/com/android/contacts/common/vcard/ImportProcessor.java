...
public class ImportProcessor extends ProcessorBase implements VCardEntryHandler {
    ...
    public void onEntryCreated(VCardEntry entry) {
    	Log.d(TAG,"onEntryCreated,entry:"+entry);
		...
		Intent intent=new Intent("CONTACTS_IMPORT_FROM_SD_DOING");
		intent.putExtra("index", mCurrentCount);
		intent.putExtra("totalContacts", mTotalCount);
		intent.putExtra("mJobId", mJobId);
		intent.putExtra("displayName",mImportRequest.displayName);
    ...
    private void runInternal() {
        ...
        Log.d(TAG,"estimatedVCardType:"+estimatedVCardType+" account:"+account+" estimatedCharset:"+estimatedCharset);
            ...
            if (isCancelled()) {
                ...
                if (mListener != null) {
                    if (uris != null && uris.size() == 1) {
                		Intent intent1=new Intent("CONTACTS_IMPORT_FROM_SD_COMPLETE");
                		intent1.putExtra("mTotalCount", mTotalCount);
