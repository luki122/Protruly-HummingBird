...
DialogInterface.OnClickListener, DialogInterface.OnCancelListener {
			...
			case VCardService.MSG_SET_AVAILABLE_EXPORT_DESTINATION:
				if (msg.obj == null) {
					...
					if (TextUtils.isEmpty(mTargetFileName)) {
						...
						.setTitle(getString(R.string.hb_menu_export_to_sd))
						.setMessage(getString(R.string.hb_export_sim_contacts_to_sd_confication_message,mTargetFileName))
	...
	private class ExportConfirmationListener implements DialogInterface.OnClickListener {
		...
		public void onClick(DialogInterface dialog, int which) {
			long availableStore=getAvailableStore(getIntent().getStringExtra("dest_path"));
			Log.d(TAG,"availableStore:"+availableStore);
			if(availableStore<5000000) {
				Toast.makeText(ExportVCardActivity.this, getString(R.string.hb_store_unavailable), Toast.LENGTH_LONG).show();
				finish();
				return;
			}
	...
	protected void onCreate(Bundle bundle) {
		...
		Log.d(TAG,"dest_path0:"+getIntent().getStringExtra("dest_path"));
	...
	public synchronized void onServiceConnected(ComponentName name, IBinder binder) {
		 ...
		 */
		Log.d(TAG,"dest_path:"+getIntent().getStringExtra("dest_path"));
