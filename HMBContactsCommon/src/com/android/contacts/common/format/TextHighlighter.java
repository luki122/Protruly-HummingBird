...
public class TextHighlighter {
    ...
    public TextHighlighter(CharacterStyle mTextStyleSpan) {
        this.mTextStyleSpan = mTextStyleSpan;
    }
...
//        final String trimmedPrefix = prefix.substring(prefixStart);
        ...
        final String trimmedPrefix=prefix;//modify by liyang 2017-5-15

//        Log.d(TAG,"trimmedPrefix:"+trimmedPrefix);
//        int index = FormatUtils.indexOfWordPrefix(text, trimmedPrefix);
        int index=text.toString().toUpperCase().indexOf(prefix);////modify by liyang 2017-5-15
