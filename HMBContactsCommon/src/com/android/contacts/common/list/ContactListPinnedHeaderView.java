...
public class ContactListPinnedHeaderView extends TextView {
    ...
    public ContactListPinnedHeaderView(Context context, AttributeSet attrs, View parent) {
       ...
       /* TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ContactListItemView);
        ...
        //modify by liyang       
        int height=getContext().getResources().getDimensionPixelOffset(R.dimen.hb_contacts_listview_header_height);
        setBackgroundColor(getContext().getResources().getColor(R.color.hb_contactlist_header_background_color));
        setTextAppearance(getContext(), R.style.hb_contacts_listview_header);
