...
public abstract class IndexerListAdapter extends PinnedHeaderListAdapter implements SectionIndexer {
    ...
    private static final String TAG = "IndexerListAdapter";
    ...
    public void setSectionHeaderDisplayEnabled(boolean flag) {
    	Log.d(TAG,"setSectionHeaderDisplayEnabled:"+flag);
...
//        Log.d(TAG,"getSectionForPosition,position:"+position+" section:"+section);
        return section;
    }
