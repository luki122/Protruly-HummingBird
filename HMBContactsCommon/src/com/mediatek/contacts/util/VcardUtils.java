...
public class VcardUtils {
    ...
    public static void setDestSelection(VCardService service, Activity activity) {
        ...
        android.util.Log.d(TAG, "[setDestSelection]destStoragePath:" + destStoragePath + ",selection = "
                + selection);
    ...
    public static String getSaveFilePathDescription(String path, Activity activity) {
        ...
        if (null == mSM) {
        	android.util.Log.e(TAG, "[getSaveFilePathDescription]Failed to get StorageManager");
            return path;
        }
        ...
        for (StorageVolume storageVolume : volumes) {
            ...
            android.util.Log.d(TAG, "[getSaveFilePathDescription]path: " + saveFilePath + ",description: "
                    + saveFilePathDescription);
            if (path.startsWith(saveFilePath)) {
                return path.replace(saveFilePath, saveFilePathDescription);
            }
        }
        android.util.Log.e(TAG, "[getSaveFilePathDescription]Not found volume for path: " + path);
        return path;
    }
