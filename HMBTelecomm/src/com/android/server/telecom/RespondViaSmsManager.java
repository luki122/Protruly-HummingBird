        ...
        new Thread() {
            ...
            public void run() {
                ...
                textMessages.add(0, prefs.getString(QuickResponseUtils.KEY_CANNED_RESPONSE_PREF_1,
                        res.getString(R.string./*respond_via_sms_canned_response_1*/hb_respond_via_sms_canned_response_1)));
                textMessages.add(1, prefs.getString(QuickResponseUtils.KEY_CANNED_RESPONSE_PREF_2,
                        res.getString(R.string./*respond_via_sms_canned_response_2*/hb_respond_via_sms_canned_response_2)));
                textMessages.add(2, prefs.getString(QuickResponseUtils.KEY_CANNED_RESPONSE_PREF_3,
                        res.getString(R.string./*respond_via_sms_canned_response_3*/hb_respond_via_sms_canned_response_3)));
                //delete by lgy 
