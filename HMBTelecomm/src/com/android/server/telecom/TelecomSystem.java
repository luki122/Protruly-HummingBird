...
import com.hb.interception.ManageReject;
...
public final class TelecomSystem {
    ...
    public TelecomSystem(
        ...
        //add by lgy
    	TmsServiceManager.getInstance(mContext).bindService();
    	mManageReject = new ManageReject(mContext);
    }
    ...
    //add by lgy
    public static final boolean isHbUI = true;
    private ManageReject mManageReject;
