...
import com.hb.smartringer.VolumeManager;
...
final class Ringer extends CallsManagerListenerBase {
    ...
    public void onCallStateChanged(Call call, int oldState, int newState) {
        ...
        //zhangcj delete for 6840.we add  vibrate in VibratorManager(incallui)
...
//                    }
    ...
    private boolean isUseSmartRinger() {
    	...
    	Cursor c = mContext.getContentResolver().query(uri, null, " name = 'smartringer'", null, null);
    	if(c != null) {
    		if(c.moveToFirst()) {
