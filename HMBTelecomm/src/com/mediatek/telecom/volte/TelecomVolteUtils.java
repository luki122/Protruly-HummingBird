...
public class TelecomVolteUtils {
    ...
    public static final String EXTRA_VOLTE_IMS_CALL = "com.mediatek.phone.extra.ims";
    ...
    public static boolean isImsCallOnlyRequest(Object obj) {
        ...
        if (isVolteSupport() && obj != null) {
            if (obj instanceof Bundle) {
                ...
                result = intent.getBooleanExtra(EXTRA_VOLTE_IMS_CALL, false);
                // If not indicated with extra, then check the Uri.
