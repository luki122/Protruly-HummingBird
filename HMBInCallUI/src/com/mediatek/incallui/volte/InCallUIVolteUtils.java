...
public class InCallUIVolteUtils {
    ...
    public static boolean isPhoneNumberChanged(final android.telecom.Call.Details oldDetails,
        ...
        //zhangcj modify
        result = !TextUtils.equals(numberOld.replace(" ", ""), numberNew.replace(" ", ""));
        if (result) {
     ...
     * @return true if yes.
     */
    public static boolean isIncomingVolteConferenceCall(Call call) {
        return call != null
                && Call.State.isIncoming(call.getState())
                && call.isConferenceCall()
                && call.hasProperty(android.telecom.Call.Details.PROPERTY_VOLTE);
    }
}
