...
public class InCallUiWfcUtils {
 ...
 public static boolean maybeShowCongratsPopup(Context context, DisconnectCause disconnectCause) {
     if(ImsManager.isWfcEnabledByUser(context)
         ...
         Log.d(LOG_TAG, "[wfc]maybeShowCongratsPopup maybeShowCongratsPopup ");
         maybeShowPopup(context);
         return true;
     } else {
         return false;
     }
 }
 public static void maybeShowPopup(Context context) {
        sContext = context;
        SharedPreferences  pref = PreferenceManager.getDefaultSharedPreferences(context);
        int TIMER = 500;
        Log.i(LOG_TAG, "[WFC]maybeShowPopup pref.getBoolean(KEY_IS_FIRST_WIFI_CALL"
