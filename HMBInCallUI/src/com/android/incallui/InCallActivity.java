...
import com.hb.view.BlurringView;
/// M: DMLock, PPL @}
 ...
 */
public class InCallActivity extends HbActivity implements FragmentDisplayManager {
...
//        requestWindowFeature(Window.FEATURE_ACTION_BAR_OVERLAY);
        ...
        mBlurView =  (BlurringView) findViewById(R.id.blur_bg);
    ...
    protected void onResume() {
        ...
        /// @}
        //add by lgy
        mHandler.removeCallbacks(mShowStatusBarView);
    ...
    protected void onStop() {
        ...
        mHandler.postDelayed(mShowStatusBarView, keyguardManager.isKeyguardLocked() ? 500 : 0);
    }
...
//                        InCallPresenter.getInstance());
    ...
    public void showAnswerFragment(boolean show) {
        ...
        if(mCallButtonFragment != null) {
        	mCallButtonFragment.getView().setVisibility(show ? View.GONE : View.VISIBLE);
        }
        //add by lgy
        if(show) {
        	updateWhenRinging();
    ...
    private void configSystemUI(boolean white) {
        getWindow().setStatusBarColor(Color.TRANSPARENT);        
        getWindow().setNavigationBarColor(Color.TRANSPARENT);
        //View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | 0x00000008
        if(white) {
    ...
    public static final String TAG_BLUR_DIALOG_FRAGMENT = "tag_blur_dialog_fragment";
    public void dismissBlurDialog() {
        DialogFragment fragment = (DialogFragment) getFragmentManager().findFragmentByTag(
        		TAG_BLUR_DIALOG_FRAGMENT);
        Log.d(this, "dismissBlurDialog(), fragment is " + fragment);
        if (fragment != null) {
            fragment.dismissAllowingStateLoss();
        }
    }
    ...
    public void showBlurBg(boolean show){
    	if(show) {
    		mBlurView.setVisibility(View.VISIBLE); 
    		if(mBlurView.getBlurredView() == null) {
    			mBlurView.setBlurredView(getCallCardFragment().getView());
    		}
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d(this, "onActivityResult: done");
        if (resultCode != RESULT_OK) {
            Log.d(this, "onActivityResult: contact picker result not OK.");
            return;
        }
        Cursor cursor = null;
       final String NUM_PROJECTION[] = {
        ...
        try {
            ...
            if ((cursor == null) || (!cursor.moveToFirst())) {
                Log.d(this, "onActivityResult: bad contact data, no results found.");
                return;
            }
