...
public class ConferenceManagerFragment
    ...
    private HbListView mConferenceParticipantList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mConferenceParticipantList = (HbListView) parent.findViewById(R.id.participantList);
...
//                Log.d(this, "onVolteAddConfMemberClicked()...");
    ...
    private void configSystemUI(boolean show) {
        if(!show) {
