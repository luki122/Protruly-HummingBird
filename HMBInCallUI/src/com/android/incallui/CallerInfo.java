...
//        photoResource = R.drawable.img_phone;
        photoResource = R.drawable.emergency_photo;       
        mIsEmergency = true;
        return this;
    }
    ...
    */
    ...
    private static void checkTimingForDebugging(long startTime, String description) {
        ...
        if (diffTime > 1000) {
            Log.e(TAG, "It spend too long to " + description + ": " + diffTime);
        }
    }
    ...
    public void updataHbInfo(String number){
        mArea = AreaManager.getArea(number);

//        mMark = MarkManager.getMark(16, "18665343459");
