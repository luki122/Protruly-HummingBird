...
public class CallCardPresenter extends Presenter<CallCardPresenter.CallCardUi>
  ...
  //zhangcj delete for 8950
//        if(FloatWindowManager.sIsAnsweringCallWaiting && isCdmaPhone()) {
//        	return;
//        }
    ...
    private void updatePrimaryDisplayInfo() {
        ...
        if (mPrimary.isConferenceCall()) {
            ...
            ui.setHbInfo(mPrimaryContactInfo.area, mPrimaryContactInfo.mark);
        } else {
            // Clear the primary display info.
            ui.setPrimary(null, null, false, null, null, false);
        }
...
//        }
    	 String  area = AreaManager.getArea(call.getNumber());
    ...
    public interface CallCardUi extends Ui {
        ...
        void setHbInfo(String area, MarkResult mark);
    ...
    /// @}
     ...
     private boolean isCdmaPhone(){
         ...
         if(call != null) {
        	 return InCallUtils.isCdmaCall(call);
         }
         return false;
     }
}
