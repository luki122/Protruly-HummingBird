...
public class ConferenceParticipantListAdapter extends BaseAdapter {
    ...
    private final void setCallerInfoForRow(View view, String callerName, String callerNumber,
            ...
            boolean thisRowCanDisconnect, int simId) {
        ...
        //zhangcj add
        final ImageView   mSimIcon = (ImageView) view.findViewById(R.id.sim_icon);
        SubUtils.setSimSubId(mSimIcon, simId);
    ...
    public final void setCallStatusForVolte(View view, Call call) {
        boolean thisRowCanShowStatus = call.getTelecommCall().getDetails().hasProperty(
