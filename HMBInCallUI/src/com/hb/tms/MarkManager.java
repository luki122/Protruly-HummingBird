...
public class MarkManager {
    ...
    private static final Uri mMarkUri = Uri.parse("content://com.hb.contacts/mark");
    ...
    public static String getUserMark(Context context, String number) {
        ...
        //zhangcj add for contacts 
        Uri contactUri = ContactsUtils.queryContactUriByPhoneNumber(context, number);
        if(contactUri != null){
        	return null;
        }
        String result = null;
