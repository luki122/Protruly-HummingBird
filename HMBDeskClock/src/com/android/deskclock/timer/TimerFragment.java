...
//        }
    ...
    public void onLeftButtonClick(View view) {
        ...
        /// M: Code moved to deleteTimer method
    ...
    public void setLabel(TimerObj timer, String label) {
         ...
         */
        int timerPos = mAdapter.getTimerPosition(timer.mTimerId);
        LogUtils.v("setLabel Check if timer is present or not: TimerPos = "+ timerPos);
        LogUtils.v("setLabel Check if timer is present or not state = "+timer.mState);

        if(timerPos == 0 ) {
            /// M : Timer doesn't exist, deleted
            if(timer.mState == 0 || timer.mState == TimerObj.STATE_DELETED) {
                LogUtils.v("setLabel Timer doesnt exist or has been deleted, return w/o update");
                return;
            }
            //return;
        }
        ...
        updateTimerState(obj, Timers.TIMER_UPDATE, false);
        /** @} */
