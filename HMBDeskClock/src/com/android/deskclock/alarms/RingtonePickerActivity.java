...
public final class RingtonePickerActivity extends AlertActivity implements
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Log.d(TAG, "onSaveInstanceState: mClickedPos = " + mClickedPos);
        ...
        if (positiveResult) {
            ...
            if (mClickedPos == mDefaultRingtonePos) {
                ...
                if (mDefaultRingtonePos == POS_UNKNOWN) {
                    uri = null;
                    Log.w(TAG, "onClick with no list item, "
    ...
    private void saveAnyPlayingRingtone() {
        if (mDefaultRingtone != null && mDefaultRingtone.isPlaying()) {
            Log.d(TAG, "saveAnyPlayingRingtone>>>:  mDefaultRingtone "  + mDefaultRingtone);
            sPlayingRingtone = mDefaultRingtone;
        } else if (mCurrentRingtone != null && mCurrentRingtone.isPlaying()) {
            Log.d(TAG, "saveAnyPlayingRingtone>>>:   mCurrentRingtone "  + mCurrentRingtone);
