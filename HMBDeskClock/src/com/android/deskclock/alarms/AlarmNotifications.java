...
//        LogUtils.v("Displaying low priority notification for alarm instance: " + instance.mId);
        ...
        NotificationCompat.Builder notification = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.stat_notif_alarm_tiny)
                .setAutoCancel(false)
...
//                .setWhen(0)
//                .setCategory(NotificationCompat.CATEGORY_ALARM)
//                .setSmallIcon(R.drawable.stat_notif_alarm)
//                .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
//                .setLocalOnly(true);
...
//                dismissPendingIntent);
        if (context != null) {
            RemoteViews remoteViewsExpanded = new RemoteViews(context.getPackageName(),
                    R.layout.alarm_notif_expanded);
            remoteViewsExpanded.setTextViewText(R.id.alarm_notif_expanded_title,
                    instance.getLabelOrDefault(context));
            remoteViewsExpanded.setImageViewResource(R.id.notification_icon,
                    R.drawable.stat_notif_alarm);
            remoteViewsExpanded.setTextViewText(R.id.alarm_notif_expanded_text,
                    AlarmUtils.getFormattedTime(context, instance.getAlarmTime()));
            remoteViewsExpanded.setTextViewText(R.id.alarm_notif_left_button,
                    resources.getString(R.string.alarm_alert_snooze_text));
            remoteViewsExpanded.setOnClickPendingIntent(R.id.alarm_notif_left_button, snoozePendingIntent);
            remoteViewsExpanded.setTextViewText(R.id.alarm_notif_right_button,
                    resources.getString(R.string.alarm_alert_dismiss_text));
            remoteViewsExpanded.setOnClickPendingIntent(R.id.alarm_notif_right_button, dismissPendingIntent);
...
//                instance.hashCode(), contentIntent, PendingIntent.FLAG_UPDATE_CURRENT));
            ...
            Intent fullScreenIntent = AlarmInstance.createIntent(context, AlarmActivity2.class,
                    instance.mId);
...
//        notification.setPriority(NotificationCompat.PRIORITY_MAX);
            ...
            final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                    ...
                    .setLocalOnly(true)
                    .setAutoCancel(false)
                    .setContent(remoteViewsExpanded)
                    .setSmallIcon(R.drawable.stat_notif_alarm_tiny)
            ...
            nm.cancel(instance.hashCode());
            nm.notify(instance.hashCode(), notification);
        }
    }
...
//        LogUtils.v("Updating alarm notification for alarm instance: " + instance.mId);
        ...
        // Setup Content Action
        Intent contentIntent = AlarmInstance.createIntent(context, AlarmActivity2.class,
                instance.mId);
