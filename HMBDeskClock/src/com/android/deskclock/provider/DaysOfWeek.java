...
public final class DaysOfWeek {
    ...
    public static final int WEEKDAYS_SET = 0x1f;

    public static final int WEEKENDS_SET = 0x60;
    ...
    private String toString(Context context, int firstDay, boolean forAccessibility) {
        ...
        if (mBitSet == WEEKDAYS_SET) {
            return context.getText(R.string.week_day).toString();
        }

        if (mBitSet == WEEKENDS_SET) {
