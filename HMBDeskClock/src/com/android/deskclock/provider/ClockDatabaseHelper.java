...
class ClockDatabaseHelper extends SQLiteOpenHelper {
    ...
    /**
     * Added snooze time to instance table
     */
    private static final int VERSION_8 = 8;

    // This creates a default alarm at 8:30 for every Mon,Tue,Wed,Thu,Fri
    private static final String DEFAULT_ALARM_1 = "(8, 30, 31, 0, 0, '', NULL, 0, 0, 0, 0, 0);";

    // This creates a default alarm at 9:30 for every Sat,Sun
    private static final String DEFAULT_ALARM_2 = "(9, 00, 96, 0, 0, '', NULL, 0, 0, 0, 0, 0);";
    ...
    private static void createAlarmsTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + ALARMS_TABLE_NAME + " (" +
                ...
                ClockContract.AlarmsColumns.NEXT_TIME_NOT_FIRED + " INTEGER NOT NULL, " +
                ClockContract.AlarmsColumns.DISABLED_YEAR + " INTEGER NOT NULL, " +
                ClockContract.AlarmsColumns.DISABLED_MONTH + " INTEGER NOT NULL, " +
                ClockContract.AlarmsColumns.DISABLED_DAY + " INTEGER NOT NULL, " +
    ...
    private static void createInstanceTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + INSTANCES_TABLE_NAME + " (" +
                ...
                ClockContract.InstancesColumns.SNOOZE_TIME + " INTEGER NOT NULL, " +
                ClockContract.InstancesColumns.NEXT_TIME_NOT_FIRED + " INTEGER NOT NULL, " +
...
//        super(context, DATABASE_NAME, null, VERSION_7);
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insertMe = "INSERT INTO " + ALARMS_TABLE_NAME + " (" +
                ...
                ClockContract.AlarmsColumns.NEXT_TIME_NOT_FIRED + cs +
                ClockContract.AlarmsColumns.DISABLED_YEAR + cs +
                ClockContract.AlarmsColumns.DISABLED_MONTH + cs +
                ClockContract.AlarmsColumns.DISABLED_DAY + cs +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
        ...
        if (oldVersion <= VERSION_7) {
            ...
            while (cursor.moveToNext()) {
                ...
                alarm.notFiredNextTime = cursor.getInt(8) == 1;
                alarm.deleteAfterUse = cursor.getInt(9) == 1;
