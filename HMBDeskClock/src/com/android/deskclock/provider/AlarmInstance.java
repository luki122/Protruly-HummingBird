...
//    private static final String DEFAULT_ALARM_TIMEOUT_SETTING = "10";
    private static final String DEFAULT_ALARM_TIMEOUT_SETTING = "3";
    ...
    private static final int SNOOZE_TIME_INDEX = 11;
    private static final int NEXT_TIME_NOT_FIRED_INDEX = 12;

    private static final int COLUMN_COUNT = NEXT_TIME_NOT_FIRED_INDEX + 1;
    ...
    public static ContentValues createContentValues(AlarmInstance instance) {
        ...
        values.put(SNOOZE_TIME, instance.mSnoozeTime);
        values.put(NEXT_TIME_NOT_FIRED, instance.mNextTimeNotFired);
        return values;
    }
    ...
    public static boolean updateInstance(ContentResolver contentResolver, AlarmInstance instance) {
        LogUtils.v("---", "--- updateInstance " + instance.mId + " updateInstance State " + instance.mAlarmState);
    ...
    public boolean mNextTimeNotFired;
    ...
    public AlarmInstance(Cursor c) {
        ...
        mSnoozeTime = c.getInt(SNOOZE_TIME_INDEX);
        mNextTimeNotFired = c.getInt(NEXT_TIME_NOT_FIRED_INDEX) == 1;
    }
...
//        String timeoutSetting = "1";
        int timeoutMinutes = Integer.parseInt(timeoutSetting);
//		int count = AlarmStateManager.getPoweroffAlarmMissedCount(context);
//		if (count == AlarmStateManager.POWEROFF_ALARM_MISSED_MAX_COUNT - 1) {
//			timeoutMinutes = 6;
//			LogUtils.v("lq_alarm AlarmInstance getTimeout count = " + count + "; timeoutMinutes = " + timeoutMinutes);
//		}
    ...
    public String toString() {
        return "AlarmInstance{" +
                ...
                ", mNextTimeNotFired=" + mNextTimeNotFired +
                '}';
    }
}
