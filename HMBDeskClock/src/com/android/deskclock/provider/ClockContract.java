...
public final class ClockContract {
    ...
    protected interface AlarmsColumns extends AlarmSettingColumns, BaseColumns {
        ...
        public static final String NEXT_TIME_NOT_FIRED = "next_time_not_fired";

        public static final String DISABLED_YEAR = "disabled_year";

        public static final String DISABLED_MONTH = "disabled_month";

        public static final String DISABLED_DAY = "disabled_day";
    }
