...
public final class Alarm implements Parcelable, ClockContract.AlarmsColumns {
    ...
    public static final String DEFAULT_ALERT_URI = "content://media/internal/audio/media/7";
    ...
    private static final int NEXT_TIME_NOT_FIRED_INDEX = 8;
    private static final int DISABLED_YEAR_INDEX = 9;
    private static final int DISABLED_MONTH_INDEX = 10;
    private static final int DISABLED_DAY_INDEX = 11;
    ...
    public static ContentValues createContentValues(Alarm alarm) {
        ...
        values.put(DISABLED_YEAR, alarm.disabledYear);
        values.put(DISABLED_MONTH, alarm.disabledMonth);
        values.put(DISABLED_DAY, alarm.disabledDay);
        values.put(NEXT_TIME_NOT_FIRED, alarm.notFiredNextTime);
    ...
    public String label;
    public Uri alert;
    public boolean notFiredNextTime;
    public boolean deleteAfterUse;
    public int disabledYear;
    public int disabledMonth;
    public int disabledDay;
...
//        this.alert = Uri.parse("content://media/internal/audio/media/7");
        this.alert = Uri.parse(DEFAULT_ALERT_URI);
        this.deleteAfterUse = false;
        this.notFiredNextTime = false;
        this.disabledYear = 0;
        this.disabledMonth = 0;
        this.disabledDay = 0;
    }
    ...
    public Alarm(Cursor c) {
        ...
        notFiredNextTime = c.getInt(NEXT_TIME_NOT_FIRED_INDEX) == 1;
        disabledYear = c.getInt(DISABLED_YEAR_INDEX);
        disabledMonth = c.getInt(DISABLED_MONTH_INDEX);
        disabledDay = c.getInt(DISABLED_DAY_INDEX);

        if (c.isNull(RINGTONE_INDEX)) {
            // Should we be saving this with the current ringtone or leave it null
            // so it changes when user changes default ringtone?
//            alert = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_ALARM);
//            alert = Uri.parse("content://media/internal/audio/media/7");
            this.alert = Uri.parse(DEFAULT_ALERT_URI);
        } else {
    ...
    Alarm(Parcel p) {
        ...
        notFiredNextTime = p.readInt() == 1;
        disabledYear = p.readInt();
        disabledMonth = p.readInt();
        disabledDay = p.readInt();
    }
    ...
    public void writeToParcel(Parcel p, int flags) {
        ...
        p.writeInt(notFiredNextTime ? 1 : 0);
        p.writeInt(disabledYear);
        p.writeInt(disabledMonth);
        p.writeInt(disabledDay);
    }
    ...
    public AlarmInstance createInstanceAfter(Calendar time) {
        ...
        result.mNextTimeNotFired = notFiredNextTime;
        return result;
    }
    ...
    public String toString() {
        return "Alarm{" +
                ...
                ", vibrate=" + vibrate +
                ", label='" + label + '\'' +
                ", notFiredNextTime=" + notFiredNextTime +
