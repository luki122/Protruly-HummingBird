...
//        remoteViewsExpanded.
//                setImageViewResource(R.id.notification_icon, R.drawable.stat_notification_stopwatch);

        if (clockRunning) {
            Intent stopButtonIntent = new Intent(context, StopwatchService.class);
            stopButtonIntent.setAction(HandleDeskClockApiCalls.ACTION_STOP_STOPWATCH);

            remoteViewsExpanded.setTextViewText(R.id.btn_start_pause, getString(R.string.stopwatch_btn_text_pause));
            remoteViewsExpanded.setOnClickPendingIntent(R.id.btn_start_pause,
                    PendingIntent.getService(context, 0, stopButtonIntent, 0));

            remoteViewsCollapsed.setTextViewText(R.id.swn_collapsed_laps, getString(R.string.stopwatch_running));
            remoteViewsCollapsed.setViewVisibility(R.id.swn_collapsed_laps, View.VISIBLE);
            remoteViewsExpanded.setTextViewText(R.id.swn_expanded_laps, getString(R.string.stopwatch_running));
            remoteViewsExpanded.setViewVisibility(R.id.swn_expanded_laps, View.VISIBLE);

        } else {
            Intent startButtonIntent = new Intent(context, StopwatchService.class);
            startButtonIntent.setAction(HandleDeskClockApiCalls.ACTION_START_STOPWATCH);

            remoteViewsExpanded.setTextViewText(R.id.btn_start_pause, getString(R.string.stopwatch_btn_text_start));
            remoteViewsExpanded.setOnClickPendingIntent(R.id.btn_start_pause,
                    PendingIntent.getService(context, 0, startButtonIntent, 0));
        ...
        Notification notification = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.stat_notif_stopwatch_tiny)
...
//            editor.putLong(Stopwatches.PREF_LAP_TIME + Integer.toString(numLaps), lapTimeElapsed);
    ...
    private void writeSharedPrefsLap(long lapTimeElapsed, boolean updateCircle) {
        ...
        if (updateCircle) {
            ...
            long lapTime = laps[0];
            if (numLaps == 1) { // Have only hit lap once.
