...
public class Stopwatches {
    ...
    public static final String PREF_PREV_LAP_TIME = "sw_prev_lap_time";
    public static final String PREF_ELAP_TIME = "sw_elap_time";
    public static final String PREF_CUR_LAP_TIME = "current_lap_time";
