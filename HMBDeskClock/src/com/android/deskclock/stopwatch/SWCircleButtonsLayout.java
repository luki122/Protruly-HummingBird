 ...
 */
public class SWCircleButtonsLayout extends FrameLayout {
    ...
    private SWCircleTimerView mCtv;
    private ImageButton mResetAddButton;
    private TextView mLabel;

    @SuppressWarnings("unused")
    public SWCircleButtonsLayout(Context context) {
        this(context, null);
        mContext = context;
    }

    public SWCircleButtonsLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    ...
    protected void remeasureViews() {
        if (mCtv == null) {
            mCtv = (SWCircleTimerView) findViewById(mCircleTimerViewId);
            if (mCtv == null) {
                return;
            }
