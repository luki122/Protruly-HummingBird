...
public class TimerReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // } else if ("android.intent.action.ACTION_PRE_SHUTDOWN".equals(intent.getAction())) {
        } else if (Intent.ACTION_SHUTDOWN.equals(intent.getAction())) {
            context.startService(TimerService.createShutdownIntent(context));
        } else if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
            context.startService(TimerService.createBootCompletedIntent(context));
        }
    }
}