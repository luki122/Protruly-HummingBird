...
public class TimerSetupView extends LinearLayout implements Button.OnClickListener,
    ...
    public TimerSetupView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.time_setup_view2, this);
    }
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < mNumbers.length; i++) {
            ...
            /// M: Changing from valueof to format so that numerals are translated.
            mNumbers[i].setText(String.format("%01d",i));
