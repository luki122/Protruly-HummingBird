...
public class TimerView extends LinearLayout {
    ...
    private static Typeface mAndroidClockMonoThin;
    ...
    public void setTime(int hoursTensDigit, int hoursOnesDigit, int minutesTensDigit,
        ...
        if (hoursTensDigit == -1) {
            ...
            mHoursTens.setText(String.format("%01d",hoursTensDigit));
        ...
        if (hoursOnesDigit == -1) {
            ...
            mHoursOnes.setText(String.format("%01d",hoursOnesDigit));
        ...
        if (minutesTensDigit == -1) {
            ...
            mMinutesTens.setText(String.format("%01d",minutesTensDigit));
        ...
        if (minutesOnesDigit == -1) {
            ...
            mMinutesOnes.setText(String.format("%01d",minutesOnesDigit));
