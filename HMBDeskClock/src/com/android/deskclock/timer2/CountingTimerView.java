...
public class CountingTimerView extends View {
    ...
    private final UnsignedTime mSplitColcon;
    ...
    public CountingTimerView(Context context, AttributeSet attrs) {
        ...
        mDefaultColor = mWhiteColor = r.getColor(R.color.timer_cricle_text_color, null);
        mSecondTextColor = mGrayColor = r.getColor(R.color.timer_cricle_second_text_color, null);
        mPressedColor = mAccentColor = r.getColor(R.color.timer_cricle_red, null);
    ...
    private void calcTotalTextWidth() {
        ...
        mTotalTextWidth += mMedHundredths.calcTotalWidth(mSeconds)
                + mSplitColcon.calcTotalWidth(splitColonStr);
    }
    ...
    public void setTimeStrTextColor(boolean active, boolean forceUpdate) {
        ...
        mSecondTextColor = active ? mAccentColor : mGrayColor;
        setTextColor(mDefaultColor, mSecondTextColor);
        if (forceUpdate) {
            invalidate();
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mSeconds != null) {
            ...
            xTextStart = mMedHundredths.draw(canvas, mSeconds, xTextStart, yTextStart);
        }
        if (mHundredths != null) {
