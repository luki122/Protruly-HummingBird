...
//                ViewCompat.setElevation(layout, 0f);
        ...
        private void expandAlarm(final ItemHolder itemHolder, boolean animate) {
          ...
          ///M: first check if item is in collpase transition
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    mExpandAnimator.setInterpolator(mExpandInterpolator);
        ...
        private void collapseAlarm(final ItemHolder itemHolder, boolean animate) {
            ...
            // Mark the alarmItem as having transient state to prevent it from being recycled
            // while it is animating.
            // View#setHasTransientState: Set whether this view is currently tracking transient state that the
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    // Set up the animator to animate the expansion.
                    mCollapseAnimator = ValueAnimator.ofFloat(0f, 1f)
                    ...
                    mCollapseAnimator.setInterpolator(mCollapseInterpolator);
                    // Set everything to their final values when the animation's done.
