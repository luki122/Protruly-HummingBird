...
final class TimerDAO {
    ...
    private static final String LAST_SHUTDOWN_TIME = "last_shutdown_time";
    ...
    public static long getLastShutdownTime(Context context) {
        ...
        return prefs.getLong(LAST_SHUTDOWN_TIME, 0);
    }

    public static void setLastShutdownTime(Context context, long millis) {
        final SharedPreferences prefs = getSharedPreferences(context);
        final SharedPreferences.Editor editor = prefs.edit();
        editor.putLong(LAST_SHUTDOWN_TIME, millis).apply();
    }

    public static void clearLastShutdownTime(Context context) {
        final SharedPreferences prefs = getSharedPreferences(context);
        final SharedPreferences.Editor editor = prefs.edit();
        editor.remove(LAST_SHUTDOWN_TIME).apply();
    }
