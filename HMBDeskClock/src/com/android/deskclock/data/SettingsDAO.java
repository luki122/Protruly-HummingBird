...
final class SettingsDAO {
    ...
    static boolean getAutoShowHomeClock(Context context) {
        final SharedPreferences prefs = getSharedPreferences(context);
        return prefs.getBoolean(/*SettingsActivity.KEY_AUTO_HOME_CLOCK*/"automatic_home_clock", false);
    }
    ...
    static TimeZone getHomeTimeZone(Context context) {
        ...
        final String timeZoneId = prefs.getString(/*SettingsActivity.KEY_HOME_TZ*/"home_time_zone", defaultTimeZoneId);
    ...
    static void setDefaultHomeTimeZone(Context context, TimeZone homeTimeZone) {
        final SharedPreferences prefs = getSharedPreferences(context);
        final String homeTimeZoneId = prefs.getString(/*SettingsActivity.KEY_HOME_TZ*/"home_time_zone", null);
        if (homeTimeZoneId == null) {
            prefs.edit().putString(/*SettingsActivity.KEY_HOME_TZ*/"home_time_zone", homeTimeZone.getID()).apply();
        }
    }
    ...
    static Uri getTimerRingtoneUri(Context context, Uri defaultUri) {
        final SharedPreferences prefs = getSharedPreferences(context);
        final String uriString = prefs.getString(/*SettingsActivity.KEY_TIMER_RINGTONE*/"timer_ringtone", null);
    ...
    private static SharedPreferences getSharedPreferences(Context context) {
        if (sPrefs == null) {
            sPrefs = /*Utils*/DataModel.getDefaultSharedPreferences(context.getApplicationContext());
        }
