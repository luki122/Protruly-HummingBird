...
public class HMBCalculatorExpressionBuilder extends SpannableStringBuilder {

    private static final String TAG = "HMBCalculatorExpressionBuilder";

    private final CalculatorExpressionTokenizer mTokenizer;
    private boolean mIsEdited;

    public HMBCalculatorExpressionBuilder(
    ...
    public SpannableStringBuilder replace(int start, int end, CharSequence tb, int tbstart,
        ...
        if (appendExpr.equals("^2") || appendExpr.equals("^3") || appendExpr.equals("^")
                || appendExpr.equals("!")) {
            mIsEdited = true;
        }
