...
public class SearchSettingsImpl implements SearchSettings {
    ...
    //liuzuo add
    public static final String DEFAULT_SEARCH_ENGINE_FAVICON = "search_engine_baidu";
    ...
    public String getDefaultSearchEngineFavicon() {
        ...
        favicon = DEFAULT_SEARCH_ENGINE_FAVICON;
        return favicon;
    }
    ...
    public String getSearchEngineNameByFavicon(String favicon) {
        ...
        return searchEngineInfo != null 
                ? searchEngineInfo.getName() : null;
    }
