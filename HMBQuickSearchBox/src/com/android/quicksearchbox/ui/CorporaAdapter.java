...
public class CorporaAdapter extends BaseAdapter {
    ...
    protected Drawable getCorpusIcon(Corpus corpus) {
        if (corpus == null) {
            return mContext.getResources().getDrawable(R.drawable.search_app_icon_mirrored);
        } else {
    ...
    protected CharSequence getCorpusLabel(Corpus corpus) {
        if (corpus == null) {
            return mContext.getText(R.string.corpus_label_global_new);//lijun modify corpus_label_global to corpus_label_global_new
        } else {
