...
public abstract class SuggestionsAdapterBase<A> implements SuggestionsAdapter<A> {
    ...
    public String suggestionViewType(Suggestion suggestion) {
     ...
     */
    @Override
    public void onHistorySuggestionDeleteClicked(String queryKey) {
        mSuggestionClickListener.onHistorySuggestionDeleteClick(this,queryKey);
    }
}
