...
public class Suggestions {
    ...
    //lijun add start
    private ClickLogCursor mClickLogCursor;
    public boolean isHistory(){
        return ("".equals(mQuery));
    }
    public ClickLogCursor getClickLogCursor(){
        return mClickLogCursor;
    }
    //lijun add end

    private final MyShortcutsObserver mShortcutsObserver = new MyShortcutsObserver();
    private final MyClickLogsObserver mMyClickLogsObserver = new MyClickLogsObserver();//lijun add
    ...
    //lijun add
    public void setClickLogCursor(ClickLogCursor clickLogCursor){
        mClickLogCursor = clickLogCursor;
        notifyDataSetChanged();
    }
    ...
    private class MyClickLogsObserver extends DataSetObserver{
        @Override
        public void onChanged() {
            notifyDataSetChanged();
        }
