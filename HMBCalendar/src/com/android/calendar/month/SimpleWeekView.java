...
public class SimpleWeekView extends View {
    ...
    protected static int WEEK_VIEW_HEIGHT = 46;
    ...
    protected boolean mHasFocusMonthDay;
    ...
    public SimpleWeekView(Context context) {
        ...
        if (mScale == 0) {
            ...
            WEEK_VIEW_HEIGHT = res.getInteger(R.integer.month_week_view_height);
            if (mScale != 1) {
            	WEEK_VIEW_HEIGHT *= mScale;
    ...
    public void setWeekParams(HashMap<String, Integer> params, String tz) {
        ...
        if (mWeek == 0 && mWeekStart == 1) {
            mFirstJulianDay = julianMonday;
            time.setJulianDay(mFirstJulianDay + 1);
        }
