...
import com.android.calendar.hb.MonthAgendaView;
...
public class MonthByWeekFragment extends SimpleDayPickerFragment implements
    ...
    public View onCreateView(
    	...
    	View v = inflater.inflate(R.layout.hb_month_by_week, container, false);
        ...
        currentMonthView.setRootView(v);
        currentMonthView.setParams(mViewSwitcher, mAdapter, this, mSelectedDay, mEventLoader);
    ...
    protected void updateHeader() {
        ...
        for (int i = 1; i < 8; i++) {
            ...
            if (i < mDaysPerWeek + 1) {
                ...
                if (position == Time.SUNDAY || position == Time.SATURDAY) {
