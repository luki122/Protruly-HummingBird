...
public class EditEventActivity extends AbstractCalendarActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == EventLabelActivity.EVENT_LABEL_REQUEST_CODE
                && resultCode == RESULT_OK && data != null) {
            if (mEditFragment != null && mEditFragment.mView != null) {
                mEditFragment.hideSoftInput();
                mEditFragment.mView.onEventDescriptionSet(
                        data.getStringExtra(EventLabelActivity.KEY_EVENT_DESCRIPTION));
            }
        }
    }
