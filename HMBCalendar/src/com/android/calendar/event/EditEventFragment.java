...
public class EditEventFragment extends Fragment implements EventHandler, OnColorSelectedListener {
    ...
    public void hideSoftInput() {
        if (mView != null && mView.mTitleTextView != null) {
...
//        mContext.requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
        ...
        if (mIsReadOnly) {
            ...
            view = inflater.inflate(R.layout.hb_edit_event/*edit_event*/, null);
        }
        ...
        view.findViewById(R.id.action_cancel).setOnClickListener(mActionBarListener);
        view.findViewById(R.id.action_done).setOnClickListener(mActionBarListener);
    ...
    private boolean modelChanged() {
        ...
        if (mOriginalModel.mReminders == null) {
            if (mModel.mReminders != null) {
                return true;
            }
        } else if (!mOriginalModel.mReminders.equals(mModel.mReminders)) {
            return true;
        }
    ...
    protected void displayEditWhichDialog() {
        if (mModification == Utils.MODIFY_UNINITIALIZED) {
            ...
            mModifyDialog = new AlertDialog.Builder(mActivity)
                    ...
                    .setPositiveButton(R.string.edit_repeat_event_ok, null)
                    .show();
            mModifyDialog.setOnCancelListener(new OnCancelListener() {
                @Override
                public void onCancel(DialogInterface dialog) {
