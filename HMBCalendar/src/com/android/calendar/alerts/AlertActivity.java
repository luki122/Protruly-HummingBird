...
public class AlertActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle icicle) {
        if (!AlertUtils.hasCalendarPermission(this)) {
            AlertUtils.cancelNotification(this, AlertUtils.EXPIRED_GROUP_NOTIFICATION_ID);
            AlertUtils.showCalendarPermissionDiniedToast(this);
            finish();
        }
        ...
        mAdapter = new AlertAdapter(this, R.layout.hb_alert_item/*alert_item*/);
