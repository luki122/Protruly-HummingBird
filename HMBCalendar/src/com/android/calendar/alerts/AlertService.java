...
public class AlertService extends Service {
    ...
    public static final int MAX_NOTIFICATIONS = 7/*20*/;
        ...
        if (numLowPriority > 0) {
            ...
            if (numLowPriority == 1) {
                ...
                notification = AlertReceiver.makeBasicNotification(context, info.eventName,
                        ...
                        Notification.PRIORITY_MIN, info.description);
            } else {
            ...
            addNotificationOptions(notification, true, expiredDigestTitle,
                    ...
                    false, context); /* Do not show the LED for the expired events. */
    ...
    private static void postNotification(NotificationInfo info, String summaryText,
        ...
        addNotificationOptions(notification, quietUpdate, tickerText,
                ...
                true, context); /* Show the LED for these non-expired events */
    ...
    private static void addNotificationOptions(NotificationWrapper nw, boolean quietUpdate,
            ...
            boolean showLights, Context context) {
        ...
        if (!quietUpdate) {
            ...
            if (reminderRingtone.equals(GeneralPreferences.DEFAULT_RINGTONE)) {
                if (sDefaultRingtone != null) {
                    notification.sound = sDefaultRingtone;
                } else {
                    notification.sound = sDefaultRingtone = getDefaultRingtone(context);
                }
            }
        }
    }

    private static Uri sDefaultRingtone;

    private static Uri getDefaultRingtone(Context context) {
        Uri uri = RingtoneManager.getActualDefaultRingtoneUri(
                context, RingtoneManager.TYPE_NOTIFICATION);
        if (uri != null && !RingtoneManager.isRingtoneExist(context, uri)) {
            uri = RingtoneManager.getDefaultRingtoneUri(
                    context, RingtoneManager.TYPE_NOTIFICATION);
        }
        return uri;
    }
    ...
    private boolean hasCalendarPermission() {
        return AlertUtils.hasCalendarPermission(this);
    }
