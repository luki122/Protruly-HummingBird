...
//    private static int mPastEventColor;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        */
        ...
        String description = cursor.getString(AlertActivity.INDEX_DESCRIPTION);
        ...
        updateView(context, view, eventName, description, startMillis, endMillis, allDay);
    }

    public static void updateView(Context context, View view, String eventName, String description,
        ...
        ImageView labelIconView = (ImageView) view.findViewById(R.id.label_icon);
