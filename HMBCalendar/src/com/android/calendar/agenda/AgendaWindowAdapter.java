...
public class AgendaWindowAdapter extends BaseAdapter
    ...
    public static final int INDEX_DESCRIPTION = 17;
    ...
    private static final int MAX_QUERY_DURATION = 30/*60*/; // days
    ...
    public AgendaWindowAdapter(Context context,
        ...
        mHeaderView = (TextView) inflater.inflate(R.layout.hb_agenda_header, null);
        mFooterView = inflater.inflate(R.layout.hb_agenda_footer, null);
    ...
    private void updateHeaderFooter(final int start, final int end) {
        mHeaderView.setText(mContext.getString(R.string.show_older_agendas/*show_older_events*/,
                formatDateString(start)));
        // mFooterView.setText(mContext.getString(R.string.show_newer_events,
        //         formatDateString(end)));
        TextView footerTextView = (TextView) mFooterView.findViewById(R.id.agenda_footer);
        footerTextView.setText(mContext.getString(R.string.show_newer_agendas,
                formatDateString(end)));
    }
