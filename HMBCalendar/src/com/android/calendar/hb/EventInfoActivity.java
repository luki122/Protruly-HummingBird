...
//        SearchView.OnCloseListener {
    ...
    public void onClick(View view) {
        if (mInfoFragment != null) {
            mInfoFragment.onActionClick(view);
        }
    }
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.hb_event_info_layout);

        findViewById(R.id.action_cancel).setOnClickListener(this);
        findViewById(R.id.info_action_edit).setOnClickListener(this);
        findViewById(R.id.info_action_delete).setOnClickListener(this);
