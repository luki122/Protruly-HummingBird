...
public class Utils {
    ...
    public static final int LABEL_ICON_CUSTOM_ID = R.drawable.hb_label_custom;

    private static final int[] LABEL_ICON_IDS = new int[] {
            R.drawable.hb_label_meeting,
            R.drawable.hb_label_train,
            R.drawable.hb_label_plane,
            R.drawable.hb_label_birthday,
            R.drawable.hb_label_commemoration,
            R.drawable.hb_label_treatment,
            R.drawable.hb_label_party,
            R.drawable.hb_label_take_food,
            R.drawable.hb_label_exercise,
            R.drawable.hb_label_drink_water,
    };

    public static final int NOTIFY_ICON_CUSTOM_ID = R.drawable.hb_notify_custom;

    private static final int[] NOTIFY_ICON_IDS = new int[] {
            R.drawable.hb_notify_meeting,
            R.drawable.hb_notify_train,
            R.drawable.hb_notify_plane,
            R.drawable.hb_notify_birthday,
            R.drawable.hb_notify_commemoration,
            R.drawable.hb_notify_treatment,
            R.drawable.hb_notify_party,
            R.drawable.hb_notify_take_food,
            R.drawable.hb_notify_exercise,
            R.drawable.hb_notify_drink_water,
    };

    public static int getLabelIconId(int index) {
        return LABEL_ICON_IDS[index];
    }

    public static int getNotifyIconId(int index) {
        return NOTIFY_ICON_IDS[index];
    }

    public static ArrayList<String> loadDescriptionValues(Resources r) {
        String[] labels = r.getStringArray(R.array.description_values);
        return new ArrayList<>(Arrays.asList(labels));
    }

    public static ArrayList<String> loadDescriptionLabels(Resources r) {
        String[] labels = r.getStringArray(R.array.description_labels);
        return new ArrayList<>(Arrays.asList(labels));
    }
    ...
    **/
    ...
    public static final long timeFromIntentInMillis(Intent intent) {
        ...
        // return millis;
        return com.android.calendar.hb.utils.CalendarUtils.checkTimeRange(millis);
    }
