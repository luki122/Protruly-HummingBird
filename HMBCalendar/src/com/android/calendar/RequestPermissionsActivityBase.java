...
public abstract class RequestPermissionsActivityBase extends Activity {
    ...
    private static final String REQUIRED_PERMISSIONS_GRANTED = "required_permissions_granted";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            // requestPermissions();
            if (getRequiredPermissionsGranted(this)) {
                requestPermissions();
            } else {
    ...
    static boolean getRequiredPermissionsGranted(Context context) {
        return Utils.getSharedPreference(
                context, REQUIRED_PERMISSIONS_GRANTED, true);
    }

    void grantRequiredPermissions() {
        Utils.setSharedPreference(this, REQUIRED_PERMISSIONS_GRANTED, true);
    ...
    /**
     * If any permissions the calendar app needs are missing, open an Activity
    ...
    protected static boolean startPermissionActivity(Activity activity,
        ...
        if (!getRequiredPermissionsGranted(activity)
    ...
    private void showRequestPermissionsDialog() {
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.request_permissions_ok,
    ...
    private void showGrantPermissionsDialog() {
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.grant_permissions_ok,
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
