...
public abstract class KeyguardAbsKeyInputView extends LinearLayout
        ...
        if (matched) {
            ...
            if (isValidPassword) {
                ...
                if (timeoutMs > 0) {
                    ...
                    KeyguardUpdateMonitor.getInstance(mContext).reportSecurityModeLocked(timeoutMs);
                    //HB. end
                }
            }
            if (timeoutMs == 0) {
    ...
    protected void handleAttemptLockout(long elapsedRealtimeDeadline) {
        ...
        if(getUnlockFailedContainer() != null){
        	getUnlockFailedContainer().setVisibility(View.VISIBLE);
        }
        ...
        new CountDownTimer(elapsedRealtimeDeadline - elapsedRealtime, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if(getUnlockFailedMsgDisplay() != null){
                	getUnlockFailedMsgDisplay().setMessage(R.string.kg_too_many_failed_attempts_countdown, true, secondsRemaining);
                }
            ...
            public void onFinish() {
                ...
                KeyguardUpdateMonitor.getInstance(mContext).reportSecurityModeLocked(0);
                // modify by wxue 20170323
                resetState();
            }
        }.start();
    }
    ...
    private KeyguardUpdateMonitorCallback mUpdateCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onFingerprintError(int msgId, String errString) {
        	if(msgId == FingerprintManager.FINGERPRINT_ERROR_LOCKOUT){
        		mSecurityMessageDisplay.setFingerprintAuthFailedMessage(getResources().getString(R.string.kg_password_instructions), false);
        	}
        };
    };
    // add by wxue 20170427 end
