...
public class KeyguardHostView extends FrameLayout implements SecurityCallback {
    ...
    public boolean onBackPressed() {
    	if(mSecurityContainer.getCurrentSecuritySelection() != SecurityMode.None){
    		return mSecurityContainer.onBackPressed();
    	}
    	return false;
    }
    ...
    public void setViewMediatorCallback(ViewMediatorCallback viewMediatorCallback) {
		...
		if (mViewMediatorCallback != null && mIsShowPwroffAlarm) {
			Log.w(TAG, " lq_pwroffa -----> [KeyguardHostView] setViewMediatorCallback()");
			mViewMediatorCallback.setPwroffAlarmBg(mIsShowPwroffAlarm);
		}
    }
	...
	public void setPwroffAlarmBg(boolean show) {
		...
		if (mViewMediatorCallback != null) {
			mViewMediatorCallback.setPwroffAlarmBg(show);
		}
	}
}
