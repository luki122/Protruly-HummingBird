...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    private void showTimeoutDialog(int timeoutMs) {
        ...
        switch (mSecurityModel.getSecurityMode()) {
            case Pattern:
                ...
                break;
            case PIN:
            	// modify by wxue for dialog hints when input failed many times 20170313 start
                //messageId = R.string.kg_too_many_failed_pin_attempts_dialog_message;
                messageId = R.string.kg_too_many_failed_password_attempts_dialog_message;
               // modify by wxue for dialog hints when input failed many times 20170313 end
                break;
            case Password:
                messageId = R.string.kg_too_many_failed_password_attempts_dialog_message;
                break;
    ...
    private void reportFailedUnlockAttempt(int timeoutMs) {
        ...
        if (timeoutMs > 0) {
        	// modify by wxue 20170322 start
            //showTimeoutDialog(timeoutMs);
            // modify by wxue 20170322 end
        }
    }
    ...
    private KeyguardSecurityCallback mCallback = new KeyguardSecurityCallback() {
        ...
        public void reportUnlockAttempt(boolean success, int timeoutMs) {
            ...
            if (success) {
                ...
                monitor.setFingerprintLocked(false);
		...
		public void setPwroffAlarmBg(boolean show) {
			if (mSecurityCallback != null) {
				mSecurityCallback.setPwroffAlarmBg(show);
			}
		}
    };
    ...
    private int getSecurityViewIdForMode(SecurityMode securityMode) {
        switch (securityMode) {
            ...
            /// M: power-off alarm @{
            case AlarmBoot: return R.id.power_off_alarm_view_ex;
    ...
    private int getLayoutIdFor(SecurityMode securityMode) {
        ...
        switch (securityMode) {
            ...
            // modify by wxue 20170331 start
            //case PIN: return R.layout.keyguard_pin_view;
            case PIN: return R.layout.hb_keyguard_pin_view;
            // modify by wxue 20170331 end
            ...
            /// M: power-off alarm @{
            case AlarmBoot: return R.layout.mtk_power_off_alarm_view_ex;
    ...
    public boolean onBackPressed(){
    	if (mCurrentSecuritySelection != SecurityMode.None) {
    		...
    		if(keyguardSecurityView instanceof KeyguardPasswordView){
    			return ((KeyguardPasswordView) keyguardSecurityView).onBackPressed();
    		}
        }
    	return false;
    }
