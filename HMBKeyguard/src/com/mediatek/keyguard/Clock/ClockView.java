...
public class ClockView extends RelativeLayout {
    ...
    // modify by wxue 20170410 start
    //private static final String ANDROID_CLOCK_FONT_FILE = "/system/fonts/AndroidClock.ttf";
    private static final String ANDROID_CLOCK_FONT_FILE = "/system/fonts/Roboto-Thin.ttf";
    // modify by wxue 20170410 end
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (clock != null) {
                clock.mHandler.post(new Runnable() {
                    public void run() {
                        // M: ALPS02510800 the time on keyguard is different with system time
                        if (timezoneChanged || screenOn) {
                            Log.d(TAG, "need to update timezone.");
    ...
    protected void onAttachedToWindow() {
        ...
        Log.d(TAG, "set default timezone, timezone = " + TimeZone.getDefault());
