...
public class PagerLayout extends LinearLayout {
    ...
    public PagerLayout(final Context context, AttributeSet attrs, int defStyleAttr) {
       ...
       // mContainer = LayoutInflater.from(context).inflate(R.layout.default_view, this, false);
        ...
        mContainer.setBackgroundColor(Color.GREEN);//new BitmapDrawable(getWallPaper(context))
        // 添加视图
    ...
    public void setLayout(Context context, int layoutId) {
        ...
        mContainer.setBackground(new BitmapDrawable(getWallPaper(context)));//
        // 添加视图
        this.addView(mContainer);
        // 初始化Scroller
        if (mScroller == null) {
    ...
    public void setmHideCallBack(HideCallBack mHideCallBack) {
        this.mHideCallBack = mHideCallBack;
    }
