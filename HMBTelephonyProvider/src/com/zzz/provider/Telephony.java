...
public final class Telephony {
    ...
    public interface TextBasedSmsColumns {
        ...
        /**
         * Is the send or download failed message has not been read
         * <P>Type: INTEGER (boolean)</P>
         */
        //lichao add for TextBasedSmsColumns in 2017-07-04
        public static final String FAILED_UNREAD = "failed_unread";
        ...
        //begin tangyisen
        //非群发信息的group_id=0, 群发短信的头目group_id=-1, 其他的群发信息的group_id=头目短信的_id
        public static final String GROUP_ID = "group_id";
        public static final String NOTI_COUNT = "noti_count";
        public static final String FAILS_COUNT = "fails_count";
        //end tangyisen
        //begin tangyisen add for black 20170523
        public static final String REJECT = "reject";
        public static final String REJECT_TAG = "reject_tag";
        //end tangyisen
        //2017-06-27补充：对于群发信息,每个信息的has_error代表的都是整个群发信息的发送失败状况。
        //就是只要群发信息里任何一条发送失败，所有群发信息里的每一条信息的has_error都将是1。
        public static final String HAS_ERROR = "has_error";//lichao add in 2017-05-26
    }
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static Uri addMessageToUri(int subId, ContentResolver resolver,
           ...
           //tangyisen modify
            ...
            return addMessageToUri(subId, resolver, uri, address, body, subject, sc,
                    date, read, deliveryReport, threadId, 0L);
            //end tangyisen
        }
        // MTK-END
        ...
        public static Uri addMessageToUri(int subId, ContentResolver resolver,
                Uri uri, String address, String body, String subject, String sc,
                Long date, boolean read, boolean deliveryReport, long threadId, long groupId) {
        ...
        public static boolean moveMessageToFolder(Context context,
            ...
            //Log.d(TAG, "\n\n moveMessageToFolder(), uri = "+uri+", folder = "+folder);
            ...
            boolean markFailedAsUnread = false;
			
            //boolean markAsRead = false;
            boolean markFailedAsRead = false;
            switch(folder) {
            ...
            case MESSAGE_TYPE_SENT:
                //markAsRead = true;
                markFailedAsRead = true;
                break;
            case MESSAGE_TYPE_FAILED:
            case MESSAGE_TYPE_QUEUED:
                //markAsUnread = true;
                markFailedAsUnread = true;
                break;
            default:
                return false;
            }
            ...
            if (markFailedAsUnread) {
                //Log.d(TAG, "moveMessageToFolder(), values.put(Mms.FAILED_UNREAD, 1) \n\n");
                values.put("failed_unread", 1);
            } else if (markFailedAsRead) {
                //Log.d(TAG, "moveMessageToFolder(), values.put(Mms.FAILED_UNREAD, 0) \n\n");
                values.put("failed_unread", 0);
            }
            //HB. BUG3827 end
    ...
    public interface TextBasedSmsCbColumns {
         ...
         * <P>Type: INTEGER (boolean)</P>
         */
        //lichao add for TextBasedSmsCbColumns in 2017-07-04
        public static final String FAILED_UNREAD = "failed_unread";
    ...
    public interface BaseMmsColumns extends BaseColumns {
         ...
         * <P>Type: INTEGER (boolean)</P>
         */
        //lichao add for BaseMmsColumns in 2017-07-04
        public static final String FAILED_UNREAD = "failed_unread";
        ...
        public static final String HAS_ATTACH = "has_attach";//lichao add in 2017-05-24
        public static final String PDU_TEXT = "pdu_text";//lichao add in 2017-05-24
        ...
        //2017-06-27补充：群发彩信跟群发短信不一样，群发彩信只有一条，群发短信是分开的
        //所以群发彩信的has_error无需针对fails_count做判断（实际pdu也没增加fails_count字段）
        public static final String HAS_ERROR = "has_error";//lichao add in 2017-05-26
    }
    ...
    public interface CanonicalAddressesColumns extends BaseColumns {
        ...
        public static final String BLACK_NOTE = "black_note";
        //end tangyisen add for black
    }
    ...
    public interface ThreadsColumns extends BaseColumns {
        ...
        /**
         * Indicates whether all messages of the thread have not been read.
         * <P>Type: INTEGER (boolean)</P>
         */
        //lichao add for ThreadsColumns in 2017-07-04
        public static final String FAILED_UNREAD = "failed_unread";
        ...
        // MTK Add for ip message END
		
        //lichao add for show SIM icon
        public static final String SUBSCRIPTION_ID = "sub_id";

        /**
         * //lichao add in 2017-04-17
         * The date at which the thread was stuck top.
         * <P>Type: INTEGER (long)</P>
         */
        public static final String DATE_TOP = "date_top";

        /**
         * Indicates whether this thread was stuck top.
         * <P>Type: INTEGER</P>
         */
        public static final String IS_TOP = "is_top";

        public static final String LATEST_IS_MMS = "latest_is_mms";//lichao add
        public static final String LATEST_IS_NOTIFI = "latest_is_notifi";//lichao add
        public static final String LATEST_HAS_ATTACH = "latest_has_attach";//lichao add
        public static final String LATEST_PDU_TEXT = "latest_pdu_text";//lichao add
        public static final String LATEST_HAS_ERROR = "latest_has_error";//lichao add
        /**
         * The message count of the thread(Include draft).
         * <P>Type: INTEGER</P>
         */
        //lichao add in 2017-06-21, refer to ThreadsColumns.MESSAGE_COUNT = "message_count";
        public static final String MESSAGE_COUNT_INCLUDE_DRAFT = "msg_count_in_draft";
    }
    ...
    public static final class Threads implements ThreadsColumns {
        ...
        public static long getOrCreateThreadId(
            ...
            Uri uri = uriBuilder.build();
            Rlog.v(TAG, "getOrCreateThreadId uri: " + uri);
    ...
    public static final class MmsSms implements BaseColumns {
        ...
        public static final Uri CONTENT_REJECTED_URI = Uri.parse(
                "content://mms-sms/rejected");
        //HB. end
        ...
        */
         ...
         */
        //as URI_SEARCH in MmsSmsProvider.java
    ...
    public static final class CellBroadcasts implements BaseColumns {
        ...
        //lichao add for CellBroadcasts in 2017-07-04
        public static final String FAILED_UNREAD = "failed_unread";
    ...
    public static final class WapPush implements BaseColumns {
        ...
        //lichao add for WapPush in 2017-07-04
        public static final String FAILED_UNREAD = "failed_unread";
    ...
    public static final class Mwi implements BaseColumns {
        ...
        //lichao add for Mwi in 2017-07-04
        public static final String FAILED_UNREAD = "failed_unread";
