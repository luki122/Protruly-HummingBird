...
public class ProviderUtil {
    ...
    public static boolean isAccessRestricted(Context context, String packageName, int uid) {
        return (uid != Process.SYSTEM_UID
                ...
                && !("com.android.mms".equals(packageName))//tangyisen add
                && !("com.hb.interception".equals(packageName)));//tangyisen add
    }
  ...
  //begin tangyisen 20170523
    public static boolean isSpecifiedPackageForReject(String pac, int uid) {
        ...
        if("com.android.mms".equals( pac ) || "com.zf.csptool".equals( pac ) || "com.gionee.auto".equals( pac )
                || "com.android.mms.service".equals( pac ) || "com.hb.interception".equals( pac )) {
            return true;
        }
        return false;
    }

    public static boolean isSpecifiedPackageForReject(String pac) {
        if(TextUtils.isEmpty( pac )) {
            return false;
        }
        if("com.android.mms".equals( pac ) || "com.zf.csptool".equals( pac ) || "com.gionee.auto".equals( pac )
