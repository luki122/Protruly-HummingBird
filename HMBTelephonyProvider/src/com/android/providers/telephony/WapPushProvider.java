...
public class WapPushProvider extends ContentProvider {
    ...
    private static final String TAG = "MmsProvider/WapPush";
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (rowId > 0) {
            ...
            Log.e("@M_" + TAG, "Failed to insert! " + values.toString());
        }
        return null;
    }
    ...
    private long getOrCreatePushThreadId(SQLiteDatabase db, String address) {
        ...
        Log.i("@M_" + TAG, "getOrCreatePushThreadId address:" + address);
        ...
        Log.i("@M_" + TAG, "getOrCreatePushThreadId uri: " + uri);
