 ...
 * intent.
 */
public class PermissionControlPageActivity extends HbActivity implements ActionBarAdapter.Listener,
...
//    private ActionBarAdapter mActionBarAdapter;
    ...
    private class TabPagerAdapter extends PagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            if (position == PERMISSIONS_INFO) {
                return getString(R.string.permissions_label);
            } else if (position == APPS_INFO) {
...
//        mActionBarAdapter = new ActionBarAdapter(this, this, getActionBar());
        ...
        boolean state = PermControlUtils.isPermControlOn(this);
        Log.d("@M_" + TAG, "oncreate(), state " + state);
        Intent init = new Intent(this, PermControlService.class);
        init.putExtra(PermControlUtils.EXTRA_STATE, state);
        if (state) {
            init.setAction(PermControlUtils.START_SERVICE_ACTION);
            startService(init);
        } else {
            stopService(init);
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        Log.d("@M_" + TAG, "onSaveInstanceState()");
...
//        }
    ...
    protected void onResume() {
        ...
        Log.d("@M_" + TAG, "onResume() , isShow " + isShow);
...
//        invalidateOptionsMenu();
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (!mUserCheckedFlag) {
            Log.d("@M_" + TAG, "mUserCheckedFlag is false , return ");
            return;
        }

        Log.d("@M_" + TAG, "onCheckedChanged(),isChecked = " + isChecked);
...
//        mActionBarAdapter.removeAllTab();
    ...
    private void checkUiEnabled() {
        ...
        Log.d("@M_" + TAG, "checkEnabled(), update current interface, enable = "
                + enable);
        if (!enable) {
