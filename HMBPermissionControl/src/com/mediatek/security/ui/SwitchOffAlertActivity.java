...
public class SwitchOffAlertActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    void createDialog() {
        mAlertParams.mTitle = getString(R.string.alert_dlg_title);
        mAlertParams.mPositiveButtonText = getString(com.android.internal.R.string.yes);
        mAlertParams.mNegativeButtonText = getString(com.android.internal.R.string.no);
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            Log.d("@M_" + TAG, "OK button , turn off the switch , checkbox state = "
                    + state);
            ...
            Log.d("@M_" + TAG, "Cancle button , nothing to do");
        }
    }
