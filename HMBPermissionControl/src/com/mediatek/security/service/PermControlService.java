...
//            // protruly linxiaobin 20170706 modify for pms to block mtk permission start
//            boolean blockMtkPermission = SystemProperties.get(
//                    "ro.protruly_block_mtkperms").equals("1");
//
//            if (blockMtkPermission) {
//                PermControlUtils.enablePermissionControl(false, getApplicationContext());
//            } else {
//                // 20170526
//                if (!PreferenceUtils.hasLaunch(getApplicationContext())) {
//                    PermControlUtils.enablePermissionControl(true, getApplicationContext());
//                    PreferenceUtils.setHasLaunch(getApplicationContext(), true);
//                }
//            }
//            // protruly linxiaobin 20170706 modify for pms to block mtk permission end
...
//            }
    ...
    private void handleConfirmDlgMsg(PermissionRecord record, int flag) {
        ...
        LayoutInflater inflater = LayoutInflater.from(new ContextThemeWrapper(this, com.hb.R.style.Theme_Hb_Material_Light));
        View view = inflater.inflate(R.layout.hb_notify_dialog_customview, null);
