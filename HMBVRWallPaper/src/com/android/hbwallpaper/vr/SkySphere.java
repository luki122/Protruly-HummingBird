package com.android.hbwallpaper.vr;
...
import com.android.hbwallpaper.utils.Gl2Utils;
...
public class SkySphere{
    ...
    public SkySphere(Context context, String texture){
        ...
        try {
            ...
            Log.i("VR","1:mBitmap = "+mBitmap);
            e.printStackTrace();
        }
        Log.i("VR","2:mBitmap = "+mBitmap);
    }
    ...
    public void setSize(int width,int height){
        ...
        //透视投影矩阵/视锥
        MatrixHelper.perspectiveM(mProjectMatrix,0,100,ratio,0.5f,200);
        //设置相机位置
