...
public class DeviceProfile {
  ...
  public int workspaceToHotsetGapOffset;//liuzuo add for reduce gap
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources res,
        ...
        int cellWidthGap = res.getDimensionPixelSize(R.dimen.folder_cell_layout_gap_width);
        ...
        // Folder icon
        folderBackgroundOffset = (int) (-edgeMarginPx*1f);
    ...
    public Rect getWorkspacePadding(Rect recycle) {
        ...
        if (isVerticalBarLayout()) {
            ...
            int paddingBottom = hotseatBarHeightPx + pageIndicatorHeightPx-workspaceToHotsetGapOffset;
            if (isTablet) {
                // Pad the left and right of the workspace to ensure consistent spacing
                // between all icons
...
//        View pageIndicator = launcher.findViewById(R.id.page_indicator);
        ...
        if(FeatureFlags.SHOW_PAGEINDICATOR_CUBE){
            pageIndicator = launcher.findViewById(R.id.page_indicator_dots);
        }else {
        ...
        if(FeatureFlags.SHOW_PAGEINDICATOR_CUBE) {
            ...
            if (pageIndicatorCube != null) {
                if (isVerticalBarLayout()) {
                    ...
                    lp.bottomMargin = hotseatBarHeightPx + mInsets.bottom - 31;
        ...
        if(bar!=null){
            ...
            lpBar.height = (availableHeightPx - workspacePadding.top - workspacePadding.bottom)/inv.numRows;
    ...
    private int getArrangeNavigationBarPadding(){
        return 24;
    }
