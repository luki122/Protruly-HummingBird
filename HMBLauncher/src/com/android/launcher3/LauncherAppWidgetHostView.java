 ...
 * {@inheritDoc}
 */
public class LauncherAppWidgetHostView extends AppWidgetHostView implements TouchCompleteListener ,UninstallMode ,UninstallRect {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        //UnistallMode add by liuzuo
//        if(isUninstallMode){
//            Log.d("liuzuo55","onInterceptTouchEvent ="+ev.getAction());
//            if(ev.getAction()== MotionEvent.ACTION_DOWN) {
...
//                    CellLayout layout = (CellLayout) viewParent;
//                    layout.setOnClickWidgetView(this);
//                }
//            }
//                return true;
//        }
...
//UnistallMode add by liuzuo end
    ...
    public void showUninstallApp() {
        if(!isUninstallMode) {
            isUninstallMode = true;
            Drawable drawable = getResources().getDrawable(R.drawable.widget_host_view_bg);
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        drawUninstallDrawable(getUninstallDrawable(),canvas);
    }
        ...
        if (isUninstallMode/*&&getTag() instanceof ShortcutInfo*/ ) {
            if(mMarkDrawable==null) {
               ...
               /* int top = getPaddingTop() + (widthOfmCheckDrawable/2 - width) / 2 - widthOfmCheckDrawable / 2 + 1;*/
                ...
                int bottom = top + widthOfmCheckDrawable;
                if (right > getWidth()) {
                ...
                int offset = 135;
                mUninstallMarkRect = new Rect(left-offset,top-offset,right+offset,bottom+offset);
                mMarkDrawable.setBounds(left, top, right, bottom);
            }
