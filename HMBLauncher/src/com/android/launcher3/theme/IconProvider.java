...
public class IconProvider {
    ...
    public  Drawable getIconFromManager(Context context, String packageName, int resId){
        return getIconFromManager(context.getResources(), packageName,resId);//loadByName(context.getResources().getString(R.string.icon_provider_class),context).getIconFromManager(context.getResources(),packageName,resId);
    }
}
