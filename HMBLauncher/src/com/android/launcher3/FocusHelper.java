...
//                        .getShortcutsAndWidgets().getChildAt(0).getLayoutParams()).isFullscreen;
                ...
                if (prevPage.getShortcutsAndWidgets().getChildCount() == 0) {
                    isPrevPageFullscreen = false;
                }else {
...
//                        .getShortcutsAndWidgets().getChildAt(0).getLayoutParams()).isFullscreen;
                ...
                if (nextPage.getShortcutsAndWidgets().getChildCount() == 0) {
                    isNextPageFullscreen = false;
                }else {
