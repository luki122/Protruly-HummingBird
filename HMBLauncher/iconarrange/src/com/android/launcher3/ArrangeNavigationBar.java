 ...
 */
public class ArrangeNavigationBar extends HorizontalScrollView implements View.OnClickListener{
    ...
    protected void onFinishInflate() {
        ...
        mAddFolder.setCompoundDrawablePadding(mDeviceProfile.iconDrawablePaddingPx-3);
    ...
    private Bitmap getDragView(View view, ShortcutInfo info){
        if(view instanceof  BubbleTextView){
            ...
            if(textView.hasIDynamicIcon()){
                return new DragPreviewProvider(view).createDragBitmap(mCanvas);
            }
        }
