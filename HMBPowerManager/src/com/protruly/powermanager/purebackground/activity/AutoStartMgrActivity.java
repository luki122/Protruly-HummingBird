...
public class AutoStartMgrActivity extends HbActivity implements Observer,
        AdapterView.OnItemClickListener, LoaderManager.LoaderCallbacks<Object>, View.OnClickListener,
        HbIndexBar.OnSelectListener, AbsListView.OnScrollListener, HbIndexBar.OnTouchStateChangedListener{
    private static final String TAG = "AutoStartMgrActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setHbContentView(R.layout.activity_autostart_manager);
        initViews();
        initData();
    }
    ...
    private void initToolbar() {
        ...
        getToolbar().setTitle(R.string.auto_start);
    ...
    protected void onResume() {
        super.onResume();
        AutoStartModel.getInstance(AutoStartMgrActivity.this).attachMgrActivity(this);
    }

    @Override
    protected void onStop() {
        super.onStop();
        AutoStartModel.getInstance(AutoStartMgrActivity.this).attachMgrActivity(null);
    }
    ...
    class Task extends AsyncTask<List<ItemInfo>,Void,Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog  = new ProgressDialog(AutoStartMgrActivity.this);
        ...
        protected Void doInBackground(List<ItemInfo>... params) {
            for (int i = 0; i < mAppList.size(); i++) {
                ...
                if (isAllOpened) {
                    AutoStartModel.getInstance(AutoStartMgrActivity.this)
                            .tryChangeAutoStartState(appInfo.getPackageName(), false);
                } else {
                    AutoStartModel.getInstance(AutoStartMgrActivity.this)
                            .tryChangeAutoStartState(appInfo.getPackageName(), true);
                }
            }
            return null;
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ((TextView) ((mListView.getAdapter().getView(0, null, mListView))
                    ...
                    .setText(getResources().getString(R.string.auto_start_summary,
                            AutoStartAppProvider.getAutoStartAppList(AutoStartMgrActivity.this).size()));
            checkAll();
        }
    }
    ...
    private void checkAll() {
        ...
        if (AutoStartModel.getInstance(this).isAllAppOpened(this)) {
            LogUtils.d(TAG, "checkAll() -> All Opened!");
            isAllOpened = true;
            tvMenu.setText(R.string.app_menu_title_close);
        } else {
            LogUtils.d(TAG, "checkAll() -> Not All Opened!");
            isAllOpened = false;
    ...
    public void initOrUpdateListData() {
        ...
        header.setText(getResources().getString(R.string.auto_start_summary,
                        AutoStartAppProvider.getAutoStartAppList(this).size()));
    ...
    class AppAdapter extends ArrayAdapter<ItemInfo> implements CompoundButton.OnCheckedChangeListener {
        ...
        public View getView(int position, View convertView, final ViewGroup parent) {
            ...
            if (AutoStartAppProvider.isAllowAutoStartApp(activity, curAppInfo.getPackageName())) {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            switch (buttonView.getId()) {
                case R.id.appSwitch:
                    AutoStartModel.getInstance(activity)
                            .tryChangeAutoStartState(curAppInfo.getPackageName(), isChecked);
                    ((TextView) ((mListView.getAdapter().getView(0, null, mListView))
                            .findViewById(R.id.list_head_text)))
                            .setText(getResources().getString(R.string.auto_start_summary,
                                    AutoStartAppProvider.getAutoStartAppList(activity).size()));
                    checkAll();
                    break;
                default:
                    break;
...
//        getLoaderManager().restartLoader(AppLoader.ID_LOADER_USER_APP, null, this);
    ...
    public Loader<Object> onCreateLoader(int id, Bundle args) {
        return new AppLoader(AutoStartMgrActivity.this);
    }
    ...
    static class AppLoader extends AsyncTaskLoader<Object> {
        ...
        private List<ItemInfo> loadUserAppList() {
            ...
            for (int i = 0; i < userAppsInfo.size(); i++) {
                ...
                AutoStartInfo autoStartInfo = AutoStartModel.getInstance(mContext).
