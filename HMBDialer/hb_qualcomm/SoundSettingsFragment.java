...
public class SoundSettingsFragment extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mVibrateWhenRinging) {
            ...
            if (DialerFeatureOptions.isMtkAudioProfileEnabled()) {/*
                ...
                audioProfileManager.setVibrationEnabled(profileKey, doVibrate);
            */} else {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mPlayDtmfTone) {
            /// M: [MTK Audio Profiles]
            if (DialerFeatureOptions.isMtkAudioProfileEnabled()) {/*
                AudioProfileManager audioProfileMgr = (AudioProfileManager) getActivity()
                        .getSystemService(Context.AUDIO_PROFILE_SERVICE);
    ...
    private boolean shouldVibrateWhenRinging() {
        /// M: [MTK Audio Profiles]
        if (DialerFeatureOptions.isMtkAudioProfileEnabled()) {return false;/*
            AudioProfileManager audioProfileManager = (AudioProfileManager) getActivity()
                    .getSystemService(Context.AUDIO_PROFILE_SERVICE);
            String profileKey = audioProfileManager.getActiveProfileKey();
            return audioProfileManager.isVibrationEnabled(profileKey);
        */} else {
