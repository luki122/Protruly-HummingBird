...
//    private ICallerInfoExt mCallerInfoExtension;
    ...
    public ICallDetailExtension getCallDetailExtension() {return null;/*
    ...
    */}
    ...
    public ISelectAccountExtension getSelectAccountExtension() {return null;/*
    ...
    */}
    ...
    public IDialPadExtension getDialPadExtension() {return null;/*
    ...
    */}
    ...
    public ICallLogExtension getCallLogExtension() {return null;/*
    ...
    */}
    ...
    public IRCSeCallLogExtension getRCSeCallLogExtension() {return null;/*
    ...
    */}
    ...
    public IDialerSearchExtension getDialerSearchExtension() {return null;/*
    ...
    */}
    ...
    public /*ICallerInfoExt*/String getCallerInfoExtension() {return null;/*
        if (mCallerInfoExtension == null) {
            synchronized (ICallerInfoExt.class) {
                if (mCallerInfoExtension == null) {
                    mCallerInfoExtension = (ICallerInfoExt) MPlugin.createInstance(
    ...
    */}
    ...
    public ICallLogCommonPresenceExtension getCallLogCommonPresenceExtension() {return null;/*
        if (mCallLogCommonPresenceExtension == null) {
            synchronized (ICallLogCommonPresenceExtension.class) {
                if (mCallLogCommonPresenceExtension == null) {
                    mCallLogCommonPresenceExtension =
                    (ICallLogCommonPresenceExtension) MPlugin.createInstance(
