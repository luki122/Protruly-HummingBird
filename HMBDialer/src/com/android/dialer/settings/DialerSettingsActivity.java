...
public class DialerSettingsActivity extends PreferenceActivity {
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        Header quickDialOptionsHeader = new Header();
        quickDialOptionsHeader.titleRes = R.string.hb_quickdial;
        quickDialOptionsHeader.fragment = HbQuickDialSettingsFragment.class.getName();
        target.add(quickDialOptionsHeader);
        
        Header mergeContactsOptionsHeader = new Header();
        mergeContactsOptionsHeader.titleRes = R.string.hb_merge_contacts;
        mergeContactsOptionsHeader.fragment = HbMergeContactsSettingsFragment.class.getName();
        target.add(mergeContactsOptionsHeader);
