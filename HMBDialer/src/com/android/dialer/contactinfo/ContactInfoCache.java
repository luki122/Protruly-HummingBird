...
//            	Log.d(TAG,"getValue2");
                ...
                enqueueRequest(number, countryIso, cachedContactInfo, /*false*/true);
...
//    	Log.d(TAG,"queryContactInfo");
    ...
    public void start() {
        ...
        if (!DialerFeatureOptions.CALL_LOG_UNION_QUERY && mContactInfoQueryThread == null) {
