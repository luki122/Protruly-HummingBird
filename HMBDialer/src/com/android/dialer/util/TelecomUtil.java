...
public class TelecomUtil {
    ...
    /**
     * M: [Union Query] Return a call log unionquery uri.
     * @param context
     * @return union query uri
     */
    public static Uri getCallLogUnionQueryUri(Context context) {
//        return hasReadWriteVoicemailPermissions(context)
//                ? Uri.parse(CallLogQuery.CALL_LOG_UNION_QUERY_URI).buildUpon()
//                        .appendQueryParameter(Calls.ALLOW_VOICEMAILS_PARAM_KEY, "true").build()
//                : Uri.parse(CallLogQuery.CALL_LOG_UNION_QUERY_URI);
    	return null;
    }
