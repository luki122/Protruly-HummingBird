...
import hb.view.menu.PopupMenu.OnMenuItemClickListener;
import hb.view.menu.PopupMenu.OnDismissListener;
...
implements View.OnClickListener {
		...
		if (!TextUtils.isEmpty(voicemailUri)) {
			...
			if (canPlaceCallToNumber) {
				...
				if (isVoicemailNumber) {
					...
					primaryActionView.setTag(
							IntentProvider.getReturnCallIntentProvider(number,position,checkBox,slotId,contactUri,name));
				}
	...
	public void onClick(View view) {
		...
		if (/*view.getId() == R.id.primary_action_button && !TextUtils.isEmpty(voicemailUri)*/false) {
			...
			if(!TextUtils.isEmpty(name) && !TextUtils.isEmpty(contactUri.toString())){
				QuickContact.showQuickContact(mContext,quickContactView, contactUri,
