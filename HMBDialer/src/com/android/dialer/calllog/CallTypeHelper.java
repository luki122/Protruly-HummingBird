...
public class CallTypeHelper {
    ...
    public CallTypeHelper(Resources resources) {
        ...
        mIncomingName = resources.getString(R.string.hb_call_type_incoming);
        mOutgoingName = resources.getString(R.string.hb_call_type_outgoing);
        mMissedName = resources.getString(R.string.hb_call_type_missed);
        ...
        mRejectName=resources.getString(R.string.hb_rejected_call);
    }
        ...
        switch (callType) {
            case Calls.INCOMING_TYPE:
                if (isVideoCall) {
                    ...
                    return duration>0?mIncomingName:mRejectName;
                }
