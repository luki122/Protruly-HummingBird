...
public abstract class IntentProvider {
	...
	public static IntentProvider getReturnCallIntentProvider(final String number,
			final PhoneAccountHandle accountHandle,final int position,final CheckBox checkBox,final int slotId,final Uri contactUri,final String name) {
		return new IntentProvider() {
			public int getPosition() {
				return position;
			}
	...
	public static IntentProvider getReturnCallIntentProvider(final String number,
			final int pos,final CheckBox checkBox,final int slotId,final Uri contactUri,final String name) {
		return getReturnCallIntentProvider(number, null,pos,checkBox,slotId,contactUri,name);
	}
