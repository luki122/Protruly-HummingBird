...
LOCAL_STATIC_JAVA_LIBRARIES := android-support-v4 gson-2.7
LOCAL_SRC_FILES := $(call all-subdir-java-files)
LOCAL_PACKAGE_NAME := HMBUploadPhoneInfo
...
############################
include $(CLEAR_VARS)
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := gson-2.7:libs/gson-2.7.jar
