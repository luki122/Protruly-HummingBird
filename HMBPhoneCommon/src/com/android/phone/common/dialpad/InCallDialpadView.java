 ...
 */
public class InCallDialpadView extends LinearLayout {
    private static final String TAG = InCallDialpadView.class.getSimpleName();
...
//    private ImageButton mDelete;
    ...
    public InCallDialpadView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InCallDialpadView(Context context, AttributeSet attrs, int defStyle) {
