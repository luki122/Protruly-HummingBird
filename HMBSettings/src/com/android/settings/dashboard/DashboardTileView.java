...
public class DashboardTileView extends FrameLayout implements View.OnClickListener {
    ...
    private TextView mWidgetStatus;
    ...
    public DashboardTileView(Context context, AttributeSet attrs) {
        ...
        mWidgetStatus = (TextView) view.findViewById(R.id.next_widget_status);
    ...
    public void setWidgetStatus(String statusText) {
        if (mWidgetStatus != null) {
            mWidgetStatus.setText(statusText);
        }
    }
