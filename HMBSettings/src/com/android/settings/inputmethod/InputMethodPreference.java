...
class InputMethodPreference extends SwitchPreference implements OnPreferenceClickListener,
    ...
    InputMethodPreference(final Context context, final InputMethodInfo imi,
        ...
        if (TextUtils.isEmpty(settingsActivity)) {
            ...
            String currentInputMethodId = Settings.Secure.getString(context.getContentResolver(), Settings.Secure.DEFAULT_INPUT_METHOD);
            if ("com.iflytek.inputmethod/.FlyIME".equals(currentInputMethodId) && "com.iflytek.inputmethod".equals(imi.getPackageName())) {
                intent.setClassName(imi.getPackageName(), "com.iflytek.inputmethod.LauncherActivity");
            } else
