...
import com.android.settings.LocalePickerInternal;
...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    private final ArrayList<hb.preference.PreferenceScreen> mHardKeyboardPreferenceList = new ArrayList<>();
    ...
    public void onResume() {
        ...
        if (!mShowsOnlyFullImeAndKeyboardList) {
            if (mLanguagePref != null) {
                String localeName = getLocaleNameCompatWithLocalPicker(getActivity());
    ...
    private static String getLocaleNameCompatWithLocalPicker(Context context) {
        Locale currentLocale = context.getResources().getConfiguration().locale;
        List<LocalePicker.LocaleInfo> locales = LocalePicker.getAllAssetLocales(context, true);
        List<LocalePickerInternal.LocaleInfo> localeInfos = LocalePickerInternal.getAllAssetLocales(context, false);
        for (LocalePickerInternal.LocaleInfo info : localeInfos) {
            if (info.getLocale().equals(currentLocale)) {
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
            ...
            if (context.getAssets().getLocales().length > 1) {
                String localeName = getLocaleNameCompatWithLocalPicker(context);
...
//            indexables.add(indexable);
            ...
            indexable = new SearchIndexableRaw(context);
            indexable.key = "language_keyboard_settings";
