...
public class KeyboardLayoutPickerFragment extends SettingsPreferenceFragment
    ...
    private HashMap<hb.preference.CheckBoxPreference, KeyboardLayout> mPreferenceMap =
            new HashMap<hb.preference.CheckBoxPreference, KeyboardLayout>();
    ...
    private void updateCheckedState() {
        ...
        for (Map.Entry<hb.preference.CheckBoxPreference, KeyboardLayout> entry : mPreferenceMap.entrySet()) {
