...
public class InputMethodAndSubtypeEnabler extends SettingsPreferenceFragment
    ...
    private final HashMap<String, List<hb.preference.Preference>> mInputMethodAndSubtypePrefsMap =
            new HashMap<>();
    ...
    private void addInputMethodSubtypePreferences(final InputMethodInfo imi,
        ...
        final ArrayList<hb.preference.Preference> subtypePreferences = new ArrayList<>();
        ...
        Collections.sort(subtypePreferences, new Comparator<hb.preference.Preference>() {
            @Override
    ...
    private boolean isNoSubtypesExplicitlySelected(final String imiId) {
        final List<hb.preference.Preference> subtypePrefs = mInputMethodAndSubtypePrefsMap.get(imiId);
