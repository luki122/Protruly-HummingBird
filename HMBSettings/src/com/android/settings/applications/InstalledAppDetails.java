...
public class InstalledAppDetails extends AppInfoBase
    ...
    private static final boolean IS_ENABLE_DATA_SETTINGS = false;
    private static final boolean IS_ENABLE_BATTERY_SETTINGS = false;
    private static final boolean IS_ENABLE_GOOGLE_PERMISSION_SETTINGS = false;
    ...
    private static final String KEY_PERMISSIONS_EX = "permissions_ex";
    private static final String KEY_PERMISSIONS_DETAIL = "permissions_detail";
    ...
    private Preference mPermissionsPreferenceEx;
    private Preference mPermissionsPreferenceDetail;
    ...
    private void initUninstallButtons() {
        mUninstallButton.setBackgroundResource(com.hb.R.drawable.button_background_hb_negative);
        ...
        if (isBundled) {
            ...
            mUninstallButton.setBackgroundResource(com.hb.R.drawable.button_background_hb_delete);
        }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (IS_ENABLE_DATA_SETTINGS && Utils.isBandwidthControlEnabled()) {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (!IS_ENABLE_GOOGLE_PERMISSION_SETTINGS
                || (!UtilsExt.isGmsBuild(getActivity()) && MobileManagerUtils.isSupported())) {
        ...
        if (!IS_ENABLE_BATTERY_SETTINGS) {
            removePreference(KEY_BATTERY);
        }

        mPermissionsPreferenceEx = findPreference(KEY_PERMISSIONS_EX);
        mPermissionsPreferenceEx.setOnPreferenceClickListener(this);
        mPermissionsPreferenceDetail = findPreference(KEY_PERMISSIONS_DETAIL);
        mPermissionsPreferenceDetail.setOnPreferenceClickListener(this);
    }
    ...
    private void setAppLabelAndIcon(PackageInfo pkgInfo) {
        ...
        Drawable icon = LocalSettings.getIconDrawable(getContext(), mAppEntry.info.packageName);
        if (icon == null) {
            mState.ensureIcon(mAppEntry);
            icon = mAppEntry.icon;
        }
        setupAppSnippet(appSnippet, mAppEntry.label, icon,
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        } else if(preference == mPermissionsPreferenceEx) {
        ...
        } else if(preference == mPermissionsPreferenceDetail) {
...
//        }
        if (appRow.peekable) {
            notifSummary.add(context.getString(R.string.notifications_peeking));
        }
        if(appRow.priority && LocalSettings.getLockscreenNotificationsEnabled(context)) {
            notifSummary.add(context.getString(R.string.notifications_lock_screen));
        }
