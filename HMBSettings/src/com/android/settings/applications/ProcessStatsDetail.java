...
public class ProcessStatsDetail extends SettingsPreferenceFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Drawable icon = LocalSettings.getIconDrawable(getContext(), mApp.mPackage);
        if (icon == null) {
            icon = mApp.mUiTargetApp != null ? mApp.mUiTargetApp.loadIcon(mPm) : new ColorDrawable(0);
        }
    ...
    private void createDetails() {
        ...
        mColorBar.setColors(LocalSettings.getTingColor(context), 0,
                context.getColor(R.color.material_empty_color_light));
