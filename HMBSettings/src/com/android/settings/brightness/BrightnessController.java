...
public class BrightnessController {
    ...
    public BrightnessController(Context context, ImageView icon, SeekBar control) {
        mContext = context;
        mIcon = icon;
        mControl = control;
...
//        mControl.setOnChangedListener(null);
    ...
    public void onChanged(SeekBar view, boolean tracking, boolean automatic, int value,
...
//            mControl.setChecked(false);
    ...
    private void updateSlider() {
        if (mAutomatic) {
            ...
            mControl.setProgress((int) ((value + 1) * BRIGHTNESS_ADJ_RESOLUTION / 2f));
        } else {
            int value;
