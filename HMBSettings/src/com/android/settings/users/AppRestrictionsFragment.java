...
import hb.preference.MultiSelectListPreference;
...
public class AppRestrictionsFragment extends SettingsPreferenceFragment implements
    ...
    static class AppRestrictionsPreference extends SwitchPreference {
        ...
        private List<hb.preference.Preference> mChildren = new ArrayList<hb.preference.Preference>();
        ...
        List<hb.preference.Preference> getChildren() {
            return mChildren;
        }
