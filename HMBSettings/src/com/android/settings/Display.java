...
public class Display extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFontSize = (HbSpinner) findViewById(R.id.fontSize);
    ...
    private HbSpinner.OnItemSelectedListener mFontSizeChanged
                                    = new HbSpinner.OnItemSelectedListener() {
