...
public class ApnSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mSubscriptionInfo == null) {
            mSubscriptionInfo = SubscriptionManager.from(activity).getDefaultDataSubscriptionInfo();
        }
...
//            getActivity().finish();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mUnavailable && empty != null
                && SubscriptionManager.from(getContext()).getDefaultDataSubscriptionInfo() == null) {
            empty.setText(R.string.sim_slot_empty);
        }
    }
    ...
    private void fillList() {
        ...
        */
        ...
        if (cursor != null) {
            ...
            ArrayList<hb.preference.Preference> mnoApnList = new ArrayList<hb.preference.Preference>();
            ArrayList<hb.preference.Preference> mvnoApnList = new ArrayList<hb.preference.Preference>();
            ArrayList<hb.preference.Preference> mnoMmsApnList = new ArrayList<hb.preference.Preference>();
            ArrayList<hb.preference.Preference> mvnoMmsApnList = new ArrayList<hb.preference.Preference>();
    ...
    private void addApnToList(ApnPreference pref, ArrayList<hb.preference.Preference> mnoList,
                              ArrayList<hb.preference.Preference> mvnoList, IccRecords r, String mvnoType,
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (!mUnavailable) {
            menu.add(0, MENU_NEW, 0,
                    ...
                    .setIcon(com.hb.R.drawable.ic_add)
    ...
    private void setPreferApnChecked(ArrayList<hb.preference.Preference> apnList) {
