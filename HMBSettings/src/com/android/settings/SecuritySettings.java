...
import com.android.settings.utils.MtkPluginCompat;
...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    public static final boolean IS_SHOW_SECURITY_CATEGORY = false;
    ...
    private MtkPluginCompat mMtkPluginCompat;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMtkPluginCompat = new MtkPluginCompat(getContext());
    }
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        }*/	// del by luqiang, eastaeon, 20160916

        // Fingerprint and trust agents
        PreferenceGroup securityCategory = (PreferenceGroup)
                root.findPreference(KEY_SECURITY_CATEGORY);
        if (securityCategory != null && IS_SHOW_SECURITY_CATEGORY) {
    ...
    public void onDestroy() {
        ...
        if (mMtkPluginCompat != null) {
            mMtkPluginCompat.clear();
        }
    }
...
//                     UtilsExt.getPermControlExtPlugin(getActivity());
    ...
    private void addPluginEntrance(PreferenceGroup deviceAdminCategory) {
        mMtkPluginCompat.clear();
//        mPermCtrlExt.addAutoBootPrf(mMtkPluginCompat);
//        mPermCtrlExt.addPermSwitchPrf(mMtkPluginCompat);
//        mPermCtrlExt.enablerResume();

        //mDataProectExt.addDataPrf(mMtkPluginCompat);
        //mPplExt.addPplPrf(mMtkPluginCompat);
        mMtkPluginCompat.addPreference(deviceAdminCategory);
...
//        mDataProectExt.addDataPrf(deviceAdminCategory);
        ...
        //modify by luolaigang 2017-03-14 替换系统控件之后此处报错，暂时屏蔽
