...
//            final String total = Formatter.formatFileSize(context, totalBytes);
            final String total = (volume.getType() == VolumeInfo.TYPE_PRIVATE
                    ? PrivateVolumeSettings.getReadableRealStorageSize(context, totalBytes, 0)
                    : PrivateVolumeSettings.formatFileSize(context, totalBytes));
            final String free = PrivateVolumeSettings.formatFileSize(context, totalBytes - usedBytes);
