...
//                Formatter.formatFileSize(context, privateTotalBytes)));
        final BytesResult resultFreeBytes = PrivateVolumeSettings.formatBytes(getResources(), privateTotalBytes - privateUsedBytes, 0);
        mInternalSummary.setSummary(getString(R.string.storage_volume_header,
                PrivateVolumeSettings.getReadableRealStorageSize(context, privateTotalBytes, 0),
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference pref) {
        ...
        if (pref instanceof StorageVolumePreference) {
            ...
            if (vol == null) {
                Log.d(TAG, "the VolumeInfo find by id = " + key + " is null.");
                return false;
            }
