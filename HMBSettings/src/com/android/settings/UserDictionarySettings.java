...
public class UserDictionarySettings extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((HbActivity)getActivity()).getToolbar().setTitle(R.string.user_dict_settings_title);
    }
...
//        ((HbActivity)getActivity()).getToolbar().setSubtitle(
//                UserDictionarySettingsUtils.getLocaleDisplayName(getActivity(), mLocale));
        ((HbActivity)getActivity()).getToolbar().setTitle(UserDictionarySettingsUtils.getLocaleDisplayName(getActivity(), mLocale));
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        MenuItem actionItem =
                ...
                .setIcon(LocalSettings.Drawable.IC_MENU_ADD);
