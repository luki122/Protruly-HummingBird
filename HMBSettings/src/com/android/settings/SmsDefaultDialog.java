...
import com.android.settings.utils.AlertActivityCompat;
...
public final class SmsDefaultDialog extends AlertActivityCompat implements
        ...
        if (mNewSmsApplicationData != null) {
            ...
            if (oldSmsApplicationData != null) {
                ...
                com.android.internal.app.AlertController.AlertParams alertParams =
                        new com.android.internal.app.AlertController.AlertParams(this);
                /// M: Building confirmation message for OP03 @ {
                mSmsDialogExt.buildMessage(alertParams, packageName, getIntent(),
                                  mNewSmsApplicationData.mApplicationName,
                                  oldSmsApplicationData.mApplicationName);
                if (alertParams.mMessage != null && alertParams.mMessage.length() > 0) {
                    p.mMessage = alertParams.mMessage;
                }
                /// @ }
    ...
    private void initOkBtnBackground() {
        Button mOkButton = mAlert.getButton(BUTTON_POSITIVE);
        if (mOkButton != null) {
            mOkButton.setBackgroundResource(R.drawable.hb_button_recommend);
        }
    }
}
