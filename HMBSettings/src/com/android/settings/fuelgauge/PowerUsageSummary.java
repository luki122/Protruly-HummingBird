 ...
 */
public class PowerUsageSummary extends PowerUsageBase implements OnPreferenceChangeListener {
    ...
    public static final boolean IS_SHOW_OVER_COUNTED = false;
    ...
    public void onCreate(Bundle icicle) {
        ...
        /// M: performance and power balance
        if (FeatureOption.MTK_POWER_PERFORMANCE_STRATEGY_SUPPORT) {
            getPreferenceScreen().findPreference(PowerUsageExts.KEY_PERFORMANCE_AND_POWER)
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        return mPowerUsageExts.onPreferenceChange(preference, newValue);
    }
    /// @}
    ...
    protected void refreshStats() {
        ...
        //modify by luolaigang 2017-03-14 替换hb风格之后此处找不到该资源报错，暂时用替代方案
        int colorControl = Color.parseColor("#0D000000");//getContext().getColor(value.resourceId);
        ...
        if (averagePower >= MIN_AVERAGE_POWER_THRESHOLD_MILLI_AMP || USE_FAKE_DATA) {
            ...
            for (int i = 0; i < numSippers; i++) {
                ...
                Drawable badgedIcon = mUm.getBadgedIconForUser(entry.getIcon(),
                        userHandle);
                badgedIcon.setTintList(mTint);
