...
public final class Ranking {
    ...
    public static final int RANK_OTHERS_SETTINGS = 23;
...
//        sRankMap.put(ZenModeAutomationSettings.class.getName(), RANK_NOTIFICATIONS);
        sRankMap.put(Editprofile.class.getName(), RANK_NOTIFICATIONS);
        sRankMap.put(NotificationStatusbarSettings.class.getName(), RANK_NOTIFICATIONS);
        ...
        // Other settings
        sRankMap.put(OtherSettings.class.getName(), RANK_OTHERS_SETTINGS);
    }
