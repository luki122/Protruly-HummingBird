...
public class WifiEnabler implements SwitchBar.OnSwitchChangeListener  {
    ...
    private SwitchPreference mTogglePreference;
...
//        setupSwitchBar();
        ...
        mSwitchBar.setCustomTitle(context.getString(R.string.wlan_turn_on));
    }
    ...
    public void setupSwitchBar() {
        ...
        if(!WifiSettings.IS_ENABLER_INLINE) {
            mSwitchBar.show();
        }
    }
    ...
    private void setSwitchBarChecked(boolean checked) {
        ...
        if (!WifiSettings.IS_ENABLER_INLINE) {
            ...
            mTogglePreference.setChecked(checked);
        }
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        ...
        if (isChecked && !WirelessUtils.isRadioAllowed(mContext, Settings.Global.RADIO_WIFI)) {
            ...
            if (!WifiSettings.IS_ENABLER_INLINE) {
                ...
                mTogglePreference.setChecked(false);
            }
            return;
        }
    ...
    /**
     * Sets toggle preference.
     *
     * @param mTogglePreference the m toggle preference
     * @date Liuqin on 2017-03-30
     */
    public void setTogglePreference(SwitchPreference mTogglePreference) {
        this.mTogglePreference = mTogglePreference;
        this.mTogglePreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object value) {
                Boolean checked = (Boolean)value;
                onSwitchChanged(null, checked);
                return true;
            }
        });
    }
    ...
    private void enableSwitch(boolean enable) {
        if (!BluetoothSettings.IS_ENABLER_INLINE) {
            mSwitchBar.setEnabled(enable);
        } else if (mTogglePreference != null) {
            mTogglePreference.setEnabled(enable);
        }
    }
    ...
    public void setSummary(String summary) {
        if (!WifiSettings.IS_ENABLER_INLINE) {
            mSwitchBar.setSummary(summary);
        } else {
            mTogglePreference.setSummary(summary);
        }
    }
}
