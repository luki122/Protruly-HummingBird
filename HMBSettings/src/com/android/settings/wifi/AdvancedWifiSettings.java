...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_WLAN_SETTINGS_CATEGORY = "key_wlan_settings_category";
    ...
    private PreferenceCategory mWlanSettingsCategory;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWlanSettingsCategory = (PreferenceCategory) getPreferenceScreen().findPreference(KEY_WLAN_SETTINGS_CATEGORY);
        mAdvancedWifiSettingsExt = new AdvancedWifiSettingsExt(this);
        mAdvancedWifiSettingsExt.setWlanSettingsCategory(mWlanSettingsCategory);
        //M: add for mtk feature and bug fix
    ...
    private void initPreferences() {
        ...
        if (UserHandle.myUserId() == UserHandle.USER_OWNER && !scorers.isEmpty()) {
            ...
            mWlanSettingsCategory.removePreference(mWifiAssistantPreference);
        }
        ...
        // M: Remove wifi frequency band ListPreference because supplicant not ready
        if (mWifiManager.isDualBandSupported() &&
            context.getResources().getBoolean(
            com.mediatek.internal.R.bool.config_wifi_sta_setband_support)) {
            ...
            if (frequencyPref != null) {
                ...
                mWlanSettingsCategory.removePreference(frequencyPref);
            }
        }
