...
import com.android.settings.utils.PasswordOnTouchListener;
...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    /// M: @{
    private HbSpinner mSecurity;
    IWifiApDialogExt mExt;
    private HbSpinner mMaxConnSpinner;
    ///@}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSecurity = ((HbSpinner) mView.findViewById(R.id.security));
        final HbSpinner mChannel = (HbSpinner) mView.findViewById(R.id.choose_channel);
        ...
        mMaxConnSpinner = ((HbSpinner) mView.findViewById(R.id.max_connection_num));
        ...
        mPassword.setOnTouchListener(new PasswordOnTouchListener(mPassword));
    ...
    /**
     * M: close HbSpinner dialog method
     */
