...
public class RecentLocationApps {
     ...
     */
    public List<hb.preference.Preference> getAppList() {
        ...
        ArrayList<hb.preference.Preference> prefs = new ArrayList<hb.preference.Preference>();
    ...
    private Preference getPreferenceFromOps(final UserManager um, long now,
        ...
        try {
            ...
            Drawable icon = LocalSettings.getIconDrawable(mActivity.getApplicationContext(), packageName);
            if (icon == null) {
                Drawable appIcon = mPackageManager.getApplicationIcon(appInfo);
                icon = mPackageManager.getUserBadgedIcon(appIcon, userHandle);
            }
