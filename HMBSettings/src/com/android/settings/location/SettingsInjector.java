...
class SettingsInjector {
     ...
     */
    public List<hb.preference.Preference> getInjectedSettings(final int profileId) {
     ...
     */
    private Preference addServiceSetting(List<hb.preference.Preference> prefs, InjectedSetting info) {
        PackageManager pm = mContext.getPackageManager();
