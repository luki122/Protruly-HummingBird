...
public class LocationSettings extends LocationSettingsBase
    ...
    private void addPreferencesSorted(List<hb.preference.Preference> prefs, PreferenceGroup container) {
        // If there's some items to display, sort the items and add them to the container.
        Collections.sort(prefs, new Comparator<hb.preference.Preference>() {
            @Override
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        List<hb.preference.Preference> recentLocationRequests = recentApps.getAppList();
    ...
    private void addLocationServices(Context context, PreferenceScreen root,
        ...
        List<hb.preference.Preference> locationServices = injector.getInjectedSettings(lockdownOnLocationAccess ?
