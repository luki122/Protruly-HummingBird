...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener,
    ...
    public void setCustomTitle(String mCustomTitle) {
        this.mCustomTitle = mCustomTitle;
        setTextViewLabel(true);
    }

    private void addDivider() {
        mDividerView = new View(getContext());
        LayoutParams params = new LayoutParams(0, 1);
        mDividerView.setBackgroundResource(R.drawable.list_divider_material);
