...
//        setContentView(R.layout.add_account_screen);
    ...
    private void onAuthDescriptionsUpdated() {
        ...
        for (int i = 0; i < mAuthDescs.length; i++) {
            ...
            if (AccountSettings.PROTRULY_ACCOUNT_TYPE.equals(accountType)) {
                continue;
            }
    ...
    protected Drawable getDrawableForType(final String accountType) {
        ...
        if (mTypeToAuthDescription.containsKey(accountType)) {
            try {
                ...
                icon = LocalSettings.getIconDrawable(getApplicationContext(), desc.packageName);
                if (icon == null) {
    ...
    private void showNoAccountWarning() {
        Toast.makeText(this, getString(R.string.add_account_not_exist), Toast.LENGTH_SHORT).show();
    }
}
