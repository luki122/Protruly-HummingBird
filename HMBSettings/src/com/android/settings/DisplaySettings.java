...
import com.android.settings.brightness.BrightnessSeekBarPreference;
...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_BRIGHTNESS_SEEKBAR = "brightness_seekbar";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBrightnessSeekBarPreference = (BrightnessSeekBarPreference) findPreference(KEY_BRIGHTNESS_SEEKBAR);
        initRotation();
        hideOtherPreference();
    }
    ...
    public void onResume() {
        ...
        mBrightnessSeekBarPreference.onResume();
    }
    ...
    public void onPause() {
        ...
        mBrightnessSeekBarPreference.onPause();
    }
    /// @}
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (KEY_FONT_SIZE.equals(key)) {
            final Object objValueFinal = objValue;
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    writeFontSizePreference(objValueFinal);
                }
            },250);
        }
    ...
    private void hideOtherPreference() {
//        removePreference(KEY_SCREEN_TIMEOUT);
    ...
    private void initRotation() {
        SwitchPreference mRotationPreference = (SwitchPreference) findPreference("key_screen_rotate");
        mRotationPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object o) {
                Boolean enabled = !(Boolean)o;
                RotationPolicy.setRotationLock(getActivity(), enabled);
                return true;
            }
        });
        mRotationPreference.setChecked(!RotationPolicy.isRotationLocked(getContext()));
        mDisplaySettingsExt.setRotateSwitchPreference(mRotationPreference);
    }

    /**
     * The type Settings observer.
     *
     * @date Liuqin on 2017-04-18
     */
    private final class SettingsObserver extends ContentObserver {
        private final Uri SCREEN_BRIGHTNESS_MODE_URI =
        ...
        public void register(boolean register) {
            ...
            if (register) {
                cr.registerContentObserver(SCREEN_BRIGHTNESS_MODE_URI , false, this);
            } else {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (SCREEN_BRIGHTNESS_MODE_URI .equals(uri)) {
                updateState();
            }
        }
    }
