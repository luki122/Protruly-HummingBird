...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    private final ArrayList<hb.preference.Preference> mAllPrefs = new ArrayList<hb.preference.Preference>();

    private final ArrayList<hb.preference.SwitchPreference> mResetSwitchPrefs
            = new ArrayList<hb.preference.SwitchPreference>();

    private final HashSet<hb.preference.Preference> mDisabledPrefs = new HashSet<hb.preference.Preference>();
