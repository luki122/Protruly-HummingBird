...
import com.android.settings.widget.SettingSetupWizardLayout;
 ...
 */
public class FingerprintEnrollBase extends FullActivityBase implements View.OnClickListener {
...
//        getNavigationBar().setVisibility(View.GONE);
    ...
    protected SettingSetupWizardLayout getSetupWizardLayout() {
        return (SettingSetupWizardLayout) findViewById(R.id.setup_wizard_layout);
    }
