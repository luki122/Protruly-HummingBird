...
//        ViewGroup mainContent = (ViewGroup) getActivity().findViewById(R.id.main_content);
        ViewGroup mainContent = (ViewGroup) getActivity().findViewById(android.R.id.content);
        getActivity().getLayoutInflater().inflate(R.layout.floating_button, mainContent, true);
        hb.widget.FloatingActionButton floatingActionButton =
                (hb.widget.FloatingActionButton)mainContent.findViewById(R.id.floating_action_button);
        floatingActionButton.setOnFloatingActionButtonClickListener(
                new FloatingActionButton.OnFloatActionButtonClickListener() {
            @Override
            public void onClick(View view) {
                addVpnProfile();
            }
    ...
    private void addVpnProfile() {
        ...
        VpnProfile profile = new VpnProfile(Long.toHexString(millis));
        ConfigDialogFragment.show(VpnSettings.this, profile, true /* editing */, false /* exists */);
    }
}
