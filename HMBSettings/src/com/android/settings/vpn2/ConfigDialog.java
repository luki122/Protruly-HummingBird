...
class ConfigDialog extends AlertDialog implements TextWatcher,
    ...
    private HbSpinner mIpsecUserCert;
    private HbSpinner mIpsecCaCert;
    private HbSpinner mIpsecServerCert;
    ...
    protected void onCreate(Bundle savedState) {
        ...
        mType = (HbSpinner) mView.findViewById(R.id.type);
        ...
        mIpsecUserCert = (HbSpinner) mView.findViewById(R.id.ipsec_user_cert);
        mIpsecCaCert = (HbSpinner) mView.findViewById(R.id.ipsec_ca_cert);
        mIpsecServerCert = (HbSpinner) mView.findViewById(R.id.ipsec_server_cert);
        ...
        hideView = (View)(getWindow().getDecorView());
    	hideView.setVisibility(View.INVISIBLE);

    	viewHandler.sendEmptyMessageDelayed(0, 100);
    ...
    private void loadCertificates(HbSpinner spinner, String prefix, int firstId, String selected) {
        Context context = getContext();
