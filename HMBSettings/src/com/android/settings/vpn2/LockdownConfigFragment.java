...
public class LockdownConfigFragment extends DialogFragment {
    ...
    /// M: Change API to protected, called by ConfigDialogFragment
    ...
    private void initProfiles(KeyStore keyStore, Resources res) {
        ...
        /// M: Enable PPTP VPN for always on VPN
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final HbListView listView = (HbListView) view.findViewById(android.R.id.list);
        listView.setChoiceMode(HbListView.CHOICE_MODE_SINGLE);
