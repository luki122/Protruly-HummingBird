...
public class AppNotificationSettings extends SettingsPreferenceFragment {
    ...
    private static final boolean IS_SHOW_HEADER = false;
    private static final boolean IS_SHOW_SENTITIVE_SECTION = false;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getActivity().getActionBar().setTitle(mAppRow.label);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mIsSystemPackage = info.applicationInfo.isPrivilegedApp();
        if (!mIsSystemPackage) {
