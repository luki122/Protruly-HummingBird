    ...
    private void loadAccountList(final UserManager um) {
        ...
        for (int profileIndex = 0; profileIndex < profilesSize; profileIndex++) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                try {
                    if (desc.iconId != 0) {
                        icon = LocalSettings.getIconDrawable(getContext(), desc.packageName);
                        if (icon == null) {
                ...
                View itemView = inflater.inflate(mPreferenceLayout, contents, false);
                TextView child = (TextView) itemView.findViewById(android.R.id.title);
...
//                contents.addView(child);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPreferenceLayout = preference.getLayoutResource();
