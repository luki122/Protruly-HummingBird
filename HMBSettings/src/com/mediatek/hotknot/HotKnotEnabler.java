...
public final class HotKnotEnabler implements SwitchBar.OnSwitchChangeListener {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("@M_" + TAG, "HotKnot state changed to" + state);
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        Log.d("@M_" + TAG, "onSwitchChanged to " + isChecked
               + ", mUpdateStatusOnly is " + mUpdateStatusOnly);
    ...
    void handleStateChanged(int state) {
        switch (state) {
            case HotKnotAdapter.STATE_ENABLED:
                ...
                Log.d("@M_" + TAG, "Begin update status: set mUpdateStatusOnly to true");
                setSwitchChecked(true);
                mSwitch.setEnabled(true);
                mUpdateStatusOnly = false;
                Log.d("@M_" + TAG, "End update status: set mUpdateStatusOnly to false");
                break;
