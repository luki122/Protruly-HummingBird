...
public class OverViewTabAdapter extends BaseExpandableListAdapter {
    ...
    private WeakHashMap<Integer, View> mGroupViewMap = new WeakHashMap<>();
                    ...
                    switch (index) {
                        case SIM_COLOR_TEAL:
                            view = inflate.inflate(
                                    R.layout.data_usage_exp_child_mobile, null);
                            break;
                        case SIM_COLOR_BLUE:
                            view = inflate.inflate(
                                    R.layout.data_usage_exp_child_mobile, null);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (null == convertView || !(convertView instanceof TextView)) {
            ...
            if (isExpanded) {
                item.setCompoundDrawablesWithIntrinsicBounds(null, null,
                        item.getContext().getDrawable(R.drawable.arrow_drop_down), null);
            }
        } else {
        ...
        mGroupViewMap.put(groupPosition, item);
    ...
    public View getGroupView(int position) {
        return mGroupViewMap.get(position);
    }
