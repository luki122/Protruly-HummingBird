...
public class WifiWpsEmDialog extends AlertDialog
        ...
        private HbSpinner mPinSecuritySpinner;
        EditText mSsid;
        EditText mKey;
        EditText mPinCode;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mPinSecuritySpinner = (HbSpinner) mView.findViewById(R.id.pin_security);
        ...
        public void onClick(View view) {
             if (view.getId() == R.id.wifi_defalut_pins_togglebox) {
                  ...
                  if (((CheckBox) view).isChecked()) {
                      ...
                      ((HbSpinner) mView.findViewById(R.id.pin_security)).setEnabled(false);
                      ...
                      ((HbSpinner) mView.findViewById(R.id.pin_security)).setEnabled(true);
