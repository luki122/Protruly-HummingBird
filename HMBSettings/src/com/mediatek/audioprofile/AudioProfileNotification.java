...
public class AudioProfileNotification extends SettingsPreferenceFragment implements Indexable {
    ...
    private void initPulse() {
        ...
        if (mNotificationPulse == null) {
            Log.i("@M_" + TAG, "Preference not found: " + KEY_NOTIFICATION_PULSE);
            return;
        }
        if (!getResources()
    ...
    private void updatePulse() {
        ...
        try {
            ...
            Log.e("@M_" + TAG, Settings.System.NOTIFICATION_LIGHT_PULSE + " not found");
        }
    }
    ...
    private void initLockscreenNotifications() {
        ...
        if (mLockscreen == null) {
            Log.i("@M_" + TAG, "Preference not found: " + KEY_LOCK_SCREEN_NOTIFICATIONS);
            return;
        }
