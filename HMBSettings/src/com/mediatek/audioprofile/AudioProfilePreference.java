...
/**
 * Audio profile customized preference.
 */
public class AudioProfilePreference extends Preference implements
    ...
    public View onCreateView(ViewGroup parent) {
        Log.d("@M_" + XLOGTAG, TAG + "onCreateView " + getKey());
        mInflater = (LayoutInflater) mContext.getSystemService(
                Context.LAYOUT_INFLATER_SERVICE);
        View view = mInflater.inflate(R.layout.audio_profile_item, null);
        ...
        if (mCheckboxButton != null) {
            ...
            mCheckboxButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Log.d("@M_" + XLOGTAG, TAG + "onClick " + getKey());
        ...
        if (mPreferenceTitle != null && mTextView != null) {
            ...
            Log.d("@M_" + XLOGTAG, TAG + "PreferenceTitle is null");
        }
    ...
    /**
     * dynamic show the preference summary according to the profile,
     * eg: General / Customer -> Ring/ Ring and vibrate Silent -> Silent only Meeting
     * -> vibrate only Outdoor -> Loudest ring and vibrate.
     */
    public void dynamicShowSummary() {
        Log.d("@M_" + XLOGTAG, TAG + mKey + " dynamicShowSummary");
        ...
        if (mSummary != null) {
            ...
            if ((Scenario.GENERAL).equals(scenario)
                ...
                Log.d("@M_" + XLOGTAG, TAG + "vibrationEnabled" + vibrationEnabled);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        Log.d("@M_" + XLOGTAG, TAG + "onCheckedChanged " + isChecked + getKey());
