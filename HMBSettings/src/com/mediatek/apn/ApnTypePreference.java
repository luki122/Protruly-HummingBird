...
import hb.preference.DialogPreference;
...
public class ApnTypePreference extends DialogPreference implements
    ...
    public ApnTypePreference(Context context, AttributeSet attrs) {
        ...
        String[] tempArray = context.getResources().getStringArray(R.array.apn_type_generic);

        /// M: for plug-in
        tempArray = UtilsExt.getApnSettingsPlugin(context).getApnTypeArray(tempArray, context,
                apnType);
