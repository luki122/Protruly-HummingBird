...
public class DisplaySettingsExt implements OnPreferenceClickListener {
    ...
    public static final boolean IS_SHOW_FEATURE_ITEM = false;
    ...
    private SwitchPreference mRotateSwitchPreference;
    ...
    private RotationPolicyListener mRotationPolicyListener = new RotationPolicyListener() {
        ...
        public void onChange() {
            ...
            if (mRotateSwitchPreference != null) {
                mRotateSwitchPreference.setChecked(!RotationPolicy.isRotationLocked(mContext));
            }
        }
    };
    // @ }

    public void setRotateSwitchPreference(SwitchPreference preference) {
        mRotateSwitchPreference = preference;
    }
}
