...
/**
 * Created by lijia on 17-6-19.
 */

public class TombstoneAction extends Action {

    public TombstoneAction(Context context, String tag, String packageName, String erroReason, String filePath) {
        super(context);
