...
/**
 * Created by lijia on 17-5-23.
 */

public class WTFAction extends Action {

    public WTFAction(Context context, String tag, String packageName, String erroReason, String filePath) {
        super(context);
