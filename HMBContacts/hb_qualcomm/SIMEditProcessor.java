...
public class SIMEditProcessor extends SIMProcessorBase {
    ...
    private boolean isPhoneNumberInvaild() {return false;/*
    ...
    */}
    ...
    private boolean isSIMUpdateValuesInvalid() {return false;/*
    ...
    */}
    ...
    private boolean isUSIMUpdateValuesInvalid() {return false;/*
    ...
    */}
    ...
    private boolean isInsertValuesInvalid() {return false;/*
        if (SimCardUtils.SimType.SIM_TYPE_USIM_TAG.equals(mSimType)) {
