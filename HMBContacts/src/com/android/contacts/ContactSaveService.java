...
import hb.provider.ContactsContract.AggregationExceptions;
...
public class ContactSaveService extends IntentService {
    ...
    public static int shoudJoinCount=0;
...
//        showToast(R.string.contactsJoinedMessage);
        joinCount++;
        android.util.Log.d(TAG,"joinCount:"+joinCount+" shoudJoinCount:"+shoudJoinCount);
        if(joinCount==shoudJoinCount){
        	Intent intent2=new Intent("com.android.contacts.activities.HbMergeContactsActivity");
    ...
    private void showToast(final int message) {
        mMainHandler.post(new Runnable() {
            ...
            @Override
            public void run() {
            	android.util.Log.d(TAG,"showToast");
