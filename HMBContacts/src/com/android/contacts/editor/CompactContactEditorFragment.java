...
public class CompactContactEditorFragment extends ContactEditorBaseFragment implements
    ...
    public static final String TAG = "CompactContactEditorFragment-liumx";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        final View view = inflater.inflate(
                R.layout.hb_compact_contact_editor_fragment, container, false);
...
//             if (activity != null&&!mMainView.hasFocusable()) {
...
//            }
    ...
    @Override
    public void onContactCanSave(boolean canSave) {
    	Log.i(TAG, "[onContactCanSave]canSave = " + canSave);
    	((com.android.contacts.activities.CompactContactEditorActivity)getActivity()).getActionMode().enableItem(ActionMode.POSITIVE_BUTTON, canSave);
//        ///M:
