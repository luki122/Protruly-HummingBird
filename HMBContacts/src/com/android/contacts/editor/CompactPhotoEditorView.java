...
import hb.provider.ContactsContract.DisplayPhoto;
    ...
    public void setPhoto(ValuesDelta valuesDelta) {
        if (valuesDelta == null) {
            ...
            if (bytes == null) {
                ...
                mPhotoImageView.setImageDrawable(drawable);//.setImageBitmap(bitmap);
                mIsPhotoSet = true;
...
//        });
    ...
    private void setDefaultPhoto() {
        mPhotoImageView.setImageResource(R.drawable.hb_photo_editor_view_default1);
        mIsPhotoSet = false; 
