...
public class CallLogInteractionsLoader2 extends AsyncTaskLoader<List<ContactInteraction>> {

    private final String[] mPhoneNumbers;
    private List<ContactInteraction> mData;

    public CallLogInteractionsLoader2(Context context, String[] phoneNumbers,
            int maxToRetrieve) {
        super(context);
    ...
    public List<ContactInteraction> loadInBackground() {
        ...
        Log.e("liumx","size: "+interactions.size());
...
//            }
    ...
    private List<ContactInteraction> getCallLogInteractions(String phoneNumber) {
        ...
        final String orderByAndLimit = Calls.DATE + " DESC";
