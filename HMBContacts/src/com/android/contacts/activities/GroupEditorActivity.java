...
implements DialogManager.DialogShowingViewActivity {
	...
	public void onCreate(Bundle savedState) {
		...
		setHbContentView(R.layout.group_editor_activity);
			...
			public void onActionItemClicked(Item item){
				...
				case ActionMode.POSITIVE_BUTTON:	{
					if(TextUtils.isEmpty(mFragment.mGroupNameView.getText())) {
						Toast.makeText(GroupEditorActivity.this, getResources().getString(R.string.hb_group_name_cannot_empty), Toast.LENGTH_LONG).show();
						return;
					}
	...
	public void back(){
		...
		builder.setMessage(GroupEditorActivity.this.getString(R.string.hb_is_save_group_message));
		builder.setTitle(GroupEditorActivity.this.getString(R.string.hb_is_save_group_title));
		builder.setNegativeButton(GroupEditorActivity.this.getString(R.string.hb_cancel), new DialogInterface.OnClickListener() {
		...
		builder.setPositiveButton(GroupEditorActivity.this.getString(R.string.hb_ok), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which)
			{
				dialog.dismiss();
