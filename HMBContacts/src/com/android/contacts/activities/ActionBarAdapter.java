...
public class ActionBarAdapter implements OnCloseListener {
	...
	private void setupSearchAndSelectionViews() {
		...
		//		mSearchContainer = inflater.inflate(R.layout.hb_search_bar_expanded, mToolbar,
		//				/* attachToRoot = */ false);
	...
	public void initialize(Bundle savedState, ContactsRequest request) {
		...
		backIcon.setColorFilter(mActivity.getResources().getColor(R.color.hb_toolbar_icon_normal_color));
		...
		mSearchView.setQueryHintTextColor(mActivity.getResources().getColor(R.color.hb_searchview_hint_text_color));
		mToolbar.setBackgroundColor(mActivity.getResources().getColor(R.color.hb_toolbar_background_color));
