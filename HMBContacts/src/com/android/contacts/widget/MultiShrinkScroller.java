...
//        mCollapsedTitleStartMargin = ((Toolbar) getToolbar()).getContentInsetStart();
//
...
//        updateHeaderTextSizeAndMargin();
    ...
    public void setToolbarHeight(int delta) {
        ...
        toolbarLayoutParams.height = 0;//delta;
...
//        }
    ...
    private void setTransparentViewHeight(int height) {
        mTransparentView.getLayoutParams().height = 0;
...
//        mPhotoTouchInterceptOverlay.setClickable(toolbarHeight != mMaximumHeaderHeight);
        ...
        final float minimumSize = android.R.attr.actionBarSize;//mInvisiblePlaceholderTextView.getHeight();
