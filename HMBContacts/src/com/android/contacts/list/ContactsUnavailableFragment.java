...
import hb.provider.ContactsContract.ProviderStatus;
...
public class ContactsUnavailableFragment extends Fragment implements OnClickListener {
    ...
    private hb.widget.FoldProgressBar mProgress;
    ...
    public View onCreateView(
        ...
        drawable.setStroke(1, getResources().getColor(R.color.hb_list_main_text_color)); // 边框粗细及颜色  
        ...
        mProgress = (hb.widget.FoldProgressBar) mView.findViewById(R.id.progress);
...
//                mListener.onImportContactsFromFileAction();
    			Intent intent=new Intent(getActivity(),HbContactImportExportActivity.class);
