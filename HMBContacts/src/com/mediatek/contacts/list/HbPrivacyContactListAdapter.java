...
public class HbPrivacyContactListAdapter extends MultiBasePickerAdapter/* implements SliderView.OnSliderButtonLickListener*/{
	protected static final String TAG = "HbPrivacyContactListAdapter";
	public HbPrivacyContactListAdapter(Context context, ListView lv) {
		super(context, lv);
