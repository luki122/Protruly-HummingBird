    ...
    public ContactsRequest resolveIntent(Intent intent) {
        ...
        if (ContactsIntent.contain(intent)) {
            ...
            if (ContactsIntent.LIST.ACTION_PICK_MULTI_CONTACTS.equals(action)) {
                ...
                request.setActionCode(ContactsRequestAction.ACTION_HB_RECORD_CONTACTS_LIST);
            }else if (ContactsIntent.LIST.PRIVACY_CONTACTS_CONTACTS_LIST.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_HB_PRIVACY_CONTACTS_LIST);
            }else if (ContactsIntent.LIST.PRIVACY_ADD_CONTACTS_CONTACTS_LIST.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_HB_PRIVACY_ADD_CONTACTS_LIST);
            }
