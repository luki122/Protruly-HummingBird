...
public class ContactsRequestAction {
    ...
    public static final int ACTION_HB_RECORD_CONTACTS_LIST = 311;
    
    public static final int ACTION_HB_PRIVACY_CONTACTS_LIST = 312;
    
    public static final int ACTION_HB_PRIVACY_ADD_CONTACTS_LIST = 313;
}