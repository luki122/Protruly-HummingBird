...
public class PhoneAndEmailsPickerFragment extends DataKindBasePickerFragment {
	...
	public PhoneAndEmailsPickerFragment() {
	...
	public void onResume() {
		super.onResume();
		nameColumnIndex=4;
		quanpinyinColumnIndex=13;
		jianpinyinColumnIndex=14;
		phonebookbucketColumnIndex=15;
		contactIdIndex=6;
		numberIndex=3;
		snippetColumnIndex=3;
		_PROJECTION=PhoneAndEmailsPickerAdapter.PHONE_EMAIL_PROJECTION;
	}
...
//	}
	...
	protected ContactEntryListAdapter createListAdapter() {
		...
		Log.d(TAG,"createListAdapter,adapter:"+adapter);
	...
	public void onOptionAction() {
		...
		Log.i(TAG, "[onOptionAction]mNumberBalance = " + mNumberBalance + ",idArray.length = "
				+ idArray.length+" idArray:"+(Arrays.toString(idArray)));
