...
public class BootCmpReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "onReceive1, action is " + action);
        if (Intent.ACTION_BOOT_COMPLETED.equals(action)){
        	Log.d(TAG,"ACTION_BOOT_COMPLETED");
			SharedPreferences sharedPreferences=context.getSharedPreferences("com.android.contacts_hb", Context.MODE_WORLD_READABLE);
...
//        }
        ...
        if(action.equals("CONTACTS_IMPORT_FROM_SD_COMPLETE")){
			Toast.makeText(context, context.getString(R.string.hb_import_sim_contacts_result,String.valueOf(intent.getExtras().getInt("mTotalCount"))), Toast.LENGTH_LONG).show();
        }
        /// @}
    }
