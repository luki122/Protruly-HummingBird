...
import com.android.providers.hb.ContactsContract.DialerSearch;
import com.android.providers.hb.ContactsContract.Preferences;
    ...
    private static void createDialerSearchTempTable(SQLiteDatabase db, String contactsSelect,
        ...
        if (ContactsProviderUtils.isSearchDbSupport()) {
            ...
            String dsViewSelect = " SELECT "
                    ...
                    + dsCallsTableName + ".reject AS dsreject,"
                    + dsCallsTableName + ".name AS dsname,"
                    + dsCallsTableName + "." + Calls./*PHONE_ACCOUNT_ID*/SUB_ID + " AS "
    ...
    public Cursor query(SQLiteDatabase db, Uri uri) {
        ...
        try {
            ...
            String currentRawContactsSelect = DialerSearchLookupColumns.RAW_CONTACT_ID
                    + " in (SELECT _id FROM " + Tables.RAW_CONTACTS + ")";//modify by liyang 2017-4-22
            ...
            cursor = db.rawQuery("SELECT "
                  ...
                  + DialerSearch.RAW_CONTACT_ID + "=offset_table.raw_contact_id)"
                    ...
                    + " WHERE (dialer_search_temp_table.dsreject IS NULL OR (dialer_search_temp_table.dsreject<1 AND dialer_search_temp_table.dsname IS NULL)) AND NOT" + "( offset_table.name_type="
                    + DialerSearchLookupType.NAME_EXACT + " AND "
