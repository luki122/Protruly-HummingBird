...
//import com.android.providers.contacts.LocaleSet;
...
public class LocaleSet {
    ...
    public static LocaleSet newDefault(LocaleSet mCurrentLocales,Context context) {
    ...
    public static LocaleSet updateLocaleSet(LocaleSet oldLocales, Locale newLocale) {
    ...
    public static LocaleSet getProviderPrefLocales(SharedPreferences prefs) {
		final String providerLocaleString = prefs.getString("locale", null);
