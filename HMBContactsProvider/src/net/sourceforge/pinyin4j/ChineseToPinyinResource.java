...
public class ChineseToPinyinResource
{
    ...
    private void initializeResource()
    {
        try
        {
            ...
            InputStream is = ResourceHelper.getResourceInputStream(resourceName);
            if (null != is) {
...
//      static final ChineseToPinyinResource theInstance = new ChineseToPinyinResource();
    	static SoftReference<ChineseToPinyinResource> theInstance
    		= new SoftReference<ChineseToPinyinResource>(new ChineseToPinyinResource());
    	
    	static ChineseToPinyinResource getInstance() {
     		if (null == theInstance.get()) {
     			theInstance = new SoftReference<ChineseToPinyinResource>(new ChineseToPinyinResource());
     		}
