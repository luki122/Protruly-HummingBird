...
import com.android.providers.hb.ContactsContract.CommonDataKinds;
    ...
    private static class SearchSuggestion {
        ...
        private void process() {
            ...
            if (null != mPhotoUri) {
                ...
                mIcon1 = String.valueOf(/**com.android.internal.*/R.drawable.hb_ic_contacts);
            } else {
        ...
        private String getIcon(int slotId, int isSdn) {
            ...
            return String.valueOf(/**com.android.internal.*/R.drawable.hb_ic_contacts);
        }
    }
