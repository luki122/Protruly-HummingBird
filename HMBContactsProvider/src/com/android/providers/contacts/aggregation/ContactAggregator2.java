...
public class ContactAggregator2 extends AbstractContactAggregator {
	protected static final String TAG = "ContactAggregator2";
    ...
    private final RawContactMatcher mMatcher = new RawContactMatcher(mDbHelper.getReadableDatabase());
     ...
     */
     synchronized void aggregateContact(TransactionContext txContext, SQLiteDatabase db,
        ...
        RawContactMatcher matcher = new RawContactMatcher(db);
...
//    	Log.d(TAG,"findRawContactMatchingCandidates");
...
//        Log.d(TAG,"matchingCandidates.getRawContactIdSet():"+matchingCandidates.getRawContactIdSet());
        ...
        while (!newIds.isEmpty()) {
            ...
            for (long rId : newIds) {
                final RawContactMatcher rMatcher = new RawContactMatcher(db);
...
//    	Log.d(TAG,"reAggregateRawContacts,rawContactId:"+rawContactId+" matchingCandidates:"+matchingCandidates);
...
//        Log.d(TAG,"connectedRawContactSetst:"+connectedRawContactSets);
...
//    	Log.d(TAG,"updateAggregationAfterVisibilityChange");
    ...
    private void updateMatchScoresBasedOnNameMatches(SQLiteDatabase db, long rawContactId,
            RawContactMatcher matcher) {
//    	Log.d(TAG,"updateMatchScoresBasedOnNameMatches");
        mSelectionArgs1[0] = String.valueOf(rawContactId);
...
//    	Log.d(TAG,"updateMatchScoresBasedOnNameMatches");
    ...
    private void updateMatchScoresBasedOnPhoneMatches(SQLiteDatabase db, long rawContactId,
            RawContactMatcher matcher) {
//    	Log.d(TAG,"updateMatchScoresBasedOnPhoneMatches");
        mSelectionArgs2[0] = String.valueOf(rawContactId);
    ...
    private void lookupApproximateNameMatches(SQLiteDatabase db, MatchCandidateList candidates,
            RawContactMatcher matcher) {
//    	Log.d(TAG,"lookupApproximateNameMatches");
...
//    	Log.d(TAG,"findMatchingContacts");
...
//    	Log.d(TAG,"updateMatchScoresForSuggestionsBasedOnDataMatches");
