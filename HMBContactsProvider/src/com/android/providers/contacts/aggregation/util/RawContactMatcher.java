...
public class RawContactMatcher {
    ...
    public RawContactMatcher(SQLiteDatabase db){
    	this.db=db;
    }
...
//    	Log.d(TAG,"getMatchingScore,rId:"+rawContactId+" contactId:"+contactId+" accoundId:"+accountId);
//    	Cursor cursor=null;
//    	try{
//    		cursor=db.query("raw_contacts", new String[]{"indicate_phone_or_sim_contact"}, 
//        			"_id="+rawContactId, null, null, null,null);
//    		if(cursor!=null && cursor.moveToFirst()){
//    			int indicate_phone_or_sim_contact=cursor.getInt(0);
//    			if(indicate_phone_or_sim_contact>0) return null;
//    		}
//    	}catch(Exception e){
//    		Log.d(TAG,"e:"+e);
//    		return null;
