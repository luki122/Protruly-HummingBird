...
import cn.com.protruly.filemanager.categorylist.PinyinSortedCursor;
import cn.com.protruly.filemanager.ziplist.ZipPath;

/**
 * Created by sqf on 17-5-18.
 */
        ...
        public int compare(String text1, String text2) {
            ...
            if(characterType1 == characterType2) {
                if(characterType1 != SortUtil.TYPE_CHINESE) {
                    ...
                    //LogUtil.i(TAG, "text1:" + text1 + " pinyin1:" + pinyin1);
                    //LogUtil.i(TAG, "text2:" + text2 + " pinyin2:" + pinyin2);
                    //LogUtil.i(TAG, "compareTo:" + pinyin1.compareTo(pinyin2));
